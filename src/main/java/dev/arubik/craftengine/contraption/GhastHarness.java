...
public final class GhastHarness {
     ...
     * {@link GhastHarnessBearing#gluedStructureAround} probes the glue graph at. An adult
     ...
     * (a capture stores yaw-0 local cells and both {@code GhastHarnessBearing#rehydrate} and its
