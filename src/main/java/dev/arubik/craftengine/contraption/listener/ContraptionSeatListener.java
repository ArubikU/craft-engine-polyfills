...
public final class ContraptionSeatListener implements Listener {
     ...
     */
    public static boolean tryHandleSit(ServerPlayer player) {
     ...
     */
    public static void dismount(ContraptionState state, UUID id) {
     ...
     */
    public static void dismount(ContraptionState state, UUID id, boolean skipTeleport) {
     ...
     * {@link #tryHandleSit}.
     */
    public static boolean hasSeatUnderAim(ServerPlayer player) {
    ...
    private static boolean trySit(ServerPlayer player) {
        ...
        if (Key.of("polyfills", "vehicle").equals(bestState.bearingType())
