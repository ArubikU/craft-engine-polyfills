...
public class ItemBehaviors {
    ...
    public static final Key POLYFILL_CHAINERY = Key.of("polyfills:chainery");
    public static void register() {
        ...
        RegistryUtils.registerItemBehavior(POLYFILL_CHAINERY,
                dev.arubik.craftengine.chainery.ChaineryItemBehavior.FACTORY);
    }
}
