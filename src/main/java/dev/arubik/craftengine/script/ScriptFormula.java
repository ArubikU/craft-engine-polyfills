...
public final class ScriptFormula {
    ...
    static ScriptValue callBuiltin(String name, List<ScriptValue> args, ScriptContext ctx) {
    ...
    static ScriptValue memberCall(ScriptValue obj, String method, List<ScriptValue> args, ScriptContext ctx) {
        return switch (obj) {
