...
/**
 * [TASK-01] EntityBlock behavior for the fuel-driven Vapor Furnace Mk1
 * ({@code polyfills:vapor_furnace_mk1}). Accepts the same {@code upgrades:} config form as the
 * crusher / gas motor (item id -> list of attribute mods) and a {@code bars:} block for the
 * water / steam fill bars. Delegates all logic to {@link VaporFurnaceMk1BlockEntity}.
 */
public class VaporFurnaceMk1Behavior extends MachineBlockBehavior {

    public static final Key POLYFILL_VAPOR_FURNACE_MK1 = Key.of("polyfills:vapor_furnace_mk1");
