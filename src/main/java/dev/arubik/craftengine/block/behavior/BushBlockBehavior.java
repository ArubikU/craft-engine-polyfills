...
public class BushBlockBehavior extends AbstractCanSurviveBlockBehavior {
  ...
  public BushBlockBehavior(BlockDefinition block, int delay, boolean blacklist, boolean stackable, boolean ageDirection,
  ...
  public static class Factory implements BlockBehaviorFactory<BlockBehavior> {
    public BlockBehavior create(BlockDefinition block, ConfigSection arguments) {
      ...
      boolean stackable = dev.arubik.craftengine.util.Utils.getAsBoolean(arguments.getOrDefault("stackable", Boolean.valueOf(false)),
          "stackable");
      int delay = dev.arubik.craftengine.util.Utils.getAsInt(arguments.getOrDefault("delay", Integer.valueOf(0)), "delay");
      ...
      boolean ageDirection = dev.arubik.craftengine.util.Utils.getAsBoolean(
  ...
  protected boolean canSurvive(Object thisBlock, Object state, Object world, Object blockPos) {
    int y = dev.arubik.craftengine.util.MNms.INSTANCE.field$Vec3i$y(blockPos);
    ...
    Object belowPos = dev.arubik.craftengine.util.MNms.INSTANCE.constructor$BlockPos(x, y - 1, z);
  ...
  protected boolean mayPlaceOn(Object belowState, Object world, Object belowPos) {
    for (Object tag : this.tagsCanSurviveOn) {
      if (dev.arubik.craftengine.util.MNms.INSTANCE.method$BlockStateBase$is(belowState, tag))
    ...
    if (optionalCustomState.isEmpty()) {
      ...
      if (belowCustomState.owner().value() == this.block())
  ...
  public void onPlace(Object thisBlock, Object[] args) {
    ...
    dev.arubik.craftengine.util.MNms.INSTANCE.method$LevelWriter$setBlock(world, LocationUtils.toBlockPos(pos),
        tipState.customBlockState().minecraftState(),
        (UpdateFlags.UPDATE_IMMEDIATE | UpdateFlags.UPDATE_CLIENTS));
  ...
  public boolean isTip(Object world, Object pos) {
    ...
    if (above == null)
      return true;
    BlockDefinition cb = above.customBlock();
    if (cb == null)
      return true;
    if (cb == this.block())
      return false;
  ...
  protected void updateBlocks(Object world, Object topPos) {
    ...
    while (true) {
      ...
      if (biw == null)
        break;
      BlockDefinition cb = biw.customBlock();
      if (cb == null)
        break;
      ImmutableBlockState belowState = biw.customBlockState();
      if (belowState == null)
        break;
      if (belowState.owner().value() != this.block())
        break;
      if (tipState == null)
        tipState = belowState;
      ...
      dev.arubik.craftengine.util.MNms.INSTANCE.method$LevelWriter$setBlock(world, LocationUtils.toBlockPos(pos),
          belowState.customBlockState().minecraftState(),
          (UpdateFlags.UPDATE_IMMEDIATE | UpdateFlags.UPDATE_CLIENTS));
