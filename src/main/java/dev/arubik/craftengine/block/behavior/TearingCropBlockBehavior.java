...
public class TearingCropBlockBehavior extends BukkitBlockBehavior {
  ...
  public TearingCropBlockBehavior(CustomBlock block, Property<Integer> ageProperty, float growSpeed, boolean water, int heightLimit, boolean blacklist, List<Object> tagsCanSurviveOn, Set<Object> blockStatesCanSurviveOn, Set<String> customBlocksCansSurviveOn) {
    super(block);
  ...
  public void randomTick(Object thisBlock, Object[] args, Callable<Object> superMethod) throws Exception {
    ...
    if (!canTear(world, tearing))
      return; 
    BukkitExistingBlock block = (BukkitExistingBlock)world.getBlockAt(pos);
    int age = getAge(block.customBlockState());
    if (age < this.ageProperty.max) {
      BukkitExistingBlock blockInWorld = (BukkitExistingBlock)world.getBlockAt(pos);
      blockInWorld.block().setBlockData(BlockStateUtils.fromBlockData(block.customBlock().defaultState().with((Property)this.ageProperty, Integer.valueOf(age + 1)).customBlockState().literalObject()));
    } 
  }
  ...
  public static class Factory implements BlockBehaviorFactory {
    ...
    public BlockBehavior create(CustomBlock block, Map<String, Object> arguments) {
      ...
      float growSpeed = ResourceConfigUtils.getAsFloat(arguments.getOrDefault("grow-speed", Float.valueOf(0.125F)), "grow-speed");
      ...
      return (BlockBehavior)new TearingCropBlockBehavior(block, ageProperty, growSpeed, water.booleanValue(), heightLimit, blacklistMode, (List<Object>)tuple.left(), (Set<Object>)tuple.mid(), (Set<String>)tuple.right());
    }
  }
}
