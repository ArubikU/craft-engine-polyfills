...
import dev.arubik.craftengine.rotation.AdvancedVaporMotorBlockEntity.GasSpec;
 ...
 */
public class AdvancedVaporMotorBehavior extends MachineBlockBehavior {

    public static final Key POLYFILL_ADVANCED_VAPOR_MOTOR = Key.of("polyfills:advanced_vapor_motor");
    ...
    public AdvancedVaporMotorBehavior(BlockDefinition block,
    ...
    public BlockEntityController createBlockEntityController(BlockEntity blockEntity) {
        return new AdvancedVaporMotorBlockEntity(blockEntity, vaporCapacity, gases, upgradeDefs);
    }
    ...
    public static class Factory implements BlockBehaviorFactory<BlockBehavior> {
        ...
        public BlockBehavior create(BlockDefinition block, ConfigSection arguments) {
            ...
            return new AdvancedVaporMotorBehavior(block, base.getConnectableFaces(),
