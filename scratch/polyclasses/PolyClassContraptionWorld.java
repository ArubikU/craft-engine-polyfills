...
extends PolyClassWorld {
    ...
    public static PolyClassContraptionWorld ofVar(ScriptContext scriptContext, String string) {
        return PolyClassContraptionWorld.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
