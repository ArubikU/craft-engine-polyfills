...
public class PolyClassServer {
    ...
    public static PolyClassServer ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
    ...
    public static PolyClassServer ofVar(ScriptContext scriptContext, String string) {
        return PolyClassServer.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
