...
extends PolyClassEvent {
    ...
    public static PolyClassVehicleMoveEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassVehicleMoveEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
