...
extends PolyClassBlockMetadata {
    ...
    public static PolyClassContainerMetadata ofVar(ScriptContext scriptContext, String string) {
        return PolyClassContainerMetadata.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
