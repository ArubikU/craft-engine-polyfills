...
extends PolyClassEvent {
    ...
    public static void refresh() {
        ...
        tp$3 = (PolyType.TypedPropertyHandler)PolyClassRuntime.resolveTypedPropertyHandler((String)"EntityCombustEvent", (String)"duration", (String)"D");
    }
    ...
    public double tg$3_duration() {
        if (tp$3 != null) {
            return (Double)tp$3.get(this.instance);
        }
        return PolyClassRuntime.genericProperty((String)"EntityCombustEvent", (String)"duration", (Object)this.instance).asNum();
    }
    ...
    public static PolyClassEntityCombustEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("EntityCombustEvent")) {
            return new PolyClassEntityCombustEvent(object);
        }
        return null;
    }

    public static PolyClassEntityCombustEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityCombustEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
