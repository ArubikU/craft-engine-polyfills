...
extends PolyClassEvent {
    ...
    public static PolyClassSpawnChangeEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassSpawnChangeEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
