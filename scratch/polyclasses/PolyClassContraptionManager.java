...
public class PolyClassContraptionManager {
    ...
    public static PolyClassContraptionManager ofVar(ScriptContext scriptContext, String string) {
        return PolyClassContraptionManager.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
