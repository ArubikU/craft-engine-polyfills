...
extends PolyClassEvent {
    ...
    public static PolyClassEntityTeleportEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("EntityTeleportEvent")) {
            return new PolyClassEntityTeleportEvent(object);
        }
        return null;
    }

    public static PolyClassEntityTeleportEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityTeleportEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
