...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerInteractEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerInteractEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
