...
extends PolyClassEvent {
    ...
    public static PolyClassEntitySpawnEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("EntitySpawnEvent")) {
            return new PolyClassEntitySpawnEvent(object);
        }
        return null;
    }

    public static PolyClassEntitySpawnEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntitySpawnEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
