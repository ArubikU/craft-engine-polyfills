...
public class PolyClassMachine_v4
extends PolyClassBlock {
    ...
    public PolyClassMachine_v4(Object object) {
        super(object);
    }

    public static PolyClassMachine_v4 of(Object object) {
        return new PolyClassMachine_v4(object);
    }

    public static PolyClassMachine_v4 ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
    ...
    public static PolyClassMachine_v4 ofVar(ScriptContext scriptContext, String string) {
        return PolyClassMachine_v4.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
