...
extends PolyClassEvent {
    ...
    public static void refresh() {
        ...
        p$3 = PolyClassRuntime.resolvePropertyHandler((String)"FurnaceBurnEvent", (String)"burn_time");
        p$4 = PolyClassRuntime.resolvePropertyHandler((String)"FurnaceBurnEvent", (String)"fuel");
    }
    ...
    public ScriptValue pg$3_burn_time() {
        if (p$3 != null) {
