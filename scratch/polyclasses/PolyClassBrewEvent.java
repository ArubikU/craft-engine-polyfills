...
extends PolyClassEvent {
    ...
    public static PolyClassBrewEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBrewEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
