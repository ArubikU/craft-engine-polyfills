...
extends PolyClassEvent {
    ...
    public static PolyClassVehicleEntityCollisionEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("VehicleEntityCollisionEvent")) {
            return new PolyClassVehicleEntityCollisionEvent(object);
        }
        return null;
    }

    public static PolyClassVehicleEntityCollisionEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassVehicleEntityCollisionEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
