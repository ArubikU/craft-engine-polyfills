...
extends PolyClassEvent {
    ...
    public static PolyClassTabCompleteEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassTabCompleteEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
