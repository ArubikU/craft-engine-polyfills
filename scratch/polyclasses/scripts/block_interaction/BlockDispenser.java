    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (bl) {
            ...
            if (scriptValue2 != ScriptValue.NULL) {
                ScriptValue.Obj obj;
                Object object7;
                if (scriptValue2 instanceof ScriptValue.Obj && (object7 = (obj = (ScriptValue.Obj)scriptValue2).instance()) != null && !(object7 instanceof PolyClass) && obj.typeName().equals("Block")) {
                    PolyClassBlock_v4 polyClassBlock_v43 = new PolyClassBlock_v4(object7);
                    object = polyClassBlock_v43.tm$20_break_and_drop();
                } else {
                    object = PolyDispatch.bootstrapCall("memberCall", "break_and_drop", (ScriptValue)scriptValue2, (ScriptContext)scriptContext);
                }
            } else {
                object = ScriptValue.NULL;
            }
            ScriptValue scriptValue15 = object;
            builder.val("drops", scriptValue15);
            List list = ScriptProgram.elementsOf((ScriptValue)scriptValue15);
            if (list != null) {
                for (ScriptValue scriptValue16 : list) {
                    ...
                    builder.val("drop", scriptValue16);
                    PolyClassMachine polyClassMachine4 = PolyClassMachine.ofVar((ScriptContext)scriptContext, (String)"Machine");
                    ScriptValue scriptValue18 = polyClassMachine4 != null ? polyClassMachine4.pg$120_container() : ((scriptValue17 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue17, (ScriptContext)scriptContext) : ScriptValue.NULL);
                    ScriptValue scriptValue19 = scriptValue16;
                    if (scriptValue18 instanceof ScriptValue.Obj && (object8 = (obj = (ScriptValue.Obj)scriptValue18).instance()) != null && !(object8 instanceof PolyClass) && obj.typeName().equals("Container")) {
