    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (list != null) {
            for (ScriptValue[] scriptValueArray : list) {
                ...
                ScriptValue scriptValue8 = scriptValue7 != ScriptValue.NULL ? (scriptValue7 instanceof ScriptValue.Obj && (object5 = (obj3 = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object5 instanceof PolyClass) && obj3.typeName().equals("Machine") ? new PolyClassMachine_v4(object5).pg$167_y() : PolyDispatch.bootstrapGet("memberGet", "y", (ScriptValue)scriptValue7, (ScriptContext)scriptContext)) : ScriptValue.NULL;
