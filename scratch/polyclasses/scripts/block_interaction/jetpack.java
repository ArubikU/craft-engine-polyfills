...
public final class Jetpack {
    ...
    public static ScriptValue onEquippedTick(ScriptContext.Builder builder) {
        block58: {
            ...
            ScriptContext scriptContext = builder.peek();
            ScriptValue scriptValue = scriptContext.getClassOrVar("Player");
            boolean bl = (scriptValue != ScriptValue.NULL ? (scriptValue instanceof ScriptValue.Obj && (object5 = (obj4 = (ScriptValue.Obj)scriptValue).instance()) != null && !(object5 instanceof PolyClass) && obj4.typeName().equals("Player") ? new PolyClassPlayer(object5).pg$40_is_on_ground() : PolyDispatch.bootstrapGet("memberGet", "is_on_ground", (ScriptValue)scriptValue, (ScriptContext)scriptContext)) : ScriptValue.NULL).asBool() ^ true;
            ...
            ScriptValue scriptValue4 = scriptValue3 != ScriptValue.NULL ? (scriptValue3 instanceof ScriptValue.Obj && (object4 = (obj3 = (ScriptValue.Obj)scriptValue3).instance()) != null && !(object4 instanceof PolyClass) && obj3.typeName().equals("Player") ? new PolyClassPlayer(object4).pg$38_is_sneaking() : PolyDispatch.bootstrapGet("memberGet", "is_sneaking", (ScriptValue)scriptValue3, (ScriptContext)scriptContext)) : ScriptValue.NULL;
            ...
            if (scriptValue7 != ScriptValue.NULL) {
                ...
                Object object6;
                String string = "gas";
                if (scriptValue7 instanceof ScriptValue.Obj && (object6 = (obj5 = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object6 instanceof PolyClass) && obj5.typeName().equals("Item")) {
                    PolyClassItem polyClassItem = new PolyClassItem(object6);
                    object3 = ScriptValue.of((double)polyClassItem.tm$24_tank(string));
                } else {
                    ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                    arrayList.add(ScriptValue.of((String)string));
                    object3 = PolyDispatch.bootstrapCall("memberCall", "tank", (ScriptValue)scriptValue7, arrayList, (ScriptContext)scriptContext);
                }
            } else {
            ...
            ScriptValue scriptValue10 = scriptValue9 != ScriptValue.NULL ? (scriptValue9 instanceof ScriptValue.Obj && (object2 = (obj2 = (ScriptValue.Obj)scriptValue9).instance()) != null && !(object2 instanceof PolyClass) && obj2.typeName().equals("Player") ? new PolyClassPlayer(object2).pg$42_velocity() : PolyDispatch.bootstrapGet("memberGet", "velocity", (ScriptValue)scriptValue9, (ScriptContext)scriptContext)) : ScriptValue.NULL;
            ...
            if (ScriptFormula.valuesEqual((ScriptValue)scriptValue5, (ScriptValue)scriptValue4)) {
                ...
                Object object7 = scriptValue11 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "y", (ScriptValue)scriptValue11, (ScriptContext)scriptContext) : ScriptValue.NULL;
                if (object7.asNum() > 0.0) {
                    ...
                    if (scriptValue12 != ScriptValue.NULL) {
                        ...
                        Object object9 = scriptValue13 = scriptValue17 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "z", (ScriptValue)scriptValue17, (ScriptContext)scriptContext) : ScriptValue.NULL;
                        if (scriptValue12 instanceof ScriptValue.Obj && (object8 = (obj6 = (ScriptValue.Obj)scriptValue12).instance()) != null && !(object8 instanceof PolyClass) && obj6.typeName().equals("Player")) {
                            PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object8);
                            v3 = ScriptValue.of((boolean)polyClassPlayer.tm$16_set_velocity(scriptValue15.asNum(), d, scriptValue13.asNum()));
                        } else {
                            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                    ...
                    Object object10 = scriptValue18 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "y", (ScriptValue)scriptValue18, (ScriptContext)scriptContext) : ScriptValue.NULL;
                    if (object10.asNum() < 0.0 && bl) {
                        ...
                        if (scriptValue19 != ScriptValue.NULL) {
                            ...
                            Object object12 = scriptValue20 = scriptValue24 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "z", (ScriptValue)scriptValue24, (ScriptContext)scriptContext) : ScriptValue.NULL;
                            if (scriptValue19 instanceof ScriptValue.Obj && (object11 = (obj7 = (ScriptValue.Obj)scriptValue19).instance()) != null && !(object11 instanceof PolyClass) && obj7.typeName().equals("Player")) {
                                PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object11);
                                v6 = ScriptValue.of((boolean)polyClassPlayer.tm$16_set_velocity(scriptValue22.asNum(), d, scriptValue20.asNum()));
                            } else {
                                ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                ...
                if (scriptValue25 != ScriptValue.NULL) {
                    ...
                    Object object14 = scriptValue26 = scriptValue30 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "z", (ScriptValue)scriptValue30, (ScriptContext)scriptContext) : ScriptValue.NULL;
                    if (scriptValue25 instanceof ScriptValue.Obj && (object13 = (obj8 = (ScriptValue.Obj)scriptValue25).instance()) != null && !(object13 instanceof PolyClass) && obj8.typeName().equals("Player")) {
                        PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object13);
                        v8 = ScriptValue.of((boolean)polyClassPlayer.tm$16_set_velocity(scriptValue28.asNum(), d, scriptValue26.asNum()));
                    } else {
                        ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                ...
                if (scriptValue31 != ScriptValue.NULL) {
                    ...
                    Object object16 = scriptValue32 = scriptValue36 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "z", (ScriptValue)scriptValue36, (ScriptContext)scriptContext) : ScriptValue.NULL;
                    if (scriptValue31 instanceof ScriptValue.Obj && (object15 = (obj9 = (ScriptValue.Obj)scriptValue31).instance()) != null && !(object15 instanceof PolyClass) && obj9.typeName().equals("Player")) {
                        PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object15);
                        v10 = ScriptValue.of((boolean)polyClassPlayer.tm$16_set_velocity(scriptValue34.asNum(), d, scriptValue32.asNum()));
                    } else {
                        ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            ...
            if (scriptValue37 != ScriptValue.NULL) {
                ...
                Object object17;
                if (scriptValue37 instanceof ScriptValue.Obj && (object17 = (obj10 = (ScriptValue.Obj)scriptValue37).instance()) != null && !(object17 instanceof PolyClass) && obj10.typeName().equals("Entity")) {
                    PolyClassEntity polyClassEntity = new PolyClassEntity(object17);
            ...
            if (scriptValue39 != ScriptValue.NULL) {
                ...
                String string = "gas";
                double d2 = d;
                if (scriptValue39 instanceof ScriptValue.Obj && (object18 = (obj11 = (ScriptValue.Obj)scriptValue39).instance()) != null && !(object18 instanceof PolyClass) && obj11.typeName().equals("Item")) {
                    PolyClassItem polyClassItem = new PolyClassItem(object18);
            ...
            ScriptValue scriptValue41 = scriptValue40 != ScriptValue.NULL ? (scriptValue40 instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue40).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Player") ? new PolyClassPlayer(object).pg$32_pos() : PolyDispatch.bootstrapGet("memberGet", "pos", (ScriptValue)scriptValue40, (ScriptContext)scriptContext)) : ScriptValue.NULL;
            ...
            if (scriptValue42 != ScriptValue.NULL) {
                ...
                double d7 = 0.1;
                double d8 = 0.01;
                if (scriptValue42 instanceof ScriptValue.Obj && (object19 = (obj12 = (ScriptValue.Obj)scriptValue42).instance()) != null && !(object19 instanceof PolyClass) && obj12.typeName().equals("World")) {
            ...
            if (scriptValue48 != ScriptValue.NULL) {
                ...
                double d13 = 0.08;
                double d14 = 0.005;
                if (scriptValue48 instanceof ScriptValue.Obj && (object20 = (obj13 = (ScriptValue.Obj)scriptValue48).instance()) != null && !(object20 instanceof PolyClass) && obj13.typeName().equals("World")) {
                    PolyClassWorld polyClassWorld = new PolyClassWorld(object20);
            ...
            if (scriptValue54 != ScriptValue.NULL) {
                ...
                double d15 = 0.1;
                double d16 = 1.8;
                if (scriptValue54 instanceof ScriptValue.Obj && (object21 = (obj14 = (ScriptValue.Obj)scriptValue54).instance()) != null && !(object21 instanceof PolyClass) && obj14.typeName().equals("World")) {
            ...
            if (scriptValue61 != ScriptValue.NULL) {
                ...
                double d17 = 60.0;
                double d18 = 0.0;
                if (scriptValue61 instanceof ScriptValue.Obj && (object22 = (obj15 = (ScriptValue.Obj)scriptValue61).instance()) != null && !(object22 instanceof PolyClass) && obj15.typeName().equals("Entity")) {
                    PolyClassEntity polyClassEntity = new PolyClassEntity(object22);
            ...
            if (scriptValue62 != ScriptValue.NULL) {
                ...
                if (scriptValue62 instanceof ScriptValue.Obj && (object23 = (obj16 = (ScriptValue.Obj)scriptValue62).instance()) != null && !(object23 instanceof PolyClass) && obj16.typeName().equals("Player")) {
                    PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object23);
                    v17 = ScriptValue.of((boolean)polyClassPlayer.tm$42_send_message(string));
                } else {
                    ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                    arrayList.add(ScriptValue.of((String)string));
