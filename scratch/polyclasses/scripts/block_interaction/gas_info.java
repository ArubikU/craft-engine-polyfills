...
public final class GasInfo {
    ...
    public static ScriptValue name(ScriptContext.Builder builder) {
        ...
        return ScriptFormula.addPolymorphic((ScriptValue)ScriptValue.of((String)"<aqua>"), (ScriptValue)scriptValue3);
    }
    ...
    public static ScriptValue lore(ScriptContext.Builder builder) {
        ...
        ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
        arrayList.add(ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptValue.of((String)"<gray>Level: <white>"), (ScriptValue)scriptValue3), (ScriptValue)ScriptValue.of((String)" / ")), (ScriptValue)scriptValue5), (ScriptValue)ScriptValue.of((String)" mB")));
