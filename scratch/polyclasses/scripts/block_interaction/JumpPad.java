            ...
            for (ScriptValue scriptValue10 : list) {
                ...
                if (bl) {
                    ...
                    if (scriptValue12 != ScriptValue.NULL) {
                        ...
                        arrayList.add( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", JumpPad.class, 0.0));
                        object5 = PolyDispatch.bootstrapCall("memberCall", "push", (ScriptValue)scriptValue12, (ScriptValue)ScriptFormula.callBuiltin((String)"vec", arrayList, (ScriptContext)scriptContext), (ScriptContext)scriptContext);
                        continue;
                    }
                ...
                arrayList.add((ScriptValue)(scriptValue13 != ScriptValue.NULL ? ((polyClassMachine_v25 = PolyClassMachine_v2.ofGuarded((ScriptValue)scriptValue13)) != null ? polyClassMachine_v25.pg$133_facing_dx() : PolyDispatch.bootstrapGet("memberGet", "facing_dx", (ScriptValue)scriptValue13, (ScriptContext)scriptContext)) : ScriptValue.NULL));
                arrayList.add( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", JumpPad.class, 0.0));
                ScriptValue scriptValue14 = scriptContext.getClassOrVar("Machine");
                arrayList.add((ScriptValue)(scriptValue14 != ScriptValue.NULL ? ((polyClassMachine_v24 = PolyClassMachine_v2.ofGuarded((ScriptValue)scriptValue14)) != null ? polyClassMachine_v24.pg$131_facing_dz() : PolyDispatch.bootstrapGet("memberGet", "facing_dz", (ScriptValue)scriptValue14, (ScriptContext)scriptContext)) : ScriptValue.NULL));
