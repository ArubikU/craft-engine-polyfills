        ...
        if (list != null) {
            for (ScriptValue scriptValue10 : list) {
                ...
                if (scriptValue15 != ScriptValue.NULL) {
                    ...
                    object6 = PolyDispatch.bootstrapCall("memberCall", "scale", (ScriptValue)scriptValue15, arrayList6, (ScriptContext)scriptContext);
                } else {
                ...
                if (scriptValue16 != ScriptValue.NULL) {
                    ...
                    object5 = PolyDispatch.bootstrapCall("memberCall", "push", (ScriptValue)scriptValue16, arrayList7, (ScriptContext)scriptContext);
                    continue;
                }
