...
public final class RecipeInfo {
    ...
    public static ScriptValue name(ScriptContext.Builder builder) {
        ...
        if (ScriptFormula.valuesEqual((ScriptValue)(polyClassMachine_v2 != null ? polyClassMachine_v2.pg$162_working_recipe() : ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "working_recipe", (ScriptValue)scriptValue, (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptValue)scriptContext.getClassOrVar("null")) ^ true) {
            ...
            return ScriptValue.of((String)(scriptValue4.asStr() + " <yellow>" + ScriptFormula.numToStr((double)Math.floor((polyClassMachine_v22 = PolyClassMachine_v2.ofVar((ScriptContext)scriptContext, (String)"Machine")) != null ? polyClassMachine_v22.tg$149_progress_percent() : ((scriptValue5 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "progress_percent", (ScriptValue)scriptValue5, (ScriptContext)scriptContext).asNum() : ScriptValue.NULL.asNum()))) + "%"));
        }
    ...
    public static ScriptValue lore(ScriptContext.Builder var0) {
        block22: {
            ...
            var13_10 = PolyClassMachine_v2.ofVar((ScriptContext)var1_1, (String)"Machine");
            ...
            if (var15_12) {
                ...
                var20_17 = PolyClassMachine_v2.ofVar((ScriptContext)var1_1, (String)"Machine");
            ...
            if ((var3_3 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "fuel_required", (ScriptValue)var3_3, (ScriptContext)var1_1) : ScriptValue.NULL).asBool()) {
                var71_63 = PolyClassMachine_v2.ofVar((ScriptContext)var1_1, (String)"Machine");
                ...
                if (v13 > 0.0) {
                    var75_65 = PolyClassMachine_v2.ofVar((ScriptContext)var1_1, (String)"Machine");
