    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (list != null) {
            for (ScriptValue[] scriptValueArray : list) {
                ...
                arrayList3.add((ScriptValue)(scriptValue12 != ScriptValue.NULL ? (scriptValue12 instanceof ScriptValue.Obj && (object9 = (obj5 = (ScriptValue.Obj)scriptValue12).instance()) != null && !(object9 instanceof PolyClass) && obj5.typeName().equals("Machine") ? new PolyClassMachine_v3(object9).pg$126_facing_dx() : PolyDispatch.bootstrapGet("memberGet", "facing_dx", (ScriptValue)scriptValue12, (ScriptContext)scriptContext)) : ScriptValue.NULL));
