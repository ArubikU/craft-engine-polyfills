...
public final class Spike {
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (scriptValue2.asNum() > 0.0) {
            ...
            ScriptValue scriptValue7 = polyClassMachine_v2 != null ? polyClassMachine_v2.pg$120_container() : ((scriptValue6 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue6, (ScriptContext)scriptContext) : ScriptValue.NULL);
            double d = 0.0;
            ...
            ScriptValue scriptValue9 = polyClassMachine_v22 != null ? polyClassMachine_v22.pg$210_owner_uuid() : ((scriptValue5 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "owner_uuid", (ScriptValue)scriptValue5, (ScriptContext)scriptContext) : ScriptValue.NULL);
            ...
            if (scriptValue10 != ScriptValue.NULL) {
                ...
                if (scriptValue10 instanceof ScriptValue.Obj && (object6 = (obj2 = (ScriptValue.Obj)scriptValue10).instance()) != null && !(object6 instanceof PolyClass) && obj2.typeName().equals("Machine")) {
                    ...
                    object4 = polyClassMachine_v23.tm$94_nearby_entities(d2);
                } else {
            ...
            if (scriptValue14.asNum() > 0.0) {
                ...
                if (scriptValue19 != ScriptValue.NULL) {
                    ...
                    if (scriptValue19 instanceof ScriptValue.Obj && (object8 = (obj3 = (ScriptValue.Obj)scriptValue19).instance()) != null && !(object8 instanceof PolyClass) && obj3.typeName().equals("Machine")) {
                        PolyClassMachine_v2 polyClassMachine_v24 = new PolyClassMachine_v2(object8);
                        v5 = ScriptValue.of((boolean)polyClassMachine_v24.tm$82_set_typed(string, string4, scriptValue20));
                    } else {
