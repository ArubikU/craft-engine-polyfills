    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (d > 0.0 && ScriptFormula.valuesEqual((ScriptValue)scriptValue4, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", RedstoneLatch.class, 0.0)))) {
            ...
            if (scriptValue3 != ScriptValue.NULL) {
                ...
                object3 = polyClassMachine_v34 != null ? polyClassMachine_v34.tm$34_get_typed(string, string4) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue3, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string4), (ScriptContext)scriptContext);
            } else {
                object3 = ScriptValue.NULL;
            }
            ScriptValue scriptValue6 = object3;
            builder.val("latched", scriptValue6);
            double d2 = scriptValue6.asNum() > 0.0 ? 0.0 : 1.0;
            ScriptValue scriptValue7 = ScriptValue.of((double)d2);
            builder.val("new_state", scriptValue7);
            if (scriptValue3 != ScriptValue.NULL) {
                String string = "latched";
                String string5 = "int";
                ...
                v4 = polyClassMachine_v35 != null ? ScriptValue.of((boolean)polyClassMachine_v35.tm$82_set_typed(string, string5, scriptValue8)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue3, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string5), (ScriptValue)scriptValue8, (ScriptContext)scriptContext);
            } else {
                v4 = ScriptValue.NULL;
            }
            if (scriptValue3 != ScriptValue.NULL) {
                ...
                v5 = polyClassMachine_v36 != null ? ScriptValue.of((boolean)polyClassMachine_v36.tm$108_emit_redstone(d3)) : PolyDispatch.bootstrapCall("memberCall", "emit_redstone", (ScriptValue)scriptValue3, (ScriptValue)ScriptValue.of((double)d3), (ScriptContext)scriptContext);
            } else {
                v5 = ScriptValue.NULL;
            }
        }
