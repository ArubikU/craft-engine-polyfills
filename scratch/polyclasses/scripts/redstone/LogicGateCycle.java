 ...
 */
public final class LogicGateCycle {
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        double d = 6.0;
        double d2 = 6.0 == 0.0 ? 0.0 : ScriptFormula.addPolymorphic((ScriptValue)scriptContext.getClassOrVar("mode"), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", LogicGateCycle.class, 1.0))).asNum() % d;
