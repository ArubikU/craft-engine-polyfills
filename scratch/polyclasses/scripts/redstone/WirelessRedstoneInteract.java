        ...
        if (polyClassPlayer_v2 != null ? polyClassPlayer_v2.tg$49_is_sneaking() : ((scriptValue = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "is_sneaking", (ScriptValue)scriptValue, (ScriptContext)scriptContext).asBool() : ScriptValue.NULL.asBool())) {
            ...
            if (d == 0.0) {
                ...
                if (scriptValue8 != ScriptValue.NULL) {
                    ...
                    if (scriptValue8 instanceof ScriptValue.Obj && (object5 = (obj = (ScriptValue.Obj)scriptValue8).instance()) != null && !(object5 instanceof PolyClass) && obj.typeName().equals("Player")) {
                        ...
                        v3 = ScriptValue.of((boolean)polyClassPlayer_v23.tm$42_send_message(string));
                    } else {
            ...
            if (scriptValue14 != ScriptValue.NULL) {
                ...
                if (scriptValue14 instanceof ScriptValue.Obj && (object8 = (obj = (ScriptValue.Obj)scriptValue14).instance()) != null && !(object8 instanceof PolyClass) && obj.typeName().equals("Player")) {
                    ...
                    v6 = ScriptValue.of((boolean)polyClassPlayer_v24.tm$42_send_message(scriptValue15.asStr()));
                } else {
