...
public final class Gomoku {
    ...
    public static ScriptValue openGomoku(ScriptContext.Builder builder) {
        ...
        if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue5, (ScriptContext)scriptContext).asBool() || ScriptFormula.valuesEqualStr((ScriptValue)scriptValue5, (String)"")) {
            ...
            if (scriptValue6 != ScriptValue.NULL) {
                ...
                v0 = polyClassPlayer_v22 != null ? ScriptValue.of((boolean)polyClassPlayer_v22.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue6, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v0 = ScriptValue.NULL;
            }
        ...
        if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue13, (ScriptContext)scriptContext).asBool()) {
            ...
            if (scriptValue14 != ScriptValue.NULL) {
                ...
                PolyClassPlayer_v2 polyClassPlayer_v24 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue14);
                v3 = polyClassPlayer_v24 != null ? ScriptValue.of((boolean)polyClassPlayer_v24.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue14, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v3 = ScriptValue.NULL;
            }
            return ScriptValue.NULL;
        ...
        if (ScriptFormula.valuesEqual((ScriptValue)(scriptValue13 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue13, (ScriptContext)scriptContext) : ScriptValue.NULL), (ScriptValue)((polyClassPlayer_v2 = PolyClassPlayer_v2.ofVar((ScriptContext)scriptContext, (String)"Player")) != null ? polyClassPlayer_v2.pg$67_name() : ((scriptValue3 = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue3, (ScriptContext)scriptContext) : ScriptValue.NULL)))) {
            ...
            if (scriptValue15 != ScriptValue.NULL) {
                ...
                v4 = polyClassPlayer_v25 != null ? ScriptValue.of((boolean)polyClassPlayer_v25.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue15, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v4 = ScriptValue.NULL;
            }
            return ScriptValue.NULL;
    ...
    public static ScriptValue ensureGame(ScriptContext.Builder builder) {
        ...
        if (scriptValue3 != ScriptValue.NULL) {
            ...
            ScriptValue scriptValue6 = Gomoku.turnKey(builder5);
            String string = "string";
            ScriptValue scriptValue7 = scriptContext.getClassOrVar("CELL_BLACK");
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue3);
            v2 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue6.asStr(), string, scriptValue7)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue3, (ScriptValue)scriptValue6, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue7, (ScriptContext)scriptContext);
        } else {
            v2 = ScriptValue.NULL;
        }
        if (scriptValue3 != ScriptValue.NULL) {
            ...
            ScriptValue scriptValue8 = Gomoku.blackKey(builder6);
            String string = "string";
            ScriptValue scriptValue9 = scriptContext.getClassOrVar("starter");
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue3);
            v3 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue8.asStr(), string, scriptValue9)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue3, (ScriptValue)scriptValue8, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue9, (ScriptContext)scriptContext);
        } else {
            v3 = ScriptValue.NULL;
        }
        if (scriptValue3 != ScriptValue.NULL) {
            ...
            ScriptValue scriptValue10 = Gomoku.whiteKey(builder7);
            String string = "string";
            ScriptValue scriptValue11 = scriptContext.getClassOrVar("opponent");
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue3);
            v4 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue10.asStr(), string, scriptValue11)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue3, (ScriptValue)scriptValue10, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue11, (ScriptContext)scriptContext);
        } else {
            v4 = ScriptValue.NULL;
        }
        if (scriptValue3 != ScriptValue.NULL) {
            ...
            ScriptValue scriptValue12 = Gomoku.botKey(builder8);
            String string = "string";
            ScriptValue scriptValue13 = scriptContext.getBool("is_bot") ? ( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "1")) : ( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "0"));
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue3);
            v5 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue12.asStr(), string, scriptValue13)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue3, (ScriptValue)scriptValue12, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue13, (ScriptContext)scriptContext);
        } else {
            v5 = ScriptValue.NULL;
        }
        if (scriptValue3 != ScriptValue.NULL) {
            ...
            ScriptValue scriptValue14 = Gomoku.difficultyKey(builder9);
            String string = "string";
            ScriptValue scriptValue15 = scriptContext.getClassOrVar("difficulty");
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue3);
            v6 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue14.asStr(), string, scriptValue15)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue3, (ScriptValue)scriptValue14, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue15, (ScriptContext)scriptContext);
        } else {
            v6 = ScriptValue.NULL;
        }
        if (scriptValue3 != ScriptValue.NULL) {
            ...
            ScriptValue scriptValue16 = Gomoku.statusKey(builder10);
            String string = "string";
            ScriptValue scriptValue17 =  /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "active");
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue3);
            v7 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue16.asStr(), string, scriptValue17)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue3, (ScriptValue)scriptValue16, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue17, (ScriptContext)scriptContext);
        } else {
            v7 = ScriptValue.NULL;
        }
        return ScriptValue.NULL;
    ...
    public static ScriptValue showBoard(ScriptContext.Builder builder) {
        ...
        if (scriptValue != ScriptValue.NULL) {
            ...
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
            object4 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue4.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue4, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object4 = ScriptValue.NULL;
        }
        ScriptValue scriptValue5 = object4;
        builder.val("turn", scriptValue5);
        if (scriptValue != ScriptValue.NULL) {
            ScriptContext.Builder builder4 = ScriptContext.builder().copyFrom(scriptContext);
            builder4.val("gid", scriptContext.getClassOrVar("gid"));
            ScriptValue scriptValue6 = Gomoku.blackKey(builder4);
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
            object3 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue6.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue6, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object3 = ScriptValue.NULL;
        }
        ScriptValue scriptValue7 = object3;
        builder.val("black", scriptValue7);
        if (scriptValue != ScriptValue.NULL) {
            ScriptContext.Builder builder5 = ScriptContext.builder().copyFrom(scriptContext);
            builder5.val("gid", scriptContext.getClassOrVar("gid"));
            ScriptValue scriptValue8 = Gomoku.whiteKey(builder5);
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
            object2 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue8.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue8, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object2 = ScriptValue.NULL;
        }
        ScriptValue scriptValue9 = object2;
        builder.val("white", scriptValue9);
        if (scriptValue != ScriptValue.NULL) {
            ScriptContext.Builder builder6 = ScriptContext.builder().copyFrom(scriptContext);
            builder6.val("gid", scriptContext.getClassOrVar("gid"));
            ScriptValue scriptValue10 = Gomoku.statusKey(builder6);
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
            object = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue10.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue10, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object = ScriptValue.NULL;
        }
        ScriptValue scriptValue11 = object;
        builder.val("status", scriptValue11);
        boolean bl = ScriptFormula.valuesEqualStr((ScriptValue)scriptValue11, (String)"active") ^ true;
        ScriptValue scriptValue12 = ScriptValue.of((boolean)bl);
        builder.val("is_over", scriptValue12);
        ...
        ScriptValue scriptValue14 = scriptContext.getClassOrVar("cell_action");
        ScriptValue scriptValue15 = scriptContext.getClassOrVar("ch");
        ScriptValue scriptValue16 = scriptContext.getClassOrVar("btn");
        if (list != null) {
            for (ScriptValue scriptValue17 : list) {
                ...
                for (ScriptValue scriptValue18 : list2) {
                    ...
                    builder7.val("r", scriptValue17);
                    builder7.val("c", scriptValue18);
                    ScriptValue scriptValue19 = Gomoku.cellAt(builder7);
                    builder.val("ch", scriptValue19);
                    scriptValue15 = scriptValue19;
                    ScriptValue scriptValue20 = bl ? ( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "games/gomoku.pf:on_noop")) : ScriptValue.of((String)("games/gomoku.pf:on_cell_click:" + scriptContext.getStr("gid") + ":" + scriptValue17.asStr() + ":" + scriptValue18.asStr()));
                    builder.val("cell_action", scriptValue20);
                    scriptValue14 = scriptValue20;
                    ArrayList<ScriptValue> arrayList2 = new ArrayList<ScriptValue>();
                    arrayList2.add( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "label"));
                    ScriptContext.Builder builder8 = ScriptContext.builder().copyFrom(scriptContext);
                    builder8.val("ch", scriptValue15);
                    ...
                    ScriptValue scriptValue21 = ScriptFormula.callBuiltin((String)"make_map", arrayList2, (ScriptContext)scriptContext);
                    builder.val("btn", scriptValue21);
                    scriptValue16 = scriptValue21;
                    ScriptValue scriptValue22 = ScriptFormula.callBuiltin2((String)"push", (ScriptValue)scriptContext.getClassOrVar("buttons"), (ScriptValue)scriptValue16, (ScriptContext)scriptContext);
                    builder.val("buttons", scriptValue22);
                    array2 = scriptValue22;
                }
            }
        }
        ...
        ScriptValue scriptValue25 = scriptContext.getClassOrVar("buttons");
        ArrayList<ScriptValue> arrayList3 = new ArrayList<ScriptValue>();
        ...
        ScriptValue scriptValue26 = ScriptFormula.callBuiltin2((String)"push", (ScriptValue)scriptValue25, (ScriptValue)ScriptFormula.callBuiltin((String)"make_map", arrayList3, (ScriptContext)scriptContext), (ScriptContext)scriptContext);
        builder.val("buttons", scriptValue26);
        ScriptValue scriptValue27 = ScriptValue.of((String)("<gold>Gomoku <gray>- <yellow>" + scriptValue7.asStr() + " <gray>vs <yellow>" + scriptValue9.asStr()));
        builder.val("title", scriptValue27);
        ScriptValue scriptValue28 = scriptContext.getClassOrVar("Dialog");
        ScriptValue scriptValue29 = scriptContext.getClassOrVar("Images");
        CallSite callSite = PolyDispatch.bootstrapCall("memberCall", "body", (ScriptValue)(scriptValue28 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "base", (ScriptValue)scriptValue28, (ScriptValue)scriptValue27, (ScriptContext)scriptContext) : ScriptValue.NULL), (ScriptValue)(scriptValue29 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "from", (ScriptValue)scriptValue29, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "gomoku:ui")), (ScriptContext)scriptContext) : ScriptValue.NULL), (ScriptContext)scriptContext);
        ScriptContext.Builder builder9 = ScriptContext.builder().copyFrom(scriptContext);
        builder9.val("status", scriptValue11);
        builder9.val("turn", scriptValue5);
        builder9.val("black", scriptValue7);
        builder9.val("white", scriptValue9);
        PolyDispatch.bootstrapCall("memberCall", "show", (ScriptValue)PolyDispatch.bootstrapCall("memberCall", "as_multi_action", (ScriptValue)PolyDispatch.bootstrapCall("memberCall", "can_close_with_escape", (ScriptValue)PolyDispatch.bootstrapCall("memberCall", "body", (ScriptValue)callSite, (ScriptValue)Gomoku.statusLine(builder9), (ScriptContext)scriptContext), (ScriptValue)ScriptValue.of((boolean)(ScriptFormula.valuesEqualStr((ScriptValue)scriptValue11, (String)"active") ^ true)), (ScriptContext)scriptContext), (ScriptValue)scriptContext.getClassOrVar("Machine"), (ScriptValue)scriptValue26, (ScriptValue)scriptContext.getClassOrVar("BOARD_SIZE"), (ScriptContext)scriptContext), (ScriptValue)scriptContext.getClassOrVar("viewer"), (ScriptContext)scriptContext);
        return ScriptValue.NULL;
    }
    ...
    public static ScriptValue notifyOpponent(ScriptContext.Builder builder) {
        block7: {
            ...
            if (scriptValue2 != ScriptValue.NULL) {
                ...
                String string = "string";
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue2);
                object2 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue5.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue2, (ScriptValue)scriptValue5, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                object2 = ScriptValue.NULL;
            }
            ...
            PolyClassPlayer_v2 polyClassPlayer_v2 = PolyClassPlayer_v2.ofVar((ScriptContext)scriptContext, (String)"Player");
            ScriptValue scriptValue7 = ScriptFormula.valuesEqual((ScriptValue)(polyClassPlayer_v2 != null ? polyClassPlayer_v2.pg$67_name() : ((scriptValue = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue, (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptValue)scriptValue4) ? scriptValue6 : scriptValue4;
            builder.val("other_name", scriptValue7);
            if (scriptValue2 != ScriptValue.NULL) {
                ScriptValue scriptValue8 = scriptValue7;
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue2);
                object = polyClassServer != null ? polyClassServer.tm$10_get_player(scriptValue8.asStr()) : PolyDispatch.bootstrapCall("memberCall", "get_player", (ScriptValue)scriptValue2, (ScriptValue)scriptValue8, (ScriptContext)scriptContext);
            } else {
                object = ScriptValue.NULL;
            }
            ScriptValue scriptValue9 = object;
            builder.val("other", scriptValue9);
            if (!(ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue9, (ScriptContext)scriptContext).asBool() ^ true)) break block7;
            ScriptContext.Builder builder5 = ScriptContext.builder().copyFrom(scriptContext);
            builder5.val("gid", scriptContext.getClassOrVar("gid"));
            builder5.val("viewer", scriptValue9);
    ...
    public static ScriptValue notifyBothChat(ScriptContext.Builder builder) {
        block10: {
            ...
            if (scriptValue != ScriptValue.NULL) {
                ScriptContext.Builder builder3 = ScriptContext.builder().copyFrom(scriptContext);
                builder3.val("gid", scriptContext.getClassOrVar("gid"));
                ScriptValue scriptValue4 = Gomoku.whiteKey(builder3);
                String string = "string";
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
                object3 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue4.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue4, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                object3 = ScriptValue.NULL;
            }
            ScriptValue scriptValue5 = object3;
            builder.val("white", scriptValue5);
            if (scriptValue != ScriptValue.NULL) {
                ScriptValue scriptValue6 = scriptValue3;
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
                object2 = polyClassServer != null ? polyClassServer.tm$10_get_player(scriptValue6.asStr()) : PolyDispatch.bootstrapCall("memberCall", "get_player", (ScriptValue)scriptValue, (ScriptValue)scriptValue6, (ScriptContext)scriptContext);
            } else {
                object2 = ScriptValue.NULL;
            }
            ScriptValue scriptValue7 = object2;
            builder.val("b", scriptValue7);
            if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue7, (ScriptContext)scriptContext).asBool() ^ true) {
                Object object5 = scriptValue7 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue7, (ScriptValue)scriptContext.getClassOrVar("message"), (ScriptContext)scriptContext) : ScriptValue.NULL;
            }
            ScriptContext.Builder builder4 = ScriptContext.builder().copyFrom(scriptContext);
            builder4.val("gid", scriptContext.getClassOrVar("gid"));
            ...
            ScriptValue scriptValue9 = object;
            builder.val("w", scriptValue9);
            if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue9, (ScriptContext)scriptContext).asBool() ^ true) {
                Object object6 = scriptValue9 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue9, (ScriptValue)scriptContext.getClassOrVar("message"), (ScriptContext)scriptContext) : ScriptValue.NULL;
            }
        }
        return ScriptValue.NULL;
    }
    ...
    public static ScriptValue applyMove(ScriptContext.Builder builder) {
        block16: {
            ...
            if (scriptValue != ScriptValue.NULL) {
                ScriptContext.Builder builder4 = ScriptContext.builder().copyFrom(scriptContext);
                builder4.val("gid", scriptContext.getClassOrVar("gid"));
                ScriptValue scriptValue5 = Gomoku.boardKey(builder4);
                String string = "string";
                ScriptValue scriptValue6 = scriptValue4;
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
                v1 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue5.asStr(), string, scriptValue6)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue5, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue6, (ScriptContext)scriptContext);
            } else {
                v1 = ScriptValue.NULL;
            }
            if (scriptValue != ScriptValue.NULL) {
                ScriptContext.Builder builder5 = ScriptContext.builder().copyFrom(scriptContext);
                builder5.val("gid", scriptContext.getClassOrVar("gid"));
                ScriptValue scriptValue7 = Gomoku.blackKey(builder5);
                String string = "string";
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
                object2 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue7.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue7, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                object2 = ScriptValue.NULL;
            }
            ScriptValue scriptValue8 = object2;
            builder.val("black", scriptValue8);
            if (scriptValue != ScriptValue.NULL) {
                ScriptContext.Builder builder6 = ScriptContext.builder().copyFrom(scriptContext);
                builder6.val("gid", scriptContext.getClassOrVar("gid"));
                ScriptValue scriptValue9 = Gomoku.whiteKey(builder6);
                String string = "string";
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
                object = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue9.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue9, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                object = ScriptValue.NULL;
            }
            ScriptValue scriptValue10 = object;
            builder.val("white", scriptValue10);
            ScriptContext.Builder builder7 = ScriptContext.builder().copyFrom(scriptContext);
            ...
            if (Gomoku.hasFive(builder7).asBool()) {
                if (scriptValue != ScriptValue.NULL) {
                    ScriptContext.Builder builder8 = ScriptContext.builder().copyFrom(scriptContext);
                    builder8.val("gid", scriptContext.getClassOrVar("gid"));
                    ScriptValue scriptValue11 = Gomoku.statusKey(builder8);
                    String string = "string";
                    ScriptValue scriptValue12 = ScriptFormula.valuesEqual((ScriptValue)scriptContext.getClassOrVar("color"), (ScriptValue)scriptContext.getClassOrVar("CELL_BLACK")) ? ( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "black_win")) : ( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "white_win"));
                    PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
                    v4 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue11.asStr(), string, scriptValue12)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue11, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue12, (ScriptContext)scriptContext);
                } else {
                    v4 = ScriptValue.NULL;
                }
                ScriptValue scriptValue13 = ScriptFormula.valuesEqual((ScriptValue)scriptContext.getClassOrVar("color"), (ScriptValue)scriptContext.getClassOrVar("CELL_BLACK")) ? scriptValue8 : scriptValue10;
                builder.val("winner", scriptValue13);
                ScriptContext.Builder builder9 = ScriptContext.builder().copyFrom(scriptContext);
                builder9.val("gid", scriptContext.getClassOrVar("gid"));
                builder9.val("message", ScriptValue.of((String)("<gold>\u2726 <white>" + scriptValue13.asStr() + " wins the Gomoku match!")));
            ...
            if (Gomoku.isFull(builder10).asBool()) {
                if (scriptValue != ScriptValue.NULL) {
                    ...
                    ScriptValue scriptValue14 = Gomoku.statusKey(builder11);
                    String string = "string";
                    ScriptValue scriptValue15 =  /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "draw");
                    PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
                    v5 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue14.asStr(), string, scriptValue15)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue14, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue15, (ScriptContext)scriptContext);
                } else {
                    v5 = ScriptValue.NULL;
                }
            ...
            ScriptValue scriptValue16 = ScriptFormula.valuesEqual((ScriptValue)scriptContext.getClassOrVar("color"), (ScriptValue)scriptContext.getClassOrVar("CELL_BLACK")) ? scriptContext.getClassOrVar("CELL_WHITE") : scriptContext.getClassOrVar("CELL_BLACK");
            builder.val("next_turn", scriptValue16);
            if (scriptValue != ScriptValue.NULL) {
                ...
                ScriptValue scriptValue17 = Gomoku.turnKey(builder13);
                String string = "string";
                ScriptValue scriptValue18 = scriptValue16;
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue);
                v6 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue17.asStr(), string, scriptValue18)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue, (ScriptValue)scriptValue17, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue18, (ScriptContext)scriptContext);
            } else {
                v6 = ScriptValue.NULL;
            }
            ...
            if (!(Gomoku.isBotGame(builder14).asBool() && ScriptFormula.valuesEqual((ScriptValue)scriptValue16, (ScriptValue)scriptContext.getClassOrVar("CELL_WHITE")))) break block16;
            ScriptValue scriptValue19 = scriptContext.getClassOrVar("TaskManager");
            Object object4 = scriptValue19 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "schedule", (ScriptValue)scriptValue19, (ScriptValue)ScriptValue.of((String)("games/gomoku.pf:bot_move:" + scriptContext.getStr("gid"))), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", Gomoku.class, 15.0)), (ScriptContext)scriptContext) : ScriptValue.NULL;
        }
        return ScriptValue.NULL;
    }
    ...
    public static ScriptValue onCellClick(ScriptContext.Builder builder) {
        ...
        if (ScriptFormula.valuesEqualStr((ScriptValue)scriptValue8, (String)"active") ^ true) {
            ...
            if (scriptValue9 != ScriptValue.NULL) {
                ...
                PolyClassPlayer_v2 polyClassPlayer_v24 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue9);
                v1 = polyClassPlayer_v24 != null ? ScriptValue.of((boolean)polyClassPlayer_v24.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue9, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v1 = ScriptValue.NULL;
            }
            ScriptValue scriptValue10 = scriptContext.getClassOrVar("TaskManager");
            Object object6 = scriptValue10 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "schedule", (ScriptValue)scriptValue10, (ScriptValue)ScriptValue.of((String)("games/gomoku.pf:refresh_board:" + scriptContext.getStr("gid") + ":" + (scriptValue9 != ScriptValue.NULL ? ((polyClassPlayer_v23 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue9)) != null ? polyClassPlayer_v23.tg$68_name() : PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue9, (ScriptContext)scriptContext).asStr()) : ScriptValue.NULL.asStr()))), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", Gomoku.class, 0.0)), (ScriptContext)scriptContext) : ScriptValue.NULL;
            return ScriptValue.NULL;
        }
        if (scriptValue6 != ScriptValue.NULL) {
            ScriptContext.Builder builder3 = ScriptContext.builder().copyFrom(scriptContext);
            ...
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue6);
            object4 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue11.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue6, (ScriptValue)scriptValue11, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object4 = ScriptValue.NULL;
        }
        ...
        if (scriptValue6 != ScriptValue.NULL) {
            ...
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue6);
            object3 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue13.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue6, (ScriptValue)scriptValue13, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object3 = ScriptValue.NULL;
        }
        ...
        if (scriptValue6 != ScriptValue.NULL) {
            ScriptContext.Builder builder5 = ScriptContext.builder().copyFrom(scriptContext);
            builder5.val("gid", scriptContext.getClassOrVar("gid"));
            ScriptValue scriptValue15 = Gomoku.turnKey(builder5);
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue6);
            object2 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue15.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue6, (ScriptValue)scriptValue15, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object2 = ScriptValue.NULL;
        }
        ScriptValue scriptValue16 = object2;
        builder.val("turn", scriptValue16);
        ScriptValue scriptValue17 =  /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "");
        builder.val("my_color", scriptValue17);
        PolyClassPlayer_v2 polyClassPlayer_v25 = PolyClassPlayer_v2.ofVar((ScriptContext)scriptContext, (String)"Player");
        if (ScriptFormula.valuesEqual((ScriptValue)(polyClassPlayer_v25 != null ? polyClassPlayer_v25.pg$67_name() : ((scriptValue3 = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue3, (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptValue)scriptValue12)) {
            ScriptValue scriptValue18 = scriptContext.getClassOrVar("CELL_BLACK");
            builder.val("my_color", scriptValue18);
        }
        if (ScriptFormula.valuesEqual((ScriptValue)((polyClassPlayer_v22 = PolyClassPlayer_v2.ofVar((ScriptContext)scriptContext, (String)"Player")) != null ? polyClassPlayer_v22.pg$67_name() : ((scriptValue2 = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue2, (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptValue)scriptValue14)) {
            ScriptValue scriptValue19 = scriptContext.getClassOrVar("CELL_WHITE");
        ...
        if (scriptContext.getStr("my_color").equals("")) {
            ...
            if (scriptValue20 != ScriptValue.NULL) {
                ...
                PolyClassPlayer_v2 polyClassPlayer_v26 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue20);
                v6 = polyClassPlayer_v26 != null ? ScriptValue.of((boolean)polyClassPlayer_v26.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue20, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v6 = ScriptValue.NULL;
            }
            return ScriptValue.NULL;
        }
        if (ScriptFormula.valuesEqual((ScriptValue)scriptContext.getClassOrVar("my_color"), (ScriptValue)scriptValue16) ^ true) {
            ...
            if (scriptValue21 != ScriptValue.NULL) {
                ...
                PolyClassPlayer_v2 polyClassPlayer_v28 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue21);
                v7 = polyClassPlayer_v28 != null ? ScriptValue.of((boolean)polyClassPlayer_v28.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue21, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v7 = ScriptValue.NULL;
            }
            ScriptValue scriptValue22 = scriptContext.getClassOrVar("TaskManager");
            Object object7 = scriptValue22 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "schedule", (ScriptValue)scriptValue22, (ScriptValue)ScriptValue.of((String)("games/gomoku.pf:refresh_board:" + scriptContext.getStr("gid") + ":" + (scriptValue21 != ScriptValue.NULL ? ((polyClassPlayer_v27 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue21)) != null ? polyClassPlayer_v27.tg$68_name() : PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue21, (ScriptContext)scriptContext).asStr()) : ScriptValue.NULL.asStr()))), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", Gomoku.class, 0.0)), (ScriptContext)scriptContext) : ScriptValue.NULL;
            return ScriptValue.NULL;
        }
        if (scriptValue6 != ScriptValue.NULL) {
            ScriptContext.Builder builder6 = ScriptContext.builder().copyFrom(scriptContext);
            builder6.val("gid", scriptContext.getClassOrVar("gid"));
            ScriptValue scriptValue23 = Gomoku.boardKey(builder6);
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue6);
            object = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue23.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue6, (ScriptValue)scriptValue23, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object = ScriptValue.NULL;
        }
        ScriptValue scriptValue24 = object;
        builder.val("board", scriptValue24);
        ScriptContext.Builder builder7 = ScriptContext.builder().copyFrom(scriptContext);
        builder7.val("board", scriptValue24);
        ...
        if (ScriptFormula.valuesEqual((ScriptValue)Gomoku.cellAt(builder7), (ScriptValue)scriptContext.getClassOrVar("CELL_EMPTY")) ^ true) {
            ...
            if (scriptValue25 != ScriptValue.NULL) {
                ...
                PolyClassPlayer_v2 polyClassPlayer_v210 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue25);
                v10 = polyClassPlayer_v210 != null ? ScriptValue.of((boolean)polyClassPlayer_v210.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue25, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v10 = ScriptValue.NULL;
            }
            ScriptValue scriptValue26 = scriptContext.getClassOrVar("TaskManager");
            Object object8 = scriptValue26 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "schedule", (ScriptValue)scriptValue26, (ScriptValue)ScriptValue.of((String)("games/gomoku.pf:refresh_board:" + scriptContext.getStr("gid") + ":" + (scriptValue25 != ScriptValue.NULL ? ((polyClassPlayer_v29 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue25)) != null ? polyClassPlayer_v29.tg$68_name() : PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue25, (ScriptContext)scriptContext).asStr()) : ScriptValue.NULL.asStr()))), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", Gomoku.class, 0.0)), (ScriptContext)scriptContext) : ScriptValue.NULL;
            return ScriptValue.NULL;
        }
        ScriptContext.Builder builder8 = ScriptContext.builder().copyFrom(scriptContext);
        builder8.val("gid", scriptContext.getClassOrVar("gid"));
    ...
    public static ScriptValue onResign(ScriptContext.Builder builder) {
        ...
        if (ScriptFormula.valuesEqualStr((ScriptValue)scriptValue7, (String)"active") ^ true) {
            ...
            if (scriptValue8 != ScriptValue.NULL) {
                ...
                v1 = polyClassPlayer_v22 != null ? ScriptValue.of((boolean)polyClassPlayer_v22.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue8, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v1 = ScriptValue.NULL;
            }
            return ScriptValue.NULL;
        ...
        if (scriptValue5 != ScriptValue.NULL) {
            ScriptContext.Builder builder3 = ScriptContext.builder().copyFrom(scriptContext);
            builder3.val("gid", scriptContext.getClassOrVar("gid"));
            ScriptValue scriptValue9 = Gomoku.blackKey(builder3);
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue5);
            object2 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue9.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue5, (ScriptValue)scriptValue9, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object2 = ScriptValue.NULL;
        }
        ...
        if (scriptValue5 != ScriptValue.NULL) {
            ScriptContext.Builder builder4 = ScriptContext.builder().copyFrom(scriptContext);
            builder4.val("gid", scriptContext.getClassOrVar("gid"));
            ScriptValue scriptValue11 = Gomoku.whiteKey(builder4);
            String string = "string";
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue5);
            object = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue11.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue5, (ScriptValue)scriptValue11, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
        } else {
            object = ScriptValue.NULL;
        }
        ...
        if (ScriptFormula.valuesEqual((ScriptValue)(polyClassPlayer_v23 != null ? polyClassPlayer_v23.pg$67_name() : ((scriptValue4 = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue4, (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptValue)scriptValue10) ^ true && ScriptFormula.valuesEqual((ScriptValue)((polyClassPlayer_v2 = PolyClassPlayer_v2.ofVar((ScriptContext)scriptContext, (String)"Player")) != null ? polyClassPlayer_v2.pg$67_name() : ((scriptValue3 = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue3, (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptValue)scriptValue12) ^ true) {
            ...
            if (scriptValue13 != ScriptValue.NULL) {
                ...
                v4 = polyClassPlayer_v24 != null ? ScriptValue.of((boolean)polyClassPlayer_v24.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue13, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                v4 = ScriptValue.NULL;
            }
            return ScriptValue.NULL;
        ...
        ScriptValue scriptValue14 = ScriptValue.of((boolean)bl);
        builder.val("resigner_is_black", scriptValue14);
        if (scriptValue5 != ScriptValue.NULL) {
            ScriptContext.Builder builder5 = ScriptContext.builder().copyFrom(scriptContext);
            builder5.val("gid", scriptContext.getClassOrVar("gid"));
            ScriptValue scriptValue15 = Gomoku.statusKey(builder5);
            String string = "string";
            ScriptValue scriptValue16 = bl ? ( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "white_win")) : ( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Gomoku.class, "black_win"));
            PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue5);
            v5 = polyClassServer != null ? ScriptValue.of((boolean)polyClassServer.tm$0_set_typed(scriptValue15.asStr(), string, scriptValue16)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue5, (ScriptValue)scriptValue15, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)scriptValue16, (ScriptContext)scriptContext);
        } else {
            v5 = ScriptValue.NULL;
        }
        ScriptValue scriptValue17 = bl ? scriptValue12 : scriptValue10;
        builder.val("winner", scriptValue17);
        ScriptContext.Builder builder6 = ScriptContext.builder().copyFrom(scriptContext);
        builder6.val("gid", scriptContext.getClassOrVar("gid"));
        PolyClassPlayer_v2 polyClassPlayer_v26 = PolyClassPlayer_v2.ofVar((ScriptContext)scriptContext, (String)"Player");
        builder6.val("message", ScriptValue.of((String)("<yellow>" + (polyClassPlayer_v26 != null ? polyClassPlayer_v26.tg$68_name() : ((scriptValue = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "name", (ScriptValue)scriptValue, (ScriptContext)scriptContext).asStr() : ScriptValue.NULL.asStr())) + " resigned. <gold>" + scriptValue17.asStr() + " wins!")));
    ...
    public static ScriptValue botApplyMove(ScriptContext.Builder builder) {
        block13: {
            ...
            if (scriptValue7 != ScriptValue.NULL) {
                ScriptContext.Builder builder7 = ScriptContext.builder().copyFrom(scriptContext);
                builder7.val("gid", scriptContext.getClassOrVar("gid"));
                ScriptValue scriptValue10 = Gomoku.blackKey(builder7);
                String string = "string";
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue7);
                object2 = polyClassServer != null ? polyClassServer.tm$6_get_typed(scriptValue10.asStr(), string) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue7, (ScriptValue)scriptValue10, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
            } else {
                object2 = ScriptValue.NULL;
            }
            ...
            if (scriptValue7 != ScriptValue.NULL) {
                ScriptValue scriptValue12 = scriptValue11;
                PolyClassServer polyClassServer = PolyClassServer.ofGuarded((ScriptValue)scriptValue7);
                object = polyClassServer != null ? polyClassServer.tm$10_get_player(scriptValue12.asStr()) : PolyDispatch.bootstrapCall("memberCall", "get_player", (ScriptValue)scriptValue7, (ScriptValue)scriptValue12, (ScriptContext)scriptContext);
            } else {
                object = ScriptValue.NULL;
            }
            ScriptValue scriptValue13 = object;
            builder.val("human", scriptValue13);
            if (!(ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue13, (ScriptContext)scriptContext).asBool() ^ true)) break block13;
            ScriptContext.Builder builder8 = ScriptContext.builder().copyFrom(scriptContext);
            builder8.val("gid", scriptContext.getClassOrVar("gid"));
            builder8.val("viewer", scriptValue13);
            Gomoku.showBoard(builder8);
        }
        return ScriptValue.NULL;
    }
