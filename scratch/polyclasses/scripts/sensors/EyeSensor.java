...
public final class EyeSensor {
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (scriptValue != ScriptValue.NULL) {
            ...
            object = polyClassMachine != null ? ScriptValue.of((boolean)polyClassMachine.tm$30_is_player_looking_at(d)) : PolyDispatch.bootstrapCall("memberCall", "is_player_looking_at", (ScriptValue)scriptValue, (ScriptValue)ScriptValue.of((double)d), (ScriptContext)scriptContext);
        } else {
        ...
        if (object.asBool()) {
            ...
            ScriptValue scriptValue3 = polyClassMachine != null ? polyClassMachine.pg$171_redstone() : ((scriptValue2 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "redstone", (ScriptValue)scriptValue2, (ScriptContext)scriptContext) : ScriptValue.NULL);
            double d = 15.0;
            ...
            PolyClassMachine polyClassMachine = PolyClassMachine.ofVar((ScriptContext)scriptContext, (String)"Machine");
            ScriptValue scriptValue5 = polyClassMachine != null ? polyClassMachine.pg$171_redstone() : ((scriptValue4 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "redstone", (ScriptValue)scriptValue4, (ScriptContext)scriptContext) : ScriptValue.NULL);
