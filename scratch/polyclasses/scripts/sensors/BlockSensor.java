        ...
        if (list != null) {
            for (ScriptValue scriptValue13 : list) {
                ...
                if (scriptValue15 != ScriptValue.NULL) {
                    ...
                    double d3 = -(polyClassMachine4 != null ? polyClassMachine4.tg$134_facing_dx() : ((scriptValue18 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "facing_dx", (ScriptValue)scriptValue18, (ScriptContext)scriptContext).asNum() : ScriptValue.NULL.asNum())) * scriptValue12.asNum();
                    PolyClassMachine polyClassMachine5 = PolyClassMachine.ofVar((ScriptContext)scriptContext, (String)"Machine");
                    double d4 = -(polyClassMachine5 != null ? polyClassMachine5.tg$130_facing_dy() : ((scriptValue17 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "facing_dy", (ScriptValue)scriptValue17, (ScriptContext)scriptContext).asNum() : ScriptValue.NULL.asNum())) * scriptValue12.asNum();
                    PolyClassMachine polyClassMachine6 = PolyClassMachine.ofVar((ScriptContext)scriptContext, (String)"Machine");
                    double d5 = -(polyClassMachine6 != null ? polyClassMachine6.tg$132_facing_dz() : ((scriptValue16 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "facing_dz", (ScriptValue)scriptValue16, (ScriptContext)scriptContext).asNum() : ScriptValue.NULL.asNum())) * scriptValue12.asNum();
                    if (scriptValue15 instanceof ScriptValue.Obj && (object6 = (obj4 = (ScriptValue.Obj)scriptValue15).instance()) != null && !(object6 instanceof PolyClass) && obj4.typeName().equals("Machine")) {
                        ...
                        object5 = polyClassMachine7.tm$68_block_at(d3, d4, d5);
                    } else {
