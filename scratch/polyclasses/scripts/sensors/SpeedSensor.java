...
public final class SpeedSensor {
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        List list = ScriptProgram.elementsOf((ScriptValue)scriptValue18);
        if (list != null) {
            for (ScriptValue scriptValue20 : list) {
                ScriptValue scriptValue21;
                ScriptValue scriptValue22;
                builder.val("entity", scriptValue20);
                if (scriptValue13.asNum() > 0.0 && ((scriptValue22 = scriptContext.getClassOrVar("entity")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "is_living", (ScriptValue)scriptValue22, (ScriptContext)scriptContext) : ScriptValue.NULL).asBool() ^ true) continue;
                ScriptValue scriptValue23 = scriptContext.getClassOrVar("entity");
                ScriptValue scriptValue24 = scriptValue23 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "velocity_x", (ScriptValue)scriptValue23, (ScriptContext)scriptContext) : ScriptValue.NULL;
                builder.val("vx", scriptValue24);
                ScriptValue scriptValue25 = scriptValue15.asNum() > 0.0 ? ((scriptValue21 = scriptContext.getClassOrVar("entity")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "velocity_y", (ScriptValue)scriptValue21, (ScriptContext)scriptContext) : ScriptValue.NULL) : ScriptValue.of((double)0.0);
                builder.val("vy", scriptValue25);
                ScriptValue scriptValue26 = scriptContext.getClassOrVar("entity");
                ScriptValue scriptValue27 = scriptValue26 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "velocity_z", (ScriptValue)scriptValue26, (ScriptContext)scriptContext) : ScriptValue.NULL;
                builder.val("vz", scriptValue27);
                double d7 = Math.sqrt(scriptValue24.asNum() * scriptValue24.asNum() + scriptValue25.asNum() * scriptValue25.asNum() + scriptValue27.asNum() * scriptValue27.asNum());
                ScriptValue scriptValue28 = ScriptValue.of((double)d7);
                builder.val("speed", scriptValue28);
                if (!(d7 > scriptContext.getNum("max_speed"))) continue;
                double d8 = d7;
                ScriptValue scriptValue29 = ScriptValue.of((double)d8);
                builder.val("max_speed", scriptValue29);
            }
        }
        double d9 = 0.0;
        ...
        if (scriptContext.getNum("max_speed") > d5) {
            ...
            ScriptValue scriptValue31 = ScriptFormula.callBuiltin((String)"clamp", arrayList, (ScriptContext)scriptContext);
        ...
        PolyDispatch.bootstrapCall("memberCall", "set", (ScriptValue)(scriptValue32 != ScriptValue.NULL ? ((polyClassMachine = PolyClassMachine.ofGuarded((ScriptValue)scriptValue32)) != null ? polyClassMachine.pg$170_redstone() : PolyDispatch.bootstrapGet("memberGet", "redstone", (ScriptValue)scriptValue32, (ScriptContext)scriptContext)) : ScriptValue.NULL), arrayList, (ScriptContext)scriptContext);
