...
public final class WindmillInteract {
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        Object object4 = scriptValue4 != ScriptValue.NULL ? (scriptValue4 instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue4).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Player") ? new PolyClassPlayer(object).pg$38_is_sneaking() : PolyDispatch.bootstrapGet("memberGet", "is_sneaking", (ScriptValue)scriptValue4, (ScriptContext)scriptContext)) : ScriptValue.NULL;
        if (object4.asBool()) {
            if (scriptValue3.asNum() > 0.0) {
                ...
                if (scriptValue6 != ScriptValue.NULL) {
                    ...
                    if (scriptValue6 instanceof ScriptValue.Obj && (object7 = (obj3 = (ScriptValue.Obj)scriptValue6).instance()) != null && !(object7 instanceof PolyClass) && obj3.typeName().equals("Machine")) {
                        ...
                        object6 = PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue6, arrayList, (ScriptContext)scriptContext);
                    }
                } else {
                ...
                if (scriptValue8 != ScriptValue.NULL) {
                    ...
                    if (scriptValue8 instanceof ScriptValue.Obj && (object8 = (obj4 = (ScriptValue.Obj)scriptValue8).instance()) != null && !(object8 instanceof PolyClass) && obj4.typeName().equals("ContraptionManager")) {
                        ...
                        object5 = polyClassContraptionManager.tm$6_get(scriptValue9.asStr());
                    } else {
                        ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                        arrayList.add(scriptValue9);
                        object5 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue8, arrayList, (ScriptContext)scriptContext);
                    }
                } else {
                ...
                if ((scriptValue5 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL) {
                    ...
                    if (scriptValue5 instanceof ScriptValue.Obj && (object9 = (obj5 = (ScriptValue.Obj)scriptValue5).instance()) != null && !(object9 instanceof PolyClass) && obj5.typeName().equals("Machine")) {
            ...
            if (scriptValue18 != ScriptValue.NULL) {
                ...
                String string6 = "int";
                if (scriptValue18 instanceof ScriptValue.Obj && (object15 = (obj10 = (ScriptValue.Obj)scriptValue18).instance()) != null && !(object15 instanceof PolyClass) && obj10.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object15);
                    object14 = polyClassMachine_v3.tm$34_get_typed(string, string6);
                } else {
                    ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                    arrayList.add(ScriptValue.of((String)string));
                    arrayList.add(ScriptValue.of((String)string6));
                    object14 = PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue18, arrayList, (ScriptContext)scriptContext);
                }
            } else {
                object14 = ScriptValue.NULL;
            }
            ScriptValue scriptValue19 = object14;
            ...
            if (scriptValue22 != ScriptValue.NULL) {
                ...
                if (scriptValue22 instanceof ScriptValue.Obj && (object16 = (obj11 = (ScriptValue.Obj)scriptValue22).instance()) != null && !(object16 instanceof PolyClass) && obj11.typeName().equals("Machine")) {
            ...
            if (scriptValue24 != ScriptValue.NULL) {
                ...
                if (scriptValue24 instanceof ScriptValue.Obj && (object17 = (obj12 = (ScriptValue.Obj)scriptValue24).instance()) != null && !(object17 instanceof PolyClass) && obj12.typeName().equals("Player")) {
            ...
            if (scriptValue29 != ScriptValue.NULL) {
                ...
                ScriptValue scriptValue35 = ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)scriptValue30, (ScriptValue)PolyDispatch.bootstrapCall("memberCall", "property", (ScriptValue)(scriptValue31 != ScriptValue.NULL ? (scriptValue31 instanceof ScriptValue.Obj && (object23 = (obj17 = (ScriptValue.Obj)scriptValue31).instance()) != null && !(object23 instanceof PolyClass) && obj17.typeName().equals("Machine") ? new PolyClassMachine_v3(object23).pg$130_block() : PolyDispatch.bootstrapGet("memberGet", "block", (ScriptValue)scriptValue31, (ScriptContext)scriptContext)) : ScriptValue.NULL), arrayList, (ScriptContext)scriptContext)), (ScriptValue)ScriptValue.of((String)" seed=(")), (ScriptValue)(scriptValue32 != ScriptValue.NULL ? (scriptValue32 instanceof ScriptValue.Obj && (object22 = (obj16 = (ScriptValue.Obj)scriptValue32).instance()) != null && !(object22 instanceof PolyClass) && obj16.typeName().equals("Machine") ? new PolyClassMachine_v3(object22).pg$126_facing_dx() : PolyDispatch.bootstrapGet("memberGet", "facing_dx", (ScriptValue)scriptValue32, (ScriptContext)scriptContext)) : ScriptValue.NULL)), (ScriptValue)ScriptValue.of((String)",")), (ScriptValue)(scriptValue33 != ScriptValue.NULL ? (scriptValue33 instanceof ScriptValue.Obj && (object21 = (obj15 = (ScriptValue.Obj)scriptValue33).instance()) != null && !(object21 instanceof PolyClass) && obj15.typeName().equals("Machine") ? new PolyClassMachine_v3(object21).pg$124_facing_dy() : PolyDispatch.bootstrapGet("memberGet", "facing_dy", (ScriptValue)scriptValue33, (ScriptContext)scriptContext)) : ScriptValue.NULL)), (ScriptValue)ScriptValue.of((String)",")), (ScriptValue)(scriptValue34 != ScriptValue.NULL ? (scriptValue34 instanceof ScriptValue.Obj && (object20 = (obj14 = (ScriptValue.Obj)scriptValue34).instance()) != null && !(object20 instanceof PolyClass) && obj14.typeName().equals("Machine") ? new PolyClassMachine_v3(object20).pg$125_facing_dz() : PolyDispatch.bootstrapGet("memberGet", "facing_dz", (ScriptValue)scriptValue34, (ScriptContext)scriptContext)) : ScriptValue.NULL)), (ScriptValue)ScriptValue.of((String)")")), (ScriptValue)ScriptValue.of((String)" self_glued="));
                ...
                if (scriptValue36 != ScriptValue.NULL) {
                    ...
                    if (scriptValue38 != ScriptValue.NULL) {
                        ...
                        double d7 = 0.0;
                        double d8 = 0.0;
                        if (scriptValue38 instanceof ScriptValue.Obj && (object25 = (obj19 = (ScriptValue.Obj)scriptValue38).instance()) != null && !(object25 instanceof PolyClass) && obj19.typeName().equals("Machine")) {
                            PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object25);
                            v16 = polyClassMachine_v3.tm$68_block_at(d6, d7, d8);
                        } else {
                    ...
                    if (scriptValue36 instanceof ScriptValue.Obj && (object24 = (obj18 = (ScriptValue.Obj)scriptValue36).instance()) != null && !(object24 instanceof PolyClass) && obj18.typeName().equals("Glue")) {
                        PolyClassGlue polyClassGlue = new PolyClassGlue(object24);
                        object19 = ScriptValue.of((boolean)polyClassGlue.tm$2_is_glued(scriptValue37));
                    } else {
                        ArrayList<ScriptValue> arrayList3 = new ArrayList<ScriptValue>();
                        arrayList3.add(scriptValue37);
                        object19 = PolyDispatch.bootstrapCall("memberCall", "is_glued", (ScriptValue)scriptValue36, arrayList3, (ScriptContext)scriptContext);
                    }
                } else {
                    object19 = ScriptValue.NULL;
                }
                ScriptValue scriptValue39 = ScriptFormula.addPolymorphic((ScriptValue)scriptValue35, (ScriptValue)object19);
                if (scriptValue29 instanceof ScriptValue.Obj && (object18 = (obj13 = (ScriptValue.Obj)scriptValue29).instance()) != null && !(object18 instanceof PolyClass) && obj13.typeName().equals("Player")) {
            ...
            if (ScriptFormula.valuesEqual((ScriptValue)scriptValue28, (ScriptValue)scriptContext.getClassOrVar("null")) || ((scriptValue27 = scriptContext.getClassOrVar("seed")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "is_air", (ScriptValue)scriptValue27, (ScriptContext)scriptContext) : ScriptValue.NULL).asBool()) {
                ...
                if (scriptValue40 != ScriptValue.NULL) {
                    ScriptValue.Obj obj20;
                    Object object26;
                    String string = "<red>Nothing attached to the bearing's face to assemble.";
                    if (scriptValue40 instanceof ScriptValue.Obj && (object26 = (obj20 = (ScriptValue.Obj)scriptValue40).instance()) != null && !(object26 instanceof PolyClass) && obj20.typeName().equals("Player")) {
                        PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object26);
                ...
                if (scriptValue41 != ScriptValue.NULL) {
                    ScriptValue.Obj obj21;
                    Object object28;
                    ScriptValue scriptValue42 = scriptValue28;
                    if (scriptValue41 instanceof ScriptValue.Obj && (object28 = (obj21 = (ScriptValue.Obj)scriptValue41).instance()) != null && !(object28 instanceof PolyClass) && obj21.typeName().equals("Glue")) {
                        PolyClassGlue polyClassGlue = new PolyClassGlue(object28);
                        object27 = ScriptValue.of((boolean)polyClassGlue.tm$2_is_glued(scriptValue42));
                    } else {
                        ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                        arrayList.add(scriptValue42);
                        object27 = PolyDispatch.bootstrapCall("memberCall", "is_glued", (ScriptValue)scriptValue41, arrayList, (ScriptContext)scriptContext);
                    }
                } else {
                    object27 = ScriptValue.NULL;
                }
                if (object27.asBool() ^ true) {
                    ScriptValue scriptValue43 = scriptContext.getClassOrVar("Player");
                    if (scriptValue43 != ScriptValue.NULL) {
                        ScriptValue.Obj obj22;
                        Object object29;
                        String string = "<red>That structure is not glued together - glue the sails to each other and to the bearing.";
                        if (scriptValue43 instanceof ScriptValue.Obj && (object29 = (obj22 = (ScriptValue.Obj)scriptValue43).instance()) != null && !(object29 instanceof PolyClass) && obj22.typeName().equals("Player")) {
                    ...
                    if (scriptValue44 != ScriptValue.NULL) {
                        ScriptValue.Obj obj23;
                        Object object31;
                        ScriptValue scriptValue45 = scriptValue28;
                        String string = "sail";
                        if (scriptValue44 instanceof ScriptValue.Obj && (object31 = (obj23 = (ScriptValue.Obj)scriptValue44).instance()) != null && !(object31 instanceof PolyClass) && obj23.typeName().equals("Glue")) {
                            PolyClassGlue polyClassGlue = new PolyClassGlue(object31);
                            object30 = ScriptValue.of((double)polyClassGlue.tm$4_count(scriptValue45, string));
                        } else {
                            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                            arrayList.add(scriptValue45);
                            arrayList.add(ScriptValue.of((String)string));
                            object30 = PolyDispatch.bootstrapCall("memberCall", "count", (ScriptValue)scriptValue44, arrayList, (ScriptContext)scriptContext);
                        }
                    } else {
                        object30 = ScriptValue.NULL;
                    }
                    ScriptValue scriptValue46 = object30;
                    ...
                    if (scriptValue46.asNum() < d) {
                        ...
                        if (scriptValue47 != ScriptValue.NULL) {
                            ...
                            if (scriptValue47 instanceof ScriptValue.Obj && (object32 = (obj24 = (ScriptValue.Obj)scriptValue47).instance()) != null && !(object32 instanceof PolyClass) && obj24.typeName().equals("Player")) {
                                PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object32);
                        ...
                        if (scriptValue49 != ScriptValue.NULL) {
                            ...
                            if (scriptValue50 != ScriptValue.NULL) {
                                ScriptValue.Obj obj26;
                                Object object36;
                                double d9 = 0.0;
                                double d10 = 0.0;
                                double d11 = 0.0;
                                if (scriptValue50 instanceof ScriptValue.Obj && (object36 = (obj26 = (ScriptValue.Obj)scriptValue50).instance()) != null && !(object36 instanceof PolyClass) && obj26.typeName().equals("Machine")) {
                                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object36);
                                    object35 = polyClassMachine_v3.tm$68_block_at(d9, d10, d11);
                                } else {
                                    ...
                                    object35 = PolyDispatch.bootstrapCall("memberCall", "block_at", (ScriptValue)scriptValue50, arrayList5, (ScriptContext)scriptContext);
                                }
                            } else {
                                object35 = ScriptValue.NULL;
                            }
                            arrayList.add((ScriptValue)object35);
                            object33 = scriptValue49 instanceof ScriptValue.Obj && (object34 = (obj25 = (ScriptValue.Obj)scriptValue49).instance()) != null && !(object34 instanceof PolyClass) && obj25.typeName().equals("ContraptionManager") ? new PolyClassContraptionManager(object34).um$1_create_bearing(arrayList) : PolyDispatch.bootstrapCall("memberCall", "create_bearing", (ScriptValue)scriptValue49, arrayList, (ScriptContext)scriptContext);
                        } else {
                            object33 = ScriptValue.NULL;
                        }
                        ScriptValue scriptValue51 = object33;
                        ...
                        if (ScriptFormula.valuesEqual((ScriptValue)scriptValue51, (ScriptValue)scriptContext.getClassOrVar("null"))) {
                            ...
                            if (scriptValue52 != ScriptValue.NULL) {
                                ScriptValue.Obj obj27;
                                Object object37;
                                String string = "<red>Could not assemble that structure.";
                                if (scriptValue52 instanceof ScriptValue.Obj && (object37 = (obj27 = (ScriptValue.Obj)scriptValue52).instance()) != null && !(object37 instanceof PolyClass) && obj27.typeName().equals("Player")) {
                                    PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object37);
                            ...
                            if (scriptValue56 != ScriptValue.NULL) {
                                ScriptValue.Obj obj28;
                                Object object38;
                                ScriptValue scriptValue57;
                                String string = "contraption_uuid";
                                String string8 = "string";
                                ScriptValue scriptValue58 = scriptContext.getClassOrVar("contraption");
                                Object object39 = scriptValue57 = scriptValue58 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "uuid", (ScriptValue)scriptValue58, (ScriptContext)scriptContext) : ScriptValue.NULL;
                                if (scriptValue56 instanceof ScriptValue.Obj && (object38 = (obj28 = (ScriptValue.Obj)scriptValue56).instance()) != null && !(object38 instanceof PolyClass) && obj28.typeName().equals("Machine")) {
                                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object38);
                                    v29 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string8, scriptValue57));
                                } else {
                            ...
                            if (scriptValue59 != ScriptValue.NULL) {
                                ScriptValue.Obj obj29;
                                Object object40;
                                String string = "assembled";
                                String string9 = "int";
                                ScriptValue scriptValue60 = ScriptValue.of((double)1.0);
                                if (scriptValue59 instanceof ScriptValue.Obj && (object40 = (obj29 = (ScriptValue.Obj)scriptValue59).instance()) != null && !(object40 instanceof PolyClass) && obj29.typeName().equals("Machine")) {
                                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object40);
                                    v30 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string9, scriptValue60));
                                } else {
                            ...
                            if (scriptValue61 != ScriptValue.NULL) {
                                ...
                                if (scriptValue61 instanceof ScriptValue.Obj && (object41 = (obj30 = (ScriptValue.Obj)scriptValue61).instance()) != null && !(object41 instanceof PolyClass) && obj30.typeName().equals("Machine")) {
                                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object41);
                                    v31 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string10, scriptValue62));
                                } else {
                            ...
                            if (scriptValue63 != ScriptValue.NULL) {
                                ...
                                if (scriptValue63 instanceof ScriptValue.Obj && (object42 = (obj31 = (ScriptValue.Obj)scriptValue63).instance()) != null && !(object42 instanceof PolyClass) && obj31.typeName().equals("Player")) {
                                    PolyClassPlayer polyClassPlayer = new PolyClassPlayer(object42);
