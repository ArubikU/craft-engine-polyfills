...
public final class GasMotor {
    ...
    public static ScriptValue increaseRpm(ScriptContext.Builder builder) {
        ...
        if (scriptValue7 != ScriptValue.NULL) {
            ...
            if (scriptValue7 instanceof ScriptValue.Obj && (object4 = (obj = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object4 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                ...
                v2 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string3, scriptValue8));
            } else {
        ...
        if (scriptValue9 != ScriptValue.NULL) {
            ...
            if (scriptValue9 instanceof ScriptValue.Obj && (object5 = (obj = (ScriptValue.Obj)scriptValue9).instance()) != null && !(object5 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                ...
                object = polyClassMachine_v3.tm$34_get_typed(string, string4);
            } else {
        ...
        if ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL) {
            ...
            if (scriptValue instanceof ScriptValue.Obj && (object6 = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object6 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                ...
                v4 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string5, scriptValue12));
            } else {
    ...
    public static ScriptValue decreaseRpm(ScriptContext.Builder builder) {
        ...
        if (d2 == 0.0) {
            ...
            if (scriptValue7 != ScriptValue.NULL) {
                ...
                if (scriptValue7 instanceof ScriptValue.Obj && (object4 = (obj = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object4 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object4);
                    v3 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string4, scriptValue8));
                } else {
                    ArrayList<ScriptValue> arrayList3 = new ArrayList<ScriptValue>();
                    arrayList3.add(ScriptValue.of((String)string));
                    arrayList3.add(ScriptValue.of((String)string4));
            ...
            if (scriptValue10 != ScriptValue.NULL) {
                ...
                if (scriptValue10 instanceof ScriptValue.Obj && (object6 = (obj = (ScriptValue.Obj)scriptValue10).instance()) != null && !(object6 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object6);
                    object5 = polyClassMachine_v3.tm$34_get_typed(string, string5);
                } else {
                    ArrayList<ScriptValue> arrayList4 = new ArrayList<ScriptValue>();
                    arrayList4.add(ScriptValue.of((String)string));
                    arrayList4.add(ScriptValue.of((String)string5));
    ...
    public static ScriptValue increaseSu(ScriptContext.Builder builder) {
        ...
        if (scriptValue6 != ScriptValue.NULL) {
            ...
            if (scriptValue6 instanceof ScriptValue.Obj && (object3 = (obj = (ScriptValue.Obj)scriptValue6).instance()) != null && !(object3 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object3);
                v2 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string3, scriptValue7));
            } else {
                ArrayList<ScriptValue> arrayList2 = new ArrayList<ScriptValue>();
                arrayList2.add(ScriptValue.of((String)string));
                arrayList2.add(ScriptValue.of((String)string3));
    ...
    public static ScriptValue status(ScriptContext.Builder builder) {
        ...
        ScriptContext scriptContext = builder.peek();
        ScriptValue scriptValue = scriptContext.getClassOrVar("Machine");
        ScriptValue scriptValue2 = scriptValue != ScriptValue.NULL ? (scriptValue instanceof ScriptValue.Obj && (object4 = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object4 instanceof PolyClass) && obj.typeName().equals("Machine") ? new PolyClassMachine_v3(object4).pg$129_gas_tanks() : PolyDispatch.bootstrapGet("memberGet", "gas_tanks", (ScriptValue)scriptValue, (ScriptContext)scriptContext)) : ScriptValue.NULL;
        builder.val("tanks", scriptValue2);
        ScriptValue scriptValue3 = scriptContext.getClassOrVar("tanks");
        Object object5 = scriptValue3 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "length", (ScriptValue)scriptValue3, (ScriptContext)scriptContext) : ScriptValue.NULL;
        ...
        if (scriptValue7 != ScriptValue.NULL) {
            ...
            String string = "target_rpm";
            String string2 = "int";
            if (scriptValue7 instanceof ScriptValue.Obj && (object6 = (obj2 = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object6 instanceof PolyClass) && obj2.typeName().equals("Machine")) {
                PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object6);
                object = polyClassMachine_v3.tm$34_get_typed(string, string2);
            } else {
                ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (scriptValue3 != ScriptValue.NULL) {
            ...
            String string = "target_rpm";
            String string2 = "int";
            if (scriptValue3 instanceof ScriptValue.Obj && (object13 = (obj5 = (ScriptValue.Obj)scriptValue3).instance()) != null && !(object13 instanceof PolyClass) && obj5.typeName().equals("Machine")) {
                PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object13);
                object12 = polyClassMachine_v3.tm$34_get_typed(string, string2);
            } else {
                ArrayList<ScriptValue> arrayList4 = new ArrayList<ScriptValue>();
                arrayList4.add(ScriptValue.of((String)string));
                arrayList4.add(ScriptValue.of((String)string2));
                object12 = PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue3, arrayList4, (ScriptContext)scriptContext);
            }
        } else {
            object12 = ScriptValue.NULL;
        }
        ScriptValue scriptValue4 = object12;
        ...
        if (scriptValue5 != ScriptValue.NULL) {
            ...
            String string = "target_su";
            String string3 = "int";
            if (scriptValue5 instanceof ScriptValue.Obj && (object14 = (obj6 = (ScriptValue.Obj)scriptValue5).instance()) != null && !(object14 instanceof PolyClass) && obj6.typeName().equals("Machine")) {
                PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object14);
                object11 = polyClassMachine_v3.tm$34_get_typed(string, string3);
            } else {
                ArrayList<ScriptValue> arrayList5 = new ArrayList<ScriptValue>();
                arrayList5.add(ScriptValue.of((String)string));
                arrayList5.add(ScriptValue.of((String)string3));
                object11 = PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue5, arrayList5, (ScriptContext)scriptContext);
            }
        } else {
            object11 = ScriptValue.NULL;
        }
        ScriptValue scriptValue6 = object11;
        builder.val("target_su", scriptValue6);
        ScriptValue scriptValue7 = scriptContext.getClassOrVar("Machine");
        ScriptValue scriptValue8 = scriptValue7 != ScriptValue.NULL ? (scriptValue7 instanceof ScriptValue.Obj && (object10 = (obj4 = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object10 instanceof PolyClass) && obj4.typeName().equals("Machine") ? new PolyClassMachine_v3(object10).pg$129_gas_tanks() : PolyDispatch.bootstrapGet("memberGet", "gas_tanks", (ScriptValue)scriptValue7, (ScriptContext)scriptContext)) : ScriptValue.NULL;
        builder.val("gas_tanks", scriptValue8);
        ScriptValue scriptValue9 = scriptContext.getClassOrVar("gas_tanks");
        Object object15 = scriptValue9 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "length", (ScriptValue)scriptValue9, (ScriptContext)scriptContext) : ScriptValue.NULL;
        if (object15.asNum() <= 0.0) {
            ScriptValue scriptValue10 = scriptContext.getClassOrVar("Machine");
            if (scriptValue10 != ScriptValue.NULL) {
                ScriptValue.Obj obj7;
                Object object16;
                double d = 0.0;
                if (scriptValue10 instanceof ScriptValue.Obj && (object16 = (obj7 = (ScriptValue.Obj)scriptValue10).instance()) != null && !(object16 instanceof PolyClass) && obj7.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object16);
                    v3 = ScriptValue.of((boolean)polyClassMachine_v3.tm$106_set_rpm_output(d));
                } else {
            ...
            if (scriptValue11 != ScriptValue.NULL) {
                ...
                Object object17;
                double d = 0.0;
                if (scriptValue11 instanceof ScriptValue.Obj && (object17 = (obj8 = (ScriptValue.Obj)scriptValue11).instance()) != null && !(object17 instanceof PolyClass) && obj8.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object17);
                    v4 = ScriptValue.of((boolean)polyClassMachine_v3.tm$56_report_su(d));
                } else {
        ...
        if (scriptValue12 != ScriptValue.NULL) {
            ...
            object9 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue12, arrayList8, (ScriptContext)scriptContext);
        } else {
            object9 = ScriptValue.NULL;
        }
        ScriptValue scriptValue13 = object9;
        ...
        if (scriptValue14 != ScriptValue.NULL) {
            ...
            object8 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue14, arrayList9, (ScriptContext)scriptContext);
        } else {
            object8 = ScriptValue.NULL;
        }
        ScriptValue scriptValue15 = object8;
        ...
        if (scriptValue18 != ScriptValue.NULL) {
            ...
            object7 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue18, arrayList10, (ScriptContext)scriptContext);
        } else {
            object7 = ScriptValue.NULL;
        }
        if (object7.asBool() ^ true) {
            Object object18;
            Object object19;
            ...
            if (scriptValue19 != ScriptValue.NULL) {
                ...
                object19 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue19, arrayList11, (ScriptContext)scriptContext);
            } else {
                object19 = ScriptValue.NULL;
            }
            ScriptValue scriptValue20 = object19;
            ...
            if (scriptValue21 != ScriptValue.NULL) {
                ...
                object18 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue21, arrayList12, (ScriptContext)scriptContext);
            } else {
                object18 = ScriptValue.NULL;
            }
            ScriptValue scriptValue22 = object18;
        ...
        if (ScriptFormula.valuesEqual((ScriptValue)scriptContext.getClassOrVar("spec"), (ScriptValue)scriptContext.getClassOrVar("null")) || scriptValue15.asNum() <= 0.0) {
            ...
            if (scriptValue23 != ScriptValue.NULL) {
                ...
                Object object20;
                double d = 0.0;
                if (scriptValue23 instanceof ScriptValue.Obj && (object20 = (obj9 = (ScriptValue.Obj)scriptValue23).instance()) != null && !(object20 instanceof PolyClass) && obj9.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object20);
                    v10 = ScriptValue.of((boolean)polyClassMachine_v3.tm$106_set_rpm_output(d));
                } else {
            ...
            if (scriptValue24 != ScriptValue.NULL) {
                ...
                Object object21;
                double d = 0.0;
                if (scriptValue24 instanceof ScriptValue.Obj && (object21 = (obj10 = (ScriptValue.Obj)scriptValue24).instance()) != null && !(object21 instanceof PolyClass) && obj10.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object21);
                    v11 = ScriptValue.of((boolean)polyClassMachine_v3.tm$56_report_su(d));
                } else {
        ...
        if (scriptValue25 != ScriptValue.NULL) {
            ...
            object6 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue25, arrayList15, (ScriptContext)scriptContext);
        } else {
        ...
        if (scriptValue27 != ScriptValue.NULL) {
            ...
            object5 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue27, arrayList16, (ScriptContext)scriptContext);
        } else {
            object5 = ScriptValue.NULL;
        }
        ScriptValue scriptValue28 = object5;
        ...
        if (scriptValue29 != ScriptValue.NULL) {
            ...
            object4 = PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue29, arrayList17, (ScriptContext)scriptContext);
        } else {
            object4 = ScriptValue.NULL;
        }
        ScriptValue scriptValue30 = object4;
        ...
        if (scriptValue4.asNum() <= 0.0) {
            ...
            if (scriptValue32 != ScriptValue.NULL) {
                ...
                if (scriptValue32 instanceof ScriptValue.Obj && (object22 = (obj11 = (ScriptValue.Obj)scriptValue32).instance()) != null && !(object22 instanceof PolyClass) && obj11.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object22);
                    v15 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string4, scriptValue33));
                } else {
        ...
        if (scriptValue6.asNum() <= 0.0) {
            ...
            if (scriptValue35 != ScriptValue.NULL) {
                ...
                if (scriptValue35 instanceof ScriptValue.Obj && (object23 = (obj12 = (ScriptValue.Obj)scriptValue35).instance()) != null && !(object23 instanceof PolyClass) && obj12.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object23);
                    v16 = ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string5, scriptValue36));
                } else {
        ...
        double d5 = Math.floor(scriptValue30.asNum() * d4 * scriptValue37.asNum() * (1.0 - (scriptValue41 != ScriptValue.NULL ? (scriptValue41 instanceof ScriptValue.Obj && (object2 = (obj2 = (ScriptValue.Obj)scriptValue41).instance()) != null && !(object2 instanceof PolyClass) && obj2.typeName().equals("Machine") ? new PolyClassMachine_v3(object2).pg$136_efficiency() : PolyDispatch.bootstrapGet("memberGet", "efficiency", (ScriptValue)scriptValue41, (ScriptContext)scriptContext)) : ScriptValue.NULL).asNum()));
        ...
        Object object24 = scriptValue44 != ScriptValue.NULL ? (scriptValue44 instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue44).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Machine") ? new PolyClassMachine_v3(object).pg$165_is_overstressed() : PolyDispatch.bootstrapGet("memberGet", "is_overstressed", (ScriptValue)scriptValue44, (ScriptContext)scriptContext)) : ScriptValue.NULL;
        if (object24.asBool()) {
            ...
            if (scriptValue45 != ScriptValue.NULL) {
                ...
                Object object25;
                double d7 = 0.0;
                if (scriptValue45 instanceof ScriptValue.Obj && (object25 = (obj13 = (ScriptValue.Obj)scriptValue45).instance()) != null && !(object25 instanceof PolyClass) && obj13.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object25);
                    v18 = ScriptValue.of((boolean)polyClassMachine_v3.tm$106_set_rpm_output(d7));
                } else {
            ...
            if (scriptValue46 != ScriptValue.NULL) {
                ...
                Object object26;
                double d8 = -d2;
                if (scriptValue46 instanceof ScriptValue.Obj && (object26 = (obj14 = (ScriptValue.Obj)scriptValue46).instance()) != null && !(object26 instanceof PolyClass) && obj14.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object26);
                    v19 = ScriptValue.of((boolean)polyClassMachine_v3.tm$56_report_su(d8));
                } else {
            ...
            if (scriptValue47 != ScriptValue.NULL) {
                ...
                Object object27;
                double d9 = d;
                if (scriptValue47 instanceof ScriptValue.Obj && (object27 = (obj15 = (ScriptValue.Obj)scriptValue47).instance()) != null && !(object27 instanceof PolyClass) && obj15.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object27);
                    v20 = ScriptValue.of((boolean)polyClassMachine_v3.tm$106_set_rpm_output(d9));
                } else {
            ...
            if (scriptValue48 != ScriptValue.NULL) {
                ...
                Object object28;
                double d10 = -d2;
                if (scriptValue48 instanceof ScriptValue.Obj && (object28 = (obj16 = (ScriptValue.Obj)scriptValue48).instance()) != null && !(object28 instanceof PolyClass) && obj16.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object28);
                    v21 = ScriptValue.of((boolean)polyClassMachine_v3.tm$56_report_su(d10));
                } else {
            ...
            if (scriptValue49 != ScriptValue.NULL) {
                ...
                String string = "vapor";
                double d11 = d6;
                if (scriptValue49 instanceof ScriptValue.Obj && (object29 = (obj17 = (ScriptValue.Obj)scriptValue49).instance()) != null && !(object29 instanceof PolyClass) && obj17.typeName().equals("Machine")) {
                    PolyClassMachine_v3 polyClassMachine_v3 = new PolyClassMachine_v3(object29);
                    v22 = ScriptValue.of((boolean)polyClassMachine_v3.tm$88_consume_gas(string, d11));
                } else {
