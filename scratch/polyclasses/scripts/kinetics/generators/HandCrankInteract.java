    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (scriptValue5 != ScriptValue.NULL) {
            ...
            if (scriptValue5 instanceof ScriptValue.Obj && (object4 = (obj = (ScriptValue.Obj)scriptValue5).instance()) != null && !(object4 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                ...
                v2 = ScriptValue.of((boolean)polyClassMachine_v4.tm$14_play_sound(string, d, d2));
            } else {
                v2 = PolyDispatch.bootstrapCall("memberCall", "play_sound", (ScriptValue)scriptValue5, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((double)d), (ScriptValue)ScriptValue.of((double)d2), (ScriptContext)scriptContext);
            }
        } else {
            v2 = ScriptValue.NULL;
        }
