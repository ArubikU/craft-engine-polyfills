...
public final class Harvester {
    ...
    public static ScriptValue _harvestColumnAbove(ScriptContext.Builder var0) {
        ...
        while (var11_11 < 1000) {
            ...
            var21_21 = ScriptProgram.resolveForRows((String)"drops", (ScriptContext)var1_1, (int)1);
            if (var21_21 != null) {
                for (ScriptValue[] var23_23 : var21_21) {
                    var0.val("drop", var23_23.length > 0 ? var23_23[0] : ScriptValue.NULL);
                    var24_24 = ScriptContext.builder().copyFrom(var1_1);
    ...
    public static ScriptValue _tryHarvest(ScriptContext.Builder var0) {
        ...
        var27_27 = ScriptProgram.resolveForRows((String)"drops", (ScriptContext)var1_1, (int)1);
        if (var27_27 != null) {
            for (ScriptValue[] var29_29 : var27_27) {
                var0.val("drop", var29_29.length > 0 ? var29_29[0] : ScriptValue.NULL);
                var30_30 = ScriptContext.builder().copyFrom(var1_1);
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        ScriptValue scriptValue4 = scriptValue3 != ScriptValue.NULL ? (scriptValue3 instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue3).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Machine") ? new PolyClassMachine_v2(object).pg$160_contraption() : PolyDispatch.bootstrapGet("memberGet", "contraption", (ScriptValue)scriptValue3, (ScriptContext)scriptContext)) : ScriptValue.NULL;
        ...
        if (ScriptFormula.valuesEqual((ScriptValue)scriptValue4, (ScriptValue)scriptContext.getClassOrVar("null")) ^ true) {
            ...
            if (scriptValue8 != ScriptValue.NULL) {
                ...
                object2 = PolyDispatch.bootstrapCall("memberCall", "is_moving", (ScriptValue)scriptValue8, arrayList4, (ScriptContext)scriptContext);
            } else {
            ...
            if (d2 > 0.0) {
                ...
                arrayList5.add(ScriptFormula.addPolymorphic((ScriptValue)(scriptValue12 != ScriptValue.NULL ? (scriptValue12 instanceof ScriptValue.Obj && (object8 = (obj7 = (ScriptValue.Obj)scriptValue12).instance()) != null && !(object8 instanceof PolyClass) && obj7.typeName().equals("Machine") ? new PolyClassMachine_v2(object8).pg$166_x() : PolyDispatch.bootstrapGet("memberGet", "x", (ScriptValue)scriptValue12, (ScriptContext)scriptContext)) : ScriptValue.NULL), (ScriptValue)(scriptValue11 != ScriptValue.NULL ? (scriptValue11 instanceof ScriptValue.Obj && (object7 = (obj6 = (ScriptValue.Obj)scriptValue11).instance()) != null && !(object7 instanceof PolyClass) && obj6.typeName().equals("Machine") ? new PolyClassMachine_v2(object7).pg$126_facing_dx() : PolyDispatch.bootstrapGet("memberGet", "facing_dx", (ScriptValue)scriptValue11, (ScriptContext)scriptContext)) : ScriptValue.NULL)));
                ...
                arrayList5.add(ScriptFormula.addPolymorphic((ScriptValue)(scriptValue13 != ScriptValue.NULL ? (scriptValue13 instanceof ScriptValue.Obj && (object6 = (obj5 = (ScriptValue.Obj)scriptValue13).instance()) != null && !(object6 instanceof PolyClass) && obj5.typeName().equals("Machine") ? new PolyClassMachine_v2(object6).pg$167_y() : PolyDispatch.bootstrapGet("memberGet", "y", (ScriptValue)scriptValue13, (ScriptContext)scriptContext)) : ScriptValue.NULL), (ScriptValue)(scriptValue14 != ScriptValue.NULL ? (scriptValue14 instanceof ScriptValue.Obj && (object5 = (obj4 = (ScriptValue.Obj)scriptValue14).instance()) != null && !(object5 instanceof PolyClass) && obj4.typeName().equals("Machine") ? new PolyClassMachine_v2(object5).pg$124_facing_dy() : PolyDispatch.bootstrapGet("memberGet", "facing_dy", (ScriptValue)scriptValue14, (ScriptContext)scriptContext)) : ScriptValue.NULL)));
                ...
                arrayList5.add(ScriptFormula.addPolymorphic((ScriptValue)(scriptValue15 != ScriptValue.NULL ? (scriptValue15 instanceof ScriptValue.Obj && (object4 = (obj3 = (ScriptValue.Obj)scriptValue15).instance()) != null && !(object4 instanceof PolyClass) && obj3.typeName().equals("Machine") ? new PolyClassMachine_v2(object4).pg$169_z() : PolyDispatch.bootstrapGet("memberGet", "z", (ScriptValue)scriptValue15, (ScriptContext)scriptContext)) : ScriptValue.NULL), (ScriptValue)(scriptValue16 != ScriptValue.NULL ? (scriptValue16 instanceof ScriptValue.Obj && (object3 = (obj2 = (ScriptValue.Obj)scriptValue16).instance()) != null && !(object3 instanceof PolyClass) && obj2.typeName().equals("Machine") ? new PolyClassMachine_v2(object3).pg$125_facing_dz() : PolyDispatch.bootstrapGet("memberGet", "facing_dz", (ScriptValue)scriptValue16, (ScriptContext)scriptContext)) : ScriptValue.NULL)));
            ...
            builder3.val("block", (ScriptValue)(scriptValue18 != ScriptValue.NULL ? (scriptValue18 instanceof ScriptValue.Obj && (object9 = (obj8 = (ScriptValue.Obj)scriptValue18).instance()) != null && !(object9 instanceof PolyClass) && obj8.typeName().equals("Machine") ? new PolyClassMachine_v2(object9).pg$128_facing_block() : PolyDispatch.bootstrapGet("memberGet", "facing_block", (ScriptValue)scriptValue18, (ScriptContext)scriptContext)) : ScriptValue.NULL));
