    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (ScriptFormula.valuesEqual((ScriptValue)scriptValue6, (ScriptValue)scriptContext.getClassOrVar("null")) ^ true) {
            ...
            if (scriptValue6 != ScriptValue.NULL) {
                ScriptValue.Obj obj;
                Object object2;
                if (scriptValue6 instanceof ScriptValue.Obj && (object2 = (obj = (ScriptValue.Obj)scriptValue6).instance()) != null && !(object2 instanceof PolyClass) && obj.typeName().equals("Contraption")) {
                    ...
                    object = PolyDispatch.bootstrapCall("memberCall", "is_moving", (ScriptValue)scriptValue6, (ScriptContext)scriptContext);
                }
            } else {
            ...
            if (d > 0.0) {
                ...
                if (scriptValue18 instanceof ScriptValue.Obj && (object3 = (obj = (ScriptValue.Obj)scriptValue18).instance()) != null && !(object3 instanceof PolyClass) && obj.typeName().equals("ContraptionWorld")) {
                    PolyClassContraptionWorld polyClassContraptionWorld = new PolyClassContraptionWorld(object3);
                    callSite = polyClassContraptionWorld.tm$8_real_block(scriptValue19.asNum(), scriptValue20.asNum(), scriptValue21.asNum());
                } else {
                    callSite = PolyDispatch.bootstrapCall("memberCall", "real_block", (ScriptValue)scriptValue18, (ScriptValue)scriptValue19, (ScriptValue)scriptValue20, (ScriptValue)scriptValue21, (ScriptContext)scriptContext);
                }
                ...
                if (ScriptFormula.valuesEqual((ScriptValue)callSite2, (ScriptValue)scriptContext.getClassOrVar("null")) || (callSite2 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "is_air", (ScriptValue)callSite2, (ScriptContext)scriptContext) : ScriptValue.NULL).asBool()) {
                    if (scriptValue6 != ScriptValue.NULL) {
                        ...
                        if (scriptValue6 instanceof ScriptValue.Obj && (object4 = (obj2 = (ScriptValue.Obj)scriptValue6).instance()) != null && !(object4 instanceof PolyClass) && obj2.typeName().equals("Contraption")) {
                            PolyClassContraption polyClassContraption5 = new PolyClassContraption(object4);
                            v5 = ScriptValue.of((boolean)polyClassContraption5.tm$2_release(scriptValue22.asStr()));
                        } else {
                            v5 = PolyDispatch.bootstrapCall("memberCall", "release", (ScriptValue)scriptValue6, (ScriptValue)scriptValue22, (ScriptContext)scriptContext);
                        }
                    } else {
                        v5 = ScriptValue.NULL;
                    }
                    ...
                    if (scriptValue6 != ScriptValue.NULL) {
                        ...
                        if (scriptValue6 instanceof ScriptValue.Obj && (object6 = (obj3 = (ScriptValue.Obj)scriptValue6).instance()) != null && !(object6 instanceof PolyClass) && obj3.typeName().equals("Contraption")) {
                            PolyClassContraption polyClassContraption6 = new PolyClassContraption(object6);
                            v6 = ScriptValue.of((boolean)polyClassContraption6.tm$12_hold(scriptValue24.asStr()));
                        } else {
                            v6 = PolyDispatch.bootstrapCall("memberCall", "hold", (ScriptValue)scriptValue6, (ScriptValue)scriptValue24, (ScriptContext)scriptContext);
                        }
                    } else {
                        v6 = ScriptValue.NULL;
                    }
                    ...
                    if (scriptValue25 != ScriptValue.NULL) {
                        ...
                        if (scriptValue25 instanceof ScriptValue.Obj && (object7 = (obj4 = (ScriptValue.Obj)scriptValue25).instance()) != null && !(object7 instanceof PolyClass) && obj4.typeName().equals("Machine")) {
                            PolyClassMachine polyClassMachine11 = new PolyClassMachine(object7);
                            object5 = polyClassMachine11.tm$2_tick_break((ScriptValue)callSite3, scriptValue26.asNum());
                        } else {
                            object5 = PolyDispatch.bootstrapCall("memberCall", "tick_break", (ScriptValue)scriptValue25, (ScriptValue)callSite3, (ScriptValue)scriptValue26, (ScriptContext)scriptContext);
                        }
                    } else {
                        object5 = ScriptValue.NULL;
                    }
                    ScriptValue scriptValue27 = object5;
                    ...
                    if (ScriptFormula.valuesEqual((ScriptValue)scriptValue27, (ScriptValue)scriptContext.getClassOrVar("null")) ^ true) {
                        ...
                        if (scriptValue6 != ScriptValue.NULL) {
                            ...
                            if (scriptValue6 instanceof ScriptValue.Obj && (object8 = (obj5 = (ScriptValue.Obj)scriptValue6).instance()) != null && !(object8 instanceof PolyClass) && obj5.typeName().equals("Contraption")) {
                                PolyClassContraption polyClassContraption7 = new PolyClassContraption(object8);
                                v8 = ScriptValue.of((boolean)polyClassContraption7.tm$2_release(scriptValue29.asStr()));
                            } else {
                                v8 = PolyDispatch.bootstrapCall("memberCall", "release", (ScriptValue)scriptValue6, (ScriptValue)scriptValue29, (ScriptContext)scriptContext);
                            }
                        } else {
                            v8 = ScriptValue.NULL;
                        }
                    ...
                    if ((scriptValue23 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL) {
                        ...
                        if (scriptValue23 instanceof ScriptValue.Obj && (object9 = (obj6 = (ScriptValue.Obj)scriptValue23).instance()) != null && !(object9 instanceof PolyClass) && obj6.typeName().equals("Machine")) {
                            PolyClassMachine polyClassMachine12 = new PolyClassMachine(object9);
                            v9 = ScriptValue.of((boolean)polyClassMachine12.tm$56_report_su(scriptValue30.asNum()));
                        } else {
                            v9 = PolyDispatch.bootstrapCall("memberCall", "report_su", (ScriptValue)scriptValue23, (ScriptValue)scriptValue30, (ScriptContext)scriptContext);
                        }
                    } else {
                        v9 = ScriptValue.NULL;
                    }
                ...
                if (scriptValue6 instanceof ScriptValue.Obj && (object10 = (obj = (ScriptValue.Obj)scriptValue6).instance()) != null && !(object10 instanceof PolyClass) && obj.typeName().equals("Contraption")) {
                    PolyClassContraption polyClassContraption8 = new PolyClassContraption(object10);
                    v10 = ScriptValue.of((boolean)polyClassContraption8.tm$2_release(scriptValue31.asStr()));
                } else {
                    v10 = PolyDispatch.bootstrapCall("memberCall", "release", (ScriptValue)scriptValue6, (ScriptValue)scriptValue31, (ScriptContext)scriptContext);
                }
            } else {
            ...
            if (scriptValue35 != ScriptValue.NULL) {
                ...
                if (scriptValue35 instanceof ScriptValue.Obj && (object11 = (obj = (ScriptValue.Obj)scriptValue35).instance()) != null && !(object11 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine polyClassMachine14 = new PolyClassMachine(object11);
                    object = polyClassMachine14.tm$2_tick_break(scriptValue37, d5);
                } else {
                    object = PolyDispatch.bootstrapCall("memberCall", "tick_break", (ScriptValue)scriptValue35, (ScriptValue)scriptValue37, (ScriptValue)ScriptValue.of((double)d5), (ScriptContext)scriptContext);
                }
            } else {
                object = ScriptValue.NULL;
            }
            ...
            if ((scriptValue33 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL) {
                ...
                Object object12;
                double d6 = 8.0 + d4;
                if (scriptValue33 instanceof ScriptValue.Obj && (object12 = (obj = (ScriptValue.Obj)scriptValue33).instance()) != null && !(object12 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine polyClassMachine15 = new PolyClassMachine(object12);
                    v12 = ScriptValue.of((boolean)polyClassMachine15.tm$56_report_su(d6));
                } else {
                    v12 = PolyDispatch.bootstrapCall("memberCall", "report_su", (ScriptValue)scriptValue33, (ScriptValue)ScriptValue.of((double)d6), (ScriptContext)scriptContext);
                }
            } else {
