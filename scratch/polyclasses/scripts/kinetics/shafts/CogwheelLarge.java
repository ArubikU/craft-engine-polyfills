    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (list != null) {
            for (ScriptValue scriptValue6 : list) {
                ...
                if (!(ScriptFormula.callBuiltin2((String)"contains", (ScriptValue)scriptValue5, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", CogwheelLarge.class, "cogwheel_small")), (ScriptContext)scriptContext).asBool() && ScriptFormula.callBuiltin2((String)"contains", (ScriptValue)scriptValue5, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", CogwheelLarge.class, "large")), (ScriptContext)scriptContext).asBool() ^ true)) continue;
                if (scriptValue != ScriptValue.NULL) {
                    ...
                    if (polyClassMachine_v316 != null) {
                        object = polyClassMachine_v316.um$29_relay_to(arrayList5);
                        continue;
                    }
                    object = PolyDispatch.bootstrapCall("memberCall", "relay_to", (ScriptValue)scriptValue, arrayList5, (ScriptContext)scriptContext);
                    continue;
                }
                object = ScriptValue.NULL;
            }
