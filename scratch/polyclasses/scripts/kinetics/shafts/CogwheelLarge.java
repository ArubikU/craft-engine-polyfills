...
public final class CogwheelLarge {
    ...
    public static void run(ScriptContext.Builder var0) {
        block64: {
            ...
            if (var152_116 == null) break block64;
            for (ScriptValue var154_118 : var152_116) {
                ...
                if (var161_125 != ScriptValue.NULL) {
                    ...
                    var162_126.add(ScriptValue.of((double)(-var1_1.getNum("rpm") * 2.0)));
                    var162_126.add(var13_13);
                    if (var161_125 instanceof ScriptValue.Obj && (var164_128 = (var163_127 = (ScriptValue.Obj)var161_125).instance()) != null && !(var164_128 instanceof PolyClass) && var163_127.typeName().equals("Machine")) {
                        v16 /* !! */  = new PolyClassMachine_v4(var164_128).um$29_relay_to(var162_126);
                        continue;
                    }
                    v16 /* !! */  = PolyDispatch.bootstrapCall("memberCall", "relay_to", (ScriptValue)var161_125, var162_126, (ScriptContext)var1_1);
                    continue;
                }
