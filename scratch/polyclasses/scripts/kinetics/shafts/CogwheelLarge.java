    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (scriptValue3 != ScriptValue.NULL) {
            ...
            if (scriptValue3 instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue3).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Machine")) {
                PolyClassMachine_v4 polyClassMachine_v4 = new PolyClassMachine_v4(object);
                v1 = ScriptValue.of((boolean)polyClassMachine_v4.tm$106_set_rpm_output(scriptValue4.asNum()));
            } else {
        ...
        ScriptValue scriptValue5 = polyClassMachine_v4 != null ? polyClassMachine_v4.pg$127_axis() : ((scriptValue2 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "axis", (ScriptValue)scriptValue2, (ScriptContext)scriptContext) : ScriptValue.NULL);
        ...
        ScriptValue scriptValue6 = polyClassMachine_v42 != null ? polyClassMachine_v42.pg$183_rpm_network() : ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "rpm_network", (ScriptValue)scriptValue, (ScriptContext)scriptContext) : ScriptValue.NULL);
        ...
        if (ScriptFormula.valuesEqualStr((ScriptValue)scriptValue5, (String)"y")) {
            ...
            if (scriptValue7 != ScriptValue.NULL) {
                ...
                if (scriptValue7 instanceof ScriptValue.Obj && (object5 = (obj = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object5 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    ...
                    object4 = polyClassMachine_v43.tm$68_block_at(d, d2, d3);
                } else {
            ...
            if (scriptValue8 != ScriptValue.NULL) {
                ...
                if (scriptValue8 instanceof ScriptValue.Obj && (object6 = (obj = (ScriptValue.Obj)scriptValue8).instance()) != null && !(object6 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    ...
                    object3 = polyClassMachine_v44.tm$68_block_at(d, d4, d5);
                } else {
            ...
            if (scriptValue9 != ScriptValue.NULL) {
                ...
                if (scriptValue9 instanceof ScriptValue.Obj && (object7 = (obj = (ScriptValue.Obj)scriptValue9).instance()) != null && !(object7 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v4 polyClassMachine_v45 = new PolyClassMachine_v4(object7);
                    object2 = polyClassMachine_v45.tm$68_block_at(d, d6, d7);
                } else {
            ...
            if (scriptValue10 != ScriptValue.NULL) {
                ...
                if (scriptValue10 instanceof ScriptValue.Obj && (object8 = (obj = (ScriptValue.Obj)scriptValue10).instance()) != null && !(object8 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    ...
                    object = polyClassMachine_v46.tm$68_block_at(d, d8, d9);
                } else {
            ...
            if (scriptValue11 != ScriptValue.NULL) {
                ...
                if (scriptValue11 instanceof ScriptValue.Obj && (object12 = (obj = (ScriptValue.Obj)scriptValue11).instance()) != null && !(object12 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    ...
                    object11 = polyClassMachine_v47.tm$68_block_at(d, d10, d11);
                } else {
            ...
            if (scriptValue12 != ScriptValue.NULL) {
                ...
                if (scriptValue12 instanceof ScriptValue.Obj && (object13 = (obj = (ScriptValue.Obj)scriptValue12).instance()) != null && !(object13 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    ...
                    object10 = polyClassMachine_v48.tm$68_block_at(d, d12, d13);
                } else {
            ...
            if (scriptValue13 != ScriptValue.NULL) {
                ...
                if (scriptValue13 instanceof ScriptValue.Obj && (object14 = (obj = (ScriptValue.Obj)scriptValue13).instance()) != null && !(object14 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    ...
                    object9 = polyClassMachine_v49.tm$68_block_at(d, d14, d15);
                } else {
            ...
            if (scriptValue14 != ScriptValue.NULL) {
                ...
                if (scriptValue14 instanceof ScriptValue.Obj && (object15 = (obj = (ScriptValue.Obj)scriptValue14).instance()) != null && !(object15 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    ...
                    object = polyClassMachine_v410.tm$68_block_at(d, d16, d17);
                } else {
            ...
            if (scriptValue15 != ScriptValue.NULL) {
                ...
                if (scriptValue15 instanceof ScriptValue.Obj && (object19 = (obj = (ScriptValue.Obj)scriptValue15).instance()) != null && !(object19 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v4 polyClassMachine_v411 = new PolyClassMachine_v4(object19);
                    object18 = polyClassMachine_v411.tm$68_block_at(d, d18, d19);
                } else {
            ...
            if (scriptValue16 != ScriptValue.NULL) {
                ...
                if (scriptValue16 instanceof ScriptValue.Obj && (object20 = (obj = (ScriptValue.Obj)scriptValue16).instance()) != null && !(object20 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v4 polyClassMachine_v412 = new PolyClassMachine_v4(object20);
                    object17 = polyClassMachine_v412.tm$68_block_at(d, d20, d21);
                } else {
            ...
            if (scriptValue17 != ScriptValue.NULL) {
                ...
                if (scriptValue17 instanceof ScriptValue.Obj && (object21 = (obj = (ScriptValue.Obj)scriptValue17).instance()) != null && !(object21 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v4 polyClassMachine_v413 = new PolyClassMachine_v4(object21);
                    object16 = polyClassMachine_v413.tm$68_block_at(d, d22, d23);
                } else {
            ...
            if (scriptValue18 != ScriptValue.NULL) {
                ...
                if (scriptValue18 instanceof ScriptValue.Obj && (object22 = (obj = (ScriptValue.Obj)scriptValue18).instance()) != null && !(object22 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v4 polyClassMachine_v414 = new PolyClassMachine_v4(object22);
                    object = polyClassMachine_v414.tm$68_block_at(d, d24, d25);
                } else {
        ...
        if (list != null) {
            for (ScriptValue scriptValue20 : list) {
                ...
                if (ScriptFormula.valuesEqual((ScriptValue)(scriptValue21 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "property", (ScriptValue)scriptValue21, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", CogwheelLarge.class, "axis")), (ScriptContext)scriptContext) : ScriptValue.NULL), (ScriptValue)scriptValue5) ^ true) continue;
                ...
                if (scriptValue23 != ScriptValue.NULL) {
                    ...
                    if (scriptValue23 instanceof ScriptValue.Obj && (object23 = (obj = (ScriptValue.Obj)scriptValue23).instance()) != null && !(object23 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                        object = new PolyClassMachine_v4(object23).um$29_relay_to(arrayList5);
                        continue;
                    }
                    object = PolyDispatch.bootstrapCall("memberCall", "relay_to", (ScriptValue)scriptValue23, arrayList5, (ScriptContext)scriptContext);
                    continue;
                }
                object = ScriptValue.NULL;
            }
        ...
        builder.val("is_now", scriptValue24);
