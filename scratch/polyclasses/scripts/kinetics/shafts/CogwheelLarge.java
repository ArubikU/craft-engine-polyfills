        ...
        if (list != null) {
            for (ScriptValue scriptValue20 : list) {
                ...
                if (scriptValue22 != ScriptValue.NULL) {
                    ...
                    if (scriptValue22 instanceof ScriptValue.Obj && (object23 = (obj = (ScriptValue.Obj)scriptValue22).instance()) != null && !(object23 instanceof PolyClass) && obj.typeName().equals("Machine")) {
