        ...
        block35: {
            block36: {
                block33: {
                    block34: {
                        ...
                        if (var62_58 != ScriptValue.NULL) {
                            ...
                            var66_62 = PolyClassMachine.ofGuarded((ScriptValue)var62_58);
                    ...
                    if (var67_63 != ScriptValue.NULL) {
                        ...
                        var71_67 = PolyClassMachine.ofGuarded((ScriptValue)var67_63);
                ...
                if (var72_68 != ScriptValue.NULL) {
                    ...
                    var74_70 = "int";
                    var75_71 = PolyClassMachine.ofGuarded((ScriptValue)var72_68);
                ...
                if (var1_1.getNum("keepalive") > 0.0) {
                    var80_75 = var1_1.getClassOrVar("Machine");
                    if (var80_75 != ScriptValue.NULL) {
                        var81_76 = "_psi_keepalive";
                        var82_77 = "int";
                        var83_78 = ScriptValue.of((double)(var1_1.getNum("keepalive") - 1.0));
                        var84_79 = PolyClassMachine.ofGuarded((ScriptValue)var80_75);
                        v13 /* !! */  = var84_79 != null ? ScriptValue.of((boolean)var84_79.tm$82_set_typed(var81_76, var82_77, var83_78)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)var80_75, (ScriptValue)ScriptValue.of((String)var81_76), (ScriptValue)ScriptValue.of((String)var82_77), (ScriptValue)var83_78, (ScriptContext)var1_1);
                    } else {
                        v13 /* !! */  = ScriptValue.NULL;
                    }
                } else {
                    var85_80 = var1_1.getClassOrVar("Machine");
                    if (var85_80 != ScriptValue.NULL) {
                        var86_81 = "_psi_uuid";
                        var87_82 = "str";
                        var88_83 =  /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", PortableStorageInterface.class, "");
                        var89_84 = PolyClassMachine.ofGuarded((ScriptValue)var85_80);
                        v14 /* !! */  = var89_84 != null ? ScriptValue.of((boolean)var89_84.tm$82_set_typed(var86_81, var87_82, var88_83)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)var85_80, (ScriptValue)ScriptValue.of((String)var86_81), (ScriptValue)ScriptValue.of((String)var87_82), (ScriptValue)var88_83, (ScriptContext)var1_1);
                    } else {
                        v14 /* !! */  = ScriptValue.NULL;
                    }
                }
                if (!(var1_1.getNum("keepalive") > 0.0)) break block36;
                var90_85 = PolyClassMachine.ofVar((ScriptContext)var1_1, (String)"Machine");
                v15 = var90_85 != null ? var90_85.tg$136_last_transfer_tick() : ((var91_86 = var1_1.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "last_transfer_tick", (ScriptValue)var91_86, (ScriptContext)var1_1).asNum() : ScriptValue.NULL.asNum());
                if (!(v15 >= 0.0)) ** GOTO lbl-1000
                v16 = ScriptFormula.callBuiltin0((String)"tick", (ScriptContext)var1_1).asNum();
                var92_87 = PolyClassMachine.ofVar((ScriptContext)var1_1, (String)"Machine");
                v17 = var92_87 != null ? var92_87.tg$136_last_transfer_tick() : ((var93_88 = var1_1.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "last_transfer_tick", (ScriptValue)var93_88, (ScriptContext)var1_1).asNum() : ScriptValue.NULL.asNum());
                if (v16 - v17 < 10.0) {
                    v18 = true;
                } else lbl-1000:
                // 2 sources
                ...
                var94_89 = v18;
                var95_90 = ScriptValue.of((boolean)v18);
                var0.val("recent", var95_90);
                var96_91 = var1_1.getClassOrVar("Machine");
                if (var96_91 != ScriptValue.NULL) {
                    var97_92 = "_psi_extend";
                    var98_93 = "int";
                    var99_94 = ScriptValue.of((double)(var94_89 != false ? 2.0 : 1.0));
                    var100_95 = PolyClassMachine.ofGuarded((ScriptValue)var96_91);
                    v19 /* !! */  = var100_95 != null ? ScriptValue.of((boolean)var100_95.tm$82_set_typed(var97_92, var98_93, var99_94)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)var96_91, (ScriptValue)ScriptValue.of((String)var97_92), (ScriptValue)ScriptValue.of((String)var98_93), (ScriptValue)var99_94, (ScriptContext)var1_1);
                } else {
            ...
            if (var101_96 != ScriptValue.NULL) {
                var102_97 = "_psi_extend";
                var103_98 = "int";
                var104_99 =  /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", PortableStorageInterface.class, 0.0);
                var105_100 = PolyClassMachine.ofGuarded((ScriptValue)var101_96);
                v20 /* !! */  = var105_100 != null ? ScriptValue.of((boolean)var105_100.tm$82_set_typed(var102_97, var103_98, var104_99)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)var101_96, (ScriptValue)ScriptValue.of((String)var102_97), (ScriptValue)ScriptValue.of((String)var103_98), (ScriptValue)var104_99, (ScriptContext)var1_1);
            } else {
