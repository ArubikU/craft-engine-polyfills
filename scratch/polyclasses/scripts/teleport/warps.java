...
public final class Warps {
    ...
    public static ScriptValue createWarp(ScriptContext.Builder var0) {
        ...
        if (var6_6 != ScriptValue.NULL) {
            ...
            var17_17 = PolyClassServer.ofVar((ScriptContext)var1_1, (String)"Server");
            var7_7.add(var17_17 != null ? var17_17.pg$16_time() : ((var18_18 = var1_1.getClassOrVar("Server")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "time", (ScriptValue)var18_18, (ScriptContext)var1_1) : ScriptValue.NULL));
        ...
        if (Warps.warpExists(builder3).asBool()) {
            ...
            if (scriptValue14 != ScriptValue.NULL) {
                ...
                if (scriptValue14 instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue14).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Player")) {
                    ...
                    v8 = ScriptValue.of((boolean)polyClassPlayer2.tm$42_send_message(scriptValue15.asStr()));
                } else {
    ...
    public static ScriptValue generateSponsorButtons(ScriptContext.Builder builder) {
        ...
        if (list != null) {
            for (ScriptValue scriptValue : list) {
                ...
                ScriptValue scriptValue3 = ScriptFormula.addPolymorphic((ScriptValue)scriptContext.getClassOrVar("i"), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", Warps.class, 1.0)));
                builder.val("slot_num", scriptValue3);
                ScriptValue scriptValue4 = scriptContext.getClassOrVar("SPONSOR_SLOTS");
                ScriptValue scriptValue5 = scriptValue4 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue4, (ScriptValue)scriptContext.getClassOrVar("i"), (ScriptContext)scriptContext) : ScriptValue.NULL;
                builder.val("slot", scriptValue5);
                ScriptContext.Builder builder2 = ScriptContext.builder().copyFrom(scriptContext);
                builder2.val("slot_num", scriptValue3);
                ScriptValue scriptValue6 = Warps.sponsorRow(builder2);
                ...
                builder.val("name", scriptValue8);
                ArrayList<ScriptValue> arrayList4 = new ArrayList<ScriptValue>();
                arrayList4.add(scriptValue8);
                if (ScriptFormula.callBuiltin((String)"is_null", arrayList4, (ScriptContext)scriptContext).asBool()) {
                    ScriptValue scriptValue9;
                    ScriptValue scriptValue10 = scriptContext.getClassOrVar("SPONSOR_PRICES");
                    ScriptValue scriptValue11 = scriptValue10 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue10, (ScriptValue)scriptContext.getClassOrVar("i"), (ScriptContext)scriptContext) : ScriptValue.NULL;
                    builder.val("price", scriptValue11);
                    double d = 3600.0;
                    double d2 = 3600.0 == 0.0 ? 0.0 : ((scriptValue9 = scriptContext.getClassOrVar("SPONSOR_DURATIONS")) != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue9, (ScriptValue)scriptContext.getClassOrVar("i"), (ScriptContext)scriptContext) : ScriptValue.NULL).asNum() / d;
                    ScriptValue scriptValue12 = ScriptValue.of((double)d2);
                    builder.val("hours", scriptValue12);
                    ArrayList<ScriptValue> arrayList5 = new ArrayList<ScriptValue>();
                    ...
                    arrayList6.add(ScriptValue.of((String)("<yellow>Sponsor Slot #" + scriptValue3.asStr())));
                    ...
                    arrayList7.add(ScriptValue.of((String)("<gray>Price: <white>" + scriptValue11.asStr() + " XP")));
                    ...
                    arrayList6.add(ScriptValue.of((String)("warps.pf:open_sponsor_dialog:" + scriptValue3.asStr())));
                    arrayList5.add(ScriptFormula.callBuiltin((String)"make_map", arrayList6, (ScriptContext)scriptContext));
                    ScriptValue scriptValue13 = ScriptFormula.callBuiltin((String)"push", arrayList5, (ScriptContext)scriptContext);
                    builder.val("out", scriptValue13);
                    continue;
                }
                ScriptContext.Builder builder3 = ScriptContext.builder().copyFrom(scriptContext);
                builder3.val("name", scriptValue8);
                ScriptValue scriptValue14 = Warps.warpLore(builder3);
                builder.val("lore", scriptValue14);
                ScriptValue scriptValue15 = scriptContext.getClassOrVar("row");
                PolyClassPlayer polyClassPlayer = PolyClassPlayer.ofVar((ScriptContext)scriptContext, (String)"Player");
                if (ScriptFormula.valuesEqual((ScriptValue)(scriptValue15 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue15, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Warps.class, "buyer_uuid")), (ScriptContext)scriptContext) : ScriptValue.NULL), (ScriptValue)(polyClassPlayer != null ? polyClassPlayer.pg$34_uuid() : ((scriptValue2 = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "uuid", (ScriptValue)scriptValue2, (ScriptContext)scriptContext) : ScriptValue.NULL)))) {
                    ArrayList<ScriptValue> arrayList8 = new ArrayList<ScriptValue>();
                    arrayList8.add(scriptContext.getClassOrVar("lore"));
                ...
                arrayList11.add(ScriptValue.of((String)("<gold>[Sponsored] <yellow>" + scriptValue8.asStr())));
                ...
                arrayList11.add(ScriptValue.of((String)("warps.pf:on_sponsor_click:" + scriptValue3.asStr())));
    ...
    public static ScriptValue onSponsorSubmit(ScriptContext.Builder builder) {
        ...
        if (scriptValue16 != ScriptValue.NULL) {
            ...
            ScriptValue scriptValue19 =  /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Warps.class, "INSERT INTO warp_sponsors (slot_num, warp_id, buyer_uuid, expires_at) VALUES (?, ?, ?, ?)");
            ArrayList<ScriptValue> arrayList5 = new ArrayList<ScriptValue>();
            arrayList5.add(scriptContext.getClassOrVar("slot_num"));
            ScriptValue scriptValue20 = ScriptFormula.callBuiltin((String)"int", arrayList5, (ScriptContext)scriptContext);
            ScriptContext.Builder builder5 = ScriptContext.builder().copyFrom(scriptContext);
            ...
            v9 = PolyDispatch.bootstrapCall("memberCall", "execute", (ScriptValue)scriptValue16, (ScriptValue)scriptValue19, (ScriptValue)scriptValue20, (ScriptValue)Warps.warpId(builder5), (ScriptValue)(polyClassPlayer != null ? polyClassPlayer.pg$34_uuid() : ((scriptValue18 = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "uuid", (ScriptValue)scriptValue18, (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptValue)ScriptFormula.addPolymorphic((ScriptValue)(polyClassServer != null ? polyClassServer.pg$16_time() : ((scriptValue17 = scriptContext.getClassOrVar("Server")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "time", (ScriptValue)scriptValue17, (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptValue)(scriptValue21 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue21, (ScriptValue)ScriptValue.of((double)d), (ScriptContext)scriptContext) : ScriptValue.NULL)), (ScriptContext)scriptContext);
        } else {
            v9 = ScriptValue.NULL;
        }
    ...
    public static ScriptValue onSponsorClick(ScriptContext.Builder builder) {
        ...
        ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
        arrayList.add(scriptContext.getClassOrVar("slot_num"));
        builder2.val("slot_num", ScriptFormula.callBuiltin((String)"int", arrayList, (ScriptContext)scriptContext));
        ...
        if (ScriptFormula.callBuiltin((String)"is_null", arrayList2, (ScriptContext)scriptContext).asBool()) {
            return ScriptValue.NULL;
        }
        ...
        if (ScriptFormula.valuesEqualStr((ScriptValue)(scriptValue6 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "click_type", (ScriptValue)scriptValue6, (ScriptContext)scriptContext) : ScriptValue.NULL), (String)"shift_right") && ScriptFormula.valuesEqual((ScriptValue)((scriptValue2 = scriptContext.getClassOrVar("row")) != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue2, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Warps.class, "buyer_uuid")), (ScriptContext)scriptContext) : ScriptValue.NULL), (ScriptValue)((polyClassPlayer = PolyClassPlayer.ofVar((ScriptContext)scriptContext, (String)"Player")) != null ? polyClassPlayer.pg$34_uuid() : ((scriptValue = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "uuid", (ScriptValue)scriptValue, (ScriptContext)scriptContext) : ScriptValue.NULL)))) {
            ScriptValue scriptValue7 = scriptContext.getClassOrVar("SQL");
            if (scriptValue7 != ScriptValue.NULL) {
                ScriptValue scriptValue8 =  /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Warps.class, "DELETE FROM warp_sponsors WHERE slot_num = ?");
                ArrayList<ScriptValue> arrayList3 = new ArrayList<ScriptValue>();
                arrayList3.add(scriptContext.getClassOrVar("slot_num"));
                v1 = PolyDispatch.bootstrapCall("memberCall", "execute", (ScriptValue)scriptValue7, (ScriptValue)scriptValue8, (ScriptValue)ScriptFormula.callBuiltin((String)"int", arrayList3, (ScriptContext)scriptContext), (ScriptContext)scriptContext);
            } else {
                v1 = ScriptValue.NULL;
            }
            ScriptValue scriptValue9 = scriptContext.getClassOrVar("Player");
            if (scriptValue9 != ScriptValue.NULL) {
                ScriptValue.Obj obj;
                Object object;
                ScriptValue scriptValue10 = ScriptValue.of((String)("<yellow>Removed your sponsor from slot #" + scriptContext.getStr("slot_num") + "."));
                if (scriptValue9 instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue9).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Player")) {
                    PolyClassPlayer polyClassPlayer2 = new PolyClassPlayer(object);
                    v2 = ScriptValue.of((boolean)polyClassPlayer2.tm$42_send_message(scriptValue10.asStr()));
                } else {
                    v2 = PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue9, (ScriptValue)scriptValue10, (ScriptContext)scriptContext);
                }
            } else {
                v2 = ScriptValue.NULL;
            }
            ScriptValue scriptValue11 = scriptContext.getClassOrVar("Cmd");
            Object object = scriptValue11 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "open_page", (ScriptValue)scriptValue11, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Warps.class, "main")), (ScriptContext)scriptContext) : ScriptValue.NULL;
            return ScriptValue.NULL;
        }
        ScriptContext.Builder builder3 = ScriptContext.builder().copyFrom(scriptContext);
    ...
    public static ScriptValue generateRateButtons(ScriptContext.Builder builder) {
        ...
        if (list != null) {
            for (ScriptValue scriptValue5 : list) {
                ...
                arrayList3.add(scriptValue);
                if (d2 >= ScriptFormula.callBuiltin((String)"len", arrayList3, (ScriptContext)scriptContext).asNum()) break;
                ScriptValue scriptValue8 = scriptContext.getClassOrVar("records");
                ScriptValue scriptValue9 = scriptValue8 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue8, (ScriptValue)scriptValue7, (ScriptContext)scriptContext) : ScriptValue.NULL;
                builder.val("entry", scriptValue9);
                ScriptValue scriptValue10 = scriptContext.getClassOrVar("entry");
                ScriptValue scriptValue11 = scriptValue10 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue10, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Warps.class, "uuid")), (ScriptContext)scriptContext) : ScriptValue.NULL;
                builder.val("rater_uuid", scriptValue11);
                ScriptValue scriptValue12 = scriptContext.getClassOrVar("entry");
                ...
                builder.val("rater_name", scriptValue13);
                ScriptValue scriptValue14 = scriptContext.getClassOrVar("entry");
                ScriptValue scriptValue15 = scriptValue14 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue14, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", Warps.class, "stars")), (ScriptContext)scriptContext) : ScriptValue.NULL;
                builder.val("stars", scriptValue15);
                ArrayList<ScriptValue> arrayList4 = new ArrayList<ScriptValue>();
                arrayList4.add(ScriptValue.of((String)("<gray>Rating: <yellow>" + scriptValue15.asStr() + "/5")));
                ScriptValue.Array array2 = new ScriptValue.Array(arrayList4);
                builder.val("lore", (ScriptValue)array2);
                PolyClassPlayer polyClassPlayer = PolyClassPlayer.ofVar((ScriptContext)scriptContext, (String)"Player");
                if (ScriptFormula.valuesEqual((ScriptValue)scriptValue11, (ScriptValue)(polyClassPlayer != null ? polyClassPlayer.pg$34_uuid() : ((scriptValue6 = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "uuid", (ScriptValue)scriptValue6, (ScriptContext)scriptContext) : ScriptValue.NULL)))) {
                    ArrayList<ScriptValue> arrayList5 = new ArrayList<ScriptValue>();
                    arrayList5.add(scriptContext.getClassOrVar("lore"));
                ...
                ScriptContext.Builder builder3 = ScriptContext.builder().copyFrom(scriptContext);
                builder3.val("name", scriptValue13);
                ...
                arrayList8.add(ScriptValue.of((String)("<white>" + scriptValue13.asStr() + "'s rate")));
                ...
                arrayList8.add(ScriptValue.of((String)("warps.pf:on_unrate_click:" + scriptValue11.asStr())));
    ...
    public static ScriptValue cmdReset(ScriptContext.Builder builder) {
        ...
        if (scriptValue14 != ScriptValue.NULL) {
            ScriptValue.Obj obj;
            Object object;
            ScriptValue scriptValue15 = ScriptValue.of((String)("<green>\u2714 <white>Moved '" + scriptValue3.asStr() + "' to your current location."));
            if (scriptValue14 instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue14).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Player")) {
                PolyClassPlayer polyClassPlayer2 = new PolyClassPlayer(object);
                v8 = ScriptValue.of((boolean)polyClassPlayer2.tm$42_send_message(scriptValue15.asStr()));
            } else {
