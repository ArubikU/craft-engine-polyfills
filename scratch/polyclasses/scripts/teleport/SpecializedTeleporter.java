...
public final class SpecializedTeleporter {
    ...
    public static ScriptValue unregisterSelf(ScriptContext.Builder builder) {
        ...
        ScriptValue scriptValue5 = SpecializedTeleporter.myPosStr(builder3);
        builder.val("mine", scriptValue5);
        ScriptValue scriptValue6 =  /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", SpecializedTeleporter.class, "");
    ...
    public static ScriptValue setFrequency(ScriptContext.Builder builder) {
        ...
        if (scriptValue2 != ScriptValue.NULL) {
            ...
            String string3 = "int";
            ScriptValue scriptValue4 =  /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", SpecializedTeleporter.class, 0.0);
            PolyClassMachine_v3 polyClassMachine_v3 = PolyClassMachine_v3.ofGuarded((ScriptValue)scriptValue2);
            v1 = polyClassMachine_v3 != null ? ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string3, scriptValue4)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue2, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string3), (ScriptValue)scriptValue4, (ScriptContext)scriptContext);
        } else {
            v1 = ScriptValue.NULL;
        }
        return ScriptValue.NULL;
    ...
    public static ScriptValue _ownAlias(ScriptContext.Builder builder) {
        ...
        PolyClassMachine_v3 polyClassMachine_v3 = PolyClassMachine_v3.ofVar((ScriptContext)scriptContext, (String)"Machine");
        builder2.val("x", (ScriptValue)(polyClassMachine_v3 != null ? polyClassMachine_v3.pg$200_x() : ((scriptValue3 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "x", (ScriptValue)scriptValue3, (ScriptContext)scriptContext) : ScriptValue.NULL)));
        PolyClassMachine_v3 polyClassMachine_v32 = PolyClassMachine_v3.ofVar((ScriptContext)scriptContext, (String)"Machine");
        builder2.val("y", (ScriptValue)(polyClassMachine_v32 != null ? polyClassMachine_v32.pg$202_y() : ((scriptValue2 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "y", (ScriptValue)scriptValue2, (ScriptContext)scriptContext) : ScriptValue.NULL)));
        PolyClassMachine_v3 polyClassMachine_v33 = PolyClassMachine_v3.ofVar((ScriptContext)scriptContext, (String)"Machine");
        builder2.val("z", (ScriptValue)(polyClassMachine_v33 != null ? polyClassMachine_v33.pg$206_z() : ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "z", (ScriptValue)scriptValue, (ScriptContext)scriptContext) : ScriptValue.NULL)));
    ...
    public static ScriptValue statusLore(ScriptContext.Builder builder) {
        ...
        if (scriptValue7 != ScriptValue.NULL) {
            ...
            object = polyClassMachine_v3 != null ? polyClassMachine_v3.tm$34_get_typed(string, string2) : PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue7, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string2), (ScriptContext)scriptContext);
        } else {
            object = ScriptValue.NULL;
        }
    ...
    public static ScriptValue doTeleportSlot(ScriptContext.Builder builder) {
        block16: {
            ...
            PolyClassMachine_v3 polyClassMachine_v33 = PolyClassMachine_v3.ofVar((ScriptContext)scriptContext, (String)"Machine");
            double d = polyClassMachine_v33 != null ? polyClassMachine_v33.tg$126_energy_stored() : ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "energy_stored", (ScriptValue)scriptValue, (ScriptContext)scriptContext).asNum() : ScriptValue.NULL.asNum());
            ...
            if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue10, (ScriptContext)scriptContext).asBool()) {
                ...
                if (scriptValue11 != ScriptValue.NULL) {
                    ...
                    v3 = polyClassPlayer_v2 != null ? ScriptValue.of((boolean)polyClassPlayer_v2.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue11, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
                } else {
                    v3 = ScriptValue.NULL;
                }
                return ScriptValue.NULL;
            ...
            if (scriptValue13 != ScriptValue.NULL) {
                ...
                object = polyClassMachine_v34 != null ? ScriptValue.of((boolean)polyClassMachine_v34.tm$11_consume_energy(scriptValue14.asNum())) : PolyDispatch.bootstrapCall("memberCall", "consume_energy", (ScriptValue)scriptValue13, (ScriptValue)scriptValue14, (ScriptContext)scriptContext);
            } else {
                object = ScriptValue.NULL;
            }
            if (!object.asBool()) break block16;
            ScriptValue scriptValue15 = scriptContext.getClassOrVar("Machine");
            Object object3 = scriptValue15 != ScriptValue.NULL ? ((polyClassMachine_v3 = PolyClassMachine_v3.ofGuarded((ScriptValue)scriptValue15)) != null ? ScriptValue.of((boolean)polyClassMachine_v3.tm$92_close()) : PolyDispatch.bootstrapCall("memberCall", "close", (ScriptValue)scriptValue15, (ScriptContext)scriptContext)) : ScriptValue.NULL;
            ScriptValue scriptValue16 = scriptContext.getClassOrVar("Player");
            if (scriptValue16 != ScriptValue.NULL) {
                ScriptValue scriptValue17 = scriptValue12;
                PolyClassPlayer_v2 polyClassPlayer_v2 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue16);
                v6 = polyClassPlayer_v2 != null ? ScriptValue.of((boolean)polyClassPlayer_v2.tm$24_teleport_to(scriptValue17)) : PolyDispatch.bootstrapCall("memberCall", "teleport_to", (ScriptValue)scriptValue16, (ScriptValue)scriptValue17, (ScriptContext)scriptContext);
            } else {
                v6 = ScriptValue.NULL;
            }
            if (scriptValue16 != ScriptValue.NULL) {
                ScriptValue scriptValue18 = ScriptValue.of((String)("<green>Teleported to " + (scriptValue9 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "get", (ScriptValue)scriptValue9, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", SpecializedTeleporter.class, 0.0)), (ScriptContext)scriptContext) : ScriptValue.NULL).asStr() + "."));
                PolyClassPlayer_v2 polyClassPlayer_v2 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue16);
                v7 = polyClassPlayer_v2 != null ? ScriptValue.of((boolean)polyClassPlayer_v2.tm$42_send_message(scriptValue18.asStr())) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue16, (ScriptValue)scriptValue18, (ScriptContext)scriptContext);
            } else {
                v7 = ScriptValue.NULL;
            }
        }
    ...
    public static ScriptValue nextPage(ScriptContext.Builder builder) {
        block4: {
            ...
            if (scriptValue3 != ScriptValue.NULL) {
                String string = "page_offset";
                String string3 = "int";
                ScriptValue scriptValue5 = ScriptFormula.addPolymorphic((ScriptValue)scriptValue4, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", SpecializedTeleporter.class, 1.0)));
                PolyClassMachine_v3 polyClassMachine_v3 = PolyClassMachine_v3.ofGuarded((ScriptValue)scriptValue3);
                v1 = polyClassMachine_v3 != null ? ScriptValue.of((boolean)polyClassMachine_v3.tm$82_set_typed(string, string3, scriptValue5)) : PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue3, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string3), (ScriptValue)scriptValue5, (ScriptContext)scriptContext);
            } else {
                v1 = ScriptValue.NULL;
            }
        }
    ...
    public static ScriptValue onRedstoneActuator(ScriptContext.Builder builder) {
        ...
        if (list != null) {
            for (ScriptValue scriptValue7 : list) {
                ...
                PolyClassMachine_v3 polyClassMachine_v3 = PolyClassMachine_v3.ofVar((ScriptContext)scriptContext, (String)"Machine");
                double d = polyClassMachine_v3 != null ? polyClassMachine_v3.tg$126_energy_stored() : ((scriptValue8 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "energy_stored", (ScriptValue)scriptValue8, (ScriptContext)scriptContext).asNum() : ScriptValue.NULL.asNum());
                if (d < scriptContext.getNum("TELEPORT_COST")) {
                    ...
                    if (scriptValue10 != ScriptValue.NULL) {
                        ...
                        v1 = polyClassPlayer_v2 != null ? ScriptValue.of((boolean)polyClassPlayer_v2.tm$42_send_message(scriptValue11.asStr())) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue10, (ScriptValue)scriptValue11, (ScriptContext)scriptContext);
                    } else {
                        v1 = ScriptValue.NULL;
                    }
                    return ScriptValue.NULL;
                ...
                if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue6, (ScriptContext)scriptContext).asBool()) {
                    ...
                    if (scriptValue13 != ScriptValue.NULL) {
                        String string = "<red>That destination's world is not currently loaded.";
                        PolyClassPlayer_v2 polyClassPlayer_v2 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue13);
                        v2 = polyClassPlayer_v2 != null ? ScriptValue.of((boolean)polyClassPlayer_v2.tm$42_send_message(string)) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue13, (ScriptValue)ScriptValue.of((String)string), (ScriptContext)scriptContext);
                    } else {
                        v2 = ScriptValue.NULL;
                    }
                    return ScriptValue.NULL;
                ...
                if (scriptValue15 != ScriptValue.NULL) {
                    ...
                    PolyClassMachine_v3 polyClassMachine_v32 = PolyClassMachine_v3.ofGuarded((ScriptValue)scriptValue15);
                    object = polyClassMachine_v32 != null ? ScriptValue.of((boolean)polyClassMachine_v32.tm$11_consume_energy(scriptValue16.asNum())) : PolyDispatch.bootstrapCall("memberCall", "consume_energy", (ScriptValue)scriptValue15, (ScriptValue)scriptValue16, (ScriptContext)scriptContext);
                } else {
                    object = ScriptValue.NULL;
                }
                if (object.asBool()) {
                    ...
                    if (scriptValue17 != ScriptValue.NULL) {
                        ...
                        v4 = polyClassPlayer_v2 != null ? ScriptValue.of((boolean)polyClassPlayer_v2.tm$24_teleport_to(scriptValue18)) : PolyDispatch.bootstrapCall("memberCall", "teleport_to", (ScriptValue)scriptValue17, (ScriptValue)scriptValue18, (ScriptContext)scriptContext);
                    } else {
                        v4 = ScriptValue.NULL;
                    }
                    if (scriptValue17 != ScriptValue.NULL) {
                        ScriptValue scriptValue19 = ScriptValue.of((String)("<green>Teleported to <white>" + scriptValue2.asStr() + "<green>."));
                        PolyClassPlayer_v2 polyClassPlayer_v2 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue17);
                        v5 = polyClassPlayer_v2 != null ? ScriptValue.of((boolean)polyClassPlayer_v2.tm$42_send_message(scriptValue19.asStr())) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue17, (ScriptValue)scriptValue19, (ScriptContext)scriptContext);
                    } else {
                        v5 = ScriptValue.NULL;
                    }
                }
        ...
        if ((scriptValue = scriptContext.getClassOrVar("Player")) != ScriptValue.NULL) {
            ScriptValue scriptValue20 = ScriptValue.of((String)("<red>No other teleporter labeled '" + scriptValue2.asStr() + "' found on this frequency."));
            PolyClassPlayer_v2 polyClassPlayer_v2 = PolyClassPlayer_v2.ofGuarded((ScriptValue)scriptValue);
            v6 = polyClassPlayer_v2 != null ? ScriptValue.of((boolean)polyClassPlayer_v2.tm$42_send_message(scriptValue20.asStr())) : PolyDispatch.bootstrapCall("memberCall", "send_message", (ScriptValue)scriptValue, (ScriptValue)scriptValue20, (ScriptContext)scriptContext);
        } else {
            v6 = ScriptValue.NULL;
        }
        return ScriptValue.NULL;
    ...
    public static ScriptValue onRightClick(ScriptContext.Builder builder) {
        ...
        if (scriptValue != ScriptValue.NULL) {
            ...
            PolyClassMachine_v3 polyClassMachine_v3 = PolyClassMachine_v3.ofGuarded((ScriptValue)scriptValue);
            v0 = polyClassMachine_v3 != null ? ScriptValue.of((boolean)polyClassMachine_v3.tm$24_open_menu(scriptValue2)) : PolyDispatch.bootstrapCall("memberCall", "open_menu", (ScriptValue)scriptValue, (ScriptValue)scriptValue2, (ScriptContext)scriptContext);
        } else {
            v0 = ScriptValue.NULL;
        }
        return ScriptValue.NULL;
