...
public final class VirtualuiCursorGallery {
    public static ScriptValue openCursorGallery(ScriptContext.Builder builder) {
        ...
        if (scriptValue3 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"Cursor gallery"));
        ...
        if (scriptValue6 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"examples/virtualui_cursor_gallery.pf:on_close"));
        ...
        if (scriptValue7 != ScriptValue.NULL) {
            ...
            arrayList.add(ScriptValue.of((String)"<gold><bold>CURSOR GALLERY</bold>\n<gray>Hover each button to preview its cursor state"));
        ...
        if (scriptValue8 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_grab"));
            arrayList.add(ScriptValue.of((String)"<white>grab</white>"));
            arrayList.add(ScriptValue.of((double)(-2.6)));
            arrayList.add(ScriptValue.of((double)1.0));
            arrayList.add(ScriptValue.of((String)""));
            arrayList.add(ScriptValue.of((double)1.1));
        ...
        if (scriptValue9 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"grab"));
        ...
        if (scriptValue10 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_not_allowed"));
            arrayList.add(ScriptValue.of((String)"<white>not_allowed</white>"));
        ...
        if (scriptValue11 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"not_allowed"));
        ...
        if (scriptValue12 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_help"));
            arrayList.add(ScriptValue.of((String)"<white>help</white>"));
        ...
        if (scriptValue13 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"help"));
        ...
        if (scriptValue14 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_alert"));
            arrayList.add(ScriptValue.of((String)"<white>alert</white>"));
            arrayList.add(ScriptValue.of((double)1.7));
            arrayList.add(ScriptValue.of((double)1.0));
            arrayList.add(ScriptValue.of((String)""));
            arrayList.add(ScriptValue.of((double)1.1));
            arrayList.add(ScriptValue.of((double)0.5));
        ...
        if (scriptValue15 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"alert"));
        ...
        if (scriptValue16 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_text"));
            arrayList.add(ScriptValue.of((String)"<white>text</white>"));
        ...
        if (scriptValue17 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"text"));
        ...
        if (scriptValue18 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_crosshair"));
            arrayList.add(ScriptValue.of((String)"<white>crosshair</white>"));
            arrayList.add(ScriptValue.of((double)(-2.6)));
            arrayList.add(ScriptValue.of((double)0.2));
            arrayList.add(ScriptValue.of((String)""));
            arrayList.add(ScriptValue.of((double)1.5));
            arrayList.add(ScriptValue.of((double)0.5));
        ...
        if (scriptValue19 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"crosshair"));
        ...
        if (scriptValue20 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_zoom_in"));
            arrayList.add(ScriptValue.of((String)"<white>zoom_in</white>"));
        ...
        if (scriptValue21 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"zoom_in"));
        ...
        if (scriptValue22 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_zoom_out"));
            arrayList.add(ScriptValue.of((String)"<white>zoom_out</white>"));
        ...
        if (scriptValue23 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"zoom_out"));
        ...
        if (scriptValue24 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_move"));
            arrayList.add(ScriptValue.of((String)"<white>move</white>"));
            arrayList.add(ScriptValue.of((double)2.4));
            arrayList.add(ScriptValue.of((double)0.2));
            arrayList.add(ScriptValue.of((String)""));
            arrayList.add(ScriptValue.of((double)1.0));
        ...
        if (scriptValue25 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"move"));
        ...
        if (scriptValue26 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"btn_processing"));
            arrayList.add(ScriptValue.of((String)"<white>processing</white>"));
            arrayList.add(ScriptValue.of((double)(-1.0)));
        ...
        if (scriptValue27 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"processing"));
        ...
        if (scriptValue28 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"demo_scrollbar"));
        ...
        if (scriptValue29 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"examples/virtualui_cursor_gallery.pf:on_scrollbar_armed"));
        ...
        if (scriptValue30 != ScriptValue.NULL) {
            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
            arrayList.add(ScriptValue.of((String)"examples/virtualui_cursor_gallery.pf:on_scrollbar_released"));
        ...
        if (scriptValue31 != ScriptValue.NULL) {
            ...
            arrayList.add(ScriptValue.of((String)"<gray>Hover a button to preview its cursor - no click needed"));
            arrayList.add(ScriptValue.of((double)0.0));
            arrayList.add(ScriptValue.of((double)(-2.6)));
