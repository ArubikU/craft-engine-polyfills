    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        if (list2 != null) {
            for (ScriptValue scriptValue10 : list2) {
                ...
                Object object5 = scriptValue10 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "remove", (ScriptValue)scriptValue10, (ScriptContext)scriptContext) : ScriptValue.NULL;
            }
        }
