...
public final class ItemPipePanel {
    ...
    public static ScriptValue filterItem(ScriptContext.Builder builder) {
        block13: {
            ...
            Object object5 = scriptValue15 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "cancel", (ScriptValue)scriptValue15, (ScriptContext)scriptContext) : ScriptValue.NULL;
        }
        return ScriptValue.NULL;
    }
