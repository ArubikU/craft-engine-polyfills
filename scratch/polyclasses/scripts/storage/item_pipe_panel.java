...
public final class ItemPipePanel {
    ...
    public static ScriptValue filterItem(ScriptContext.Builder builder) {
        block15: {
            ...
            List list = ScriptProgram.resolveForRows((String)"range(0, 9)", (ScriptContext)scriptContext, (int)1);
            if (list != null) {
                for (ScriptValue[] scriptValueArray : list) {
                    ...
                    if (scriptValue4 != ScriptValue.NULL) {
                        ...
                        if (scriptValue4 instanceof ScriptValue.Obj && (object3 = (obj = (ScriptValue.Obj)scriptValue4).instance()) != null && !(object3 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                            PolyClassMachine_v2 polyClassMachine_v2 = new PolyClassMachine_v2(object3);
                            object2 = polyClassMachine_v2.tm$34_get_typed(scriptValue5.asStr(), string);
                        } else {
                            ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                            arrayList.add(scriptValue5);
                            arrayList.add(ScriptValue.of((String)string));
            ...
            if (scriptValue9 != ScriptValue.NULL) {
                ...
                if (scriptValue9 instanceof ScriptValue.Obj && (object4 = (obj = (ScriptValue.Obj)scriptValue9).instance()) != null && !(object4 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v2 polyClassMachine_v2 = new PolyClassMachine_v2(object4);
                    object = polyClassMachine_v2.tm$34_get_typed(scriptValue10.asStr(), string);
                } else {
                    ArrayList<ScriptValue> arrayList = new ArrayList<ScriptValue>();
                    arrayList.add(scriptValue10);
                    arrayList.add(ScriptValue.of((String)string));
            ...
            if (scriptValue14 != ScriptValue.NULL) {
                ...
                v2 = PolyDispatch.bootstrapCall("memberCall", "cancel", (ScriptValue)scriptValue14, arrayList, (ScriptContext)scriptContext);
            } else {
                v2 = ScriptValue.NULL;
            }
        }
