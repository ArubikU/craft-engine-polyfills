...
public final class ItemPipePanel {
    ...
    public static ScriptValue toggleFilterWhitelist(ScriptContext.Builder builder) {
        ...
        ScriptValue scriptValue3 = ScriptFormula.addPolymorphic((ScriptValue)ScriptValue.of((String)"pipe_whitelist_"), (ScriptValue)scriptValue2);
    ...
    public static ScriptValue cycleFilterMatchmode(ScriptContext.Builder builder) {
        ...
        if ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL) {
            ScriptValue.Obj obj;
            Object object3;
            ScriptValue scriptValue9 = ScriptFormula.addPolymorphic((ScriptValue)ScriptValue.of((String)"pipe_filter_matchmode_"), (ScriptValue)scriptValue3);
            String string = "string";
    ...
    public static ScriptValue filterMatchmodeLabel(ScriptContext.Builder builder) {
        ...
        block5: {
            ...
            if (!ScriptFormula.valuesEqualStr((ScriptValue)scriptValue3, (String)"equals")) break block5;
            ScriptValue scriptValue6 = ScriptValue.of((String)"Equals");
            builder.val("text", scriptValue6);
        }
        return ScriptFormula.addPolymorphic((ScriptValue)ScriptValue.of((String)"<gray>Filter Mode: <yellow>"), (ScriptValue)scriptContext.getClassOrVar("text"));
    }
        ...
        block15: {
            ...
            if (list != null) {
                for (ScriptValue[] scriptValueArray : list) {
                    Object object2;
                    builder.val("slot", scriptValueArray.length > 0 ? scriptValueArray[0] : ScriptValue.NULL);
                    ScriptValue scriptValue4 = scriptContext.getClassOrVar("Machine");
                    if (scriptValue4 != ScriptValue.NULL) {
                        ScriptValue.Obj obj;
                        Object object3;
                        ...
                        if (scriptValue4 instanceof ScriptValue.Obj && (object3 = (obj = (ScriptValue.Obj)scriptValue4).instance()) != null && !(object3 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                            PolyClassMachine_v4 polyClassMachine_v4 = new PolyClassMachine_v4(object3);
                            object2 = polyClassMachine_v4.tm$34_get_typed(scriptValue5.asStr(), string);
                        } else {
                            ArrayList<ScriptValue> arrayList2 = new ArrayList<ScriptValue>();
                    ...
                    ScriptValue scriptValue6 = object2;
                    builder.val("filter_item_at_slot", scriptValue6);
                    ...
                    boolean bl3 = true;
                    ScriptValue scriptValue7 = ScriptValue.of((boolean)true);
                    builder.val("any_filter", scriptValue7);
                    ScriptContext.Builder builder3 = ScriptContext.builder().copyFrom(scriptContext);
                    builder3.val("candidate", scriptContext.getClassOrVar("payload"));
                    builder3.val("saved", scriptValue6);
                    ...
                    builder.val("listed", scriptValue8);
                }
            }
            ...
            if (scriptValue9 != ScriptValue.NULL) {
                ...
                if (scriptValue9 instanceof ScriptValue.Obj && (object4 = (obj = (ScriptValue.Obj)scriptValue9).instance()) != null && !(object4 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine_v4 polyClassMachine_v4 = new PolyClassMachine_v4(object4);
                    object = polyClassMachine_v4.tm$34_get_typed(scriptValue10.asStr(), string);
                } else {
                    ArrayList<ScriptValue> arrayList4 = new ArrayList<ScriptValue>();
                    arrayList4.add(scriptValue10);
                    arrayList4.add(ScriptValue.of((String)string));
                    object = PolyDispatch.bootstrapCall("memberCall", "get_typed", (ScriptValue)scriptValue9, arrayList4, (ScriptContext)scriptContext);
                }
            } else {
                object = ScriptValue.NULL;
            }
            ScriptValue scriptValue11 = object;
            builder.val("whitelist", scriptValue11);
            ScriptValue scriptValue12 = scriptContext.getClassOrVar("listed");
            builder.val("passes", scriptValue12);
            if (ScriptFormula.valuesEqual((ScriptValue)scriptValue11, (ScriptValue)ScriptValue.of((double)0.0))) {
                boolean bl5 = scriptContext.getBool("listed") ^ true;
                ScriptValue scriptValue13 = ScriptValue.of((boolean)bl5);
            ...
            if (scriptValue14 != ScriptValue.NULL) {
                ...
                v2 = PolyDispatch.bootstrapCall("memberCall", "cancel", (ScriptValue)scriptValue14, arrayList5, (ScriptContext)scriptContext);
            } else {
                v2 = ScriptValue.NULL;
            }
        }
