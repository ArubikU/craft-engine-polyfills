...
public final class Depot {
    ...
    public static void run(ScriptContext.Builder var0) {
        ...
        var7_6 = var5_4 != ScriptValue.NULL ? ((var6_5 = PolyClassPlayer_v2.ofGuarded((ScriptValue)var5_4)) != null ? var6_5.pg$48_main_hand() : PolyDispatch.bootstrapGet("memberGet", "main_hand", (ScriptValue)var5_4, (ScriptContext)var1_1)) : ScriptValue.NULL;
        var0.val("held", var7_6);
        var8_7 = var1_1.getClassOrVar("Player");
        if (var8_7 != ScriptValue.NULL ? ((var9_8 = PolyClassPlayer_v2.ofGuarded((ScriptValue)var8_7)) != null ? var9_8.tg$49_is_sneaking() : PolyDispatch.bootstrapGet("memberGet", "is_sneaking", (ScriptValue)var8_7, (ScriptContext)var1_1).asBool()) : ScriptValue.NULL.asBool()) ** GOTO lbl-1000
        ...
        if (v0) {
            ...
            if (var11_11 != null) {
                for (ScriptValue var13_13 : var11_11) {
                    ...
                    var18_16 = var19_17 != ScriptValue.NULL ? ((var20_18 = PolyClassMachine_v2.ofGuarded((ScriptValue)var19_17)) != null ? var20_18.pg$120_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)var19_17, (ScriptContext)var1_1)) : ScriptValue.NULL;
                    var21_19 = var15_14;
                    ...
                    if (var28_25 != ScriptValue.NULL) {
                        ...
                        if (var28_25 instanceof ScriptValue.Obj && (var31_28 = (var30_27 = (ScriptValue.Obj)var28_25).instance()) != null && !(var31_28 instanceof PolyClass) && var30_27.typeName().equals("Player")) {
                            var32_29 = new PolyClassPlayer_v2(var31_28);
                    ...
                    var34_30 = var1_1.getClassOrVar("Machine");
                    var33_32 = var34_30 != ScriptValue.NULL ? ((var35_31 = PolyClassMachine_v2.ofGuarded((ScriptValue)var34_30)) != null ? var35_31.pg$120_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)var34_30, (ScriptContext)var1_1)) : ScriptValue.NULL;
                    var36_33 = var15_14;
            ...
            var46_41 = var1_1.getClassOrVar("Machine");
            var45_43 = var46_41 != ScriptValue.NULL ? ((var47_42 = PolyClassMachine_v2.ofGuarded((ScriptValue)var46_41)) != null ? var47_42.pg$120_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)var46_41, (ScriptContext)var1_1)) : ScriptValue.NULL;
            var48_44 = var7_6;
            ...
            if (var55_51 > 0.0) {
                ...
                if (var58_53 != ScriptValue.NULL) {
                    ...
                    if (var58_53 instanceof ScriptValue.Obj && (var63_57 = (var62_56 = (ScriptValue.Obj)var58_53).instance()) != null && !(var63_57 instanceof PolyClass) && var62_56.typeName().equals("Player")) {
                        var64_58 = new PolyClassPlayer_v2(var63_57);
