...
public final class ChuteUtils {
    ...
    public static ScriptValue _chuteOutChute(ScriptContext.Builder builder) {
        ...
        if (scriptValue2 != ScriptValue.NULL) {
            ...
            if (scriptValue2 instanceof ScriptValue.Obj && (object2 = (obj = (ScriptValue.Obj)scriptValue2).instance()) != null && !(object2 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                PolyClassMachine polyClassMachine = new PolyClassMachine(object2);
                object = polyClassMachine.tm$68_block_at(scriptValue3.asNum(), scriptValue4.asNum(), scriptValue5.asNum());
            } else {
                object = PolyDispatch.bootstrapCall("memberCall", "block_at", (ScriptValue)scriptValue2, (ScriptValue)scriptValue3, (ScriptValue)scriptValue4, (ScriptValue)scriptValue5, (ScriptContext)scriptContext);
            }
        } else {
            object = ScriptValue.NULL;
        }
    ...
    public static ScriptValue _chuteGiveOut(ScriptContext.Builder builder) {
        ...
        if (scriptValue2 != ScriptValue.NULL) {
            ...
            if (scriptValue2 instanceof ScriptValue.Obj && (object2 = (obj = (ScriptValue.Obj)scriptValue2).instance()) != null && !(object2 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                PolyClassMachine polyClassMachine = new PolyClassMachine(object2);
                object = polyClassMachine.tm$17_container_at(scriptValue3.asNum(), scriptValue4.asNum(), scriptValue5.asNum());
            } else {
    ...
    public static ScriptValue _chutePull(ScriptContext.Builder var0) {
        block20: {
            ...
            if ((var22_18 = var1_1.getClassOrVar("Machine")) != ScriptValue.NULL) {
                var23_19 = 0.6;
                if (var22_18 instanceof ScriptValue.Obj && (var26_21 = (var25_20 = (ScriptValue.Obj)var22_18).instance()) != null && !(var26_21 instanceof PolyClass) && var25_20.typeName().equals("Machine")) {
                    var27_22 = new PolyClassMachine(var26_21);
                    v2 /* !! */  = var27_22.tm$94_nearby_entities(var23_19);
                } else {
                    v2 /* !! */  = PolyDispatch.bootstrapCall("memberCall", "nearby_entities", (ScriptValue)var22_18, (ScriptValue)ScriptValue.of((double)var23_19), (ScriptContext)var1_1);
                }
            } else {
                v2 /* !! */  = ScriptValue.NULL;
            }
            var19_23 = ScriptProgram.elementsOf((ScriptValue)v2 /* !! */ );
            var28_24 = var1_1.getClassOrVar("item");
            var29_25 = var1_1.getClassOrVar("full");
            if (var19_23 == null) break block20;
            for (ScriptValue var21_27 : var19_23) {
                var0.val("entity", var21_27);
                var30_28 = ScriptContext.builder().copyFrom(Utils.fileScope()).copyFrom(var1_1);
                var30_28.val("entity", var21_27);
                if (!Utils.isRestingItem(var30_28).asBool()) ** GOTO lbl-1000
                v3 = PolyDispatch.bootstrapGet("memberGet", "y", (ScriptValue)(var21_27 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "pos", (ScriptValue)var21_27, (ScriptContext)var1_1) : ScriptValue.NULL), (ScriptContext)var1_1).asNum();
                var31_29 = PolyClassMachine.ofVar((ScriptContext)var1_1, (String)"Machine");
                ...
                if (!v5) continue;
                var33_31 = var21_27 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "item", (ScriptValue)var21_27, (ScriptContext)var1_1) : ScriptValue.NULL;
                var0.val("item", var33_31);
                var28_24 = var33_31;
                if (!(ScriptFormula.valuesEqual((ScriptValue)var3_3, (ScriptValue)var1_1.getClassOrVar("null")) != false || (var28_24 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "matches", (ScriptValue)var28_24, (ScriptValue)var3_3, (ScriptContext)var1_1) : ScriptValue.NULL).asBool() != false)) continue;
                var34_32 = ScriptFormula.callBuiltin1((String)"item_count", (ScriptValue)var28_24, (ScriptContext)var1_1);
                var0.val("full", var34_32);
                var29_25 = var34_32;
                if (var1_1.getBool("exact") != false && var29_25.asNum() < var1_1.getNum("cap") != false) continue;
                if ((var1_1.getBool("smart") ^ true) != false && var29_25.asNum() > var1_1.getNum("PLAIN_TRANSFER_CAP") != false) {
                    v6 /* !! */  = var21_27 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "set_item", (ScriptValue)var21_27, (ScriptValue)ScriptFormula.callBuiltin2((String)"MinecraftItem", (ScriptValue)(var28_24 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "id", (ScriptValue)var28_24, (ScriptContext)var1_1) : ScriptValue.NULL), (ScriptValue)ScriptValue.of((double)(var29_25.asNum() - var1_1.getNum("PLAIN_TRANSFER_CAP"))), (ScriptContext)var1_1), (ScriptContext)var1_1) : ScriptValue.NULL;
                    return var28_24 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "with_count", (ScriptValue)var28_24, (ScriptValue)var1_1.getClassOrVar("PLAIN_TRANSFER_CAP"), (ScriptContext)var1_1) : ScriptValue.NULL;
                }
                if (var1_1.getBool("exact") != false && var29_25.asNum() > var1_1.getNum("cap") != false) {
                    v7 /* !! */  = var21_27 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "set_item", (ScriptValue)var21_27, (ScriptValue)ScriptFormula.callBuiltin2((String)"MinecraftItem", (ScriptValue)(var28_24 != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "id", (ScriptValue)var28_24, (ScriptContext)var1_1) : ScriptValue.NULL), (ScriptValue)ScriptValue.of((double)(var29_25.asNum() - var1_1.getNum("cap"))), (ScriptContext)var1_1), (ScriptContext)var1_1) : ScriptValue.NULL;
                    return var28_24 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "with_count", (ScriptValue)var28_24, (ScriptValue)var1_1.getClassOrVar("cap"), (ScriptContext)var1_1) : ScriptValue.NULL;
                }
                v8 /* !! */  = var21_27 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "remove", (ScriptValue)var21_27, (ScriptContext)var1_1) : ScriptValue.NULL;
                return var28_24;
            }
        }
        if ((var35_33 = var1_1.getClassOrVar("Item")) != ScriptValue.NULL) {
            var36_34 = new ArrayList<ScriptValue>();
            var36_34.add( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", ChuteUtils.class, "minecraft:air"));
            v9 /* !! */  = var35_33 instanceof ScriptValue.Obj && (var38_36 = (var37_35 = (ScriptValue.Obj)var35_33).instance()) != null && !(var38_36 instanceof PolyClass) && var37_35.typeName().equals("Item") ? new PolyClassItem(var38_36).um$21_create(var36_34) : PolyDispatch.bootstrapCall("memberCall", "create", (ScriptValue)var35_33, var36_34, (ScriptContext)var1_1);
        } else {
            v9 /* !! */  = ScriptValue.NULL;
        }
        return v9 /* !! */ ;
    ...
    public static ScriptValue _chuteSyncPowered(ScriptContext.Builder builder) {
        block7: {
            ...
            ScriptValue scriptValue4 = polyClassMachine2 != null ? polyClassMachine2.pg$171_redstone() : ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "redstone", (ScriptValue)scriptValue, (ScriptContext)scriptContext) : ScriptValue.NULL);
            ...
            if (scriptValue6 != ScriptValue.NULL) {
                ...
                if (scriptValue6 instanceof ScriptValue.Obj && (object2 = (obj2 = (ScriptValue.Obj)scriptValue6).instance()) != null && !(object2 instanceof PolyClass) && obj2.typeName().equals("Machine")) {
                    ...
                    v1 = ScriptValue.of((boolean)polyClassMachine3.tm$16_set_property(string2, scriptValue7.asStr()));
                } else {
    ...
    public static ScriptValue _chuteTick(ScriptContext.Builder builder) {
            ...
            if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue6, (ScriptContext)scriptContext).asBool() ^ true) {
                ...
                if (scriptValue7 != ScriptValue.NULL) {
                    ...
                    if (scriptValue7 instanceof ScriptValue.Obj && (object4 = (obj = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object4 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                        ...
                        v1 = ScriptValue.of((boolean)polyClassMachine3.tm$82_set_typed(string, string3, scriptValue8));
                    } else {
                ...
                if (scriptValue9 != ScriptValue.NULL) {
                    ...
                    if (scriptValue9 instanceof ScriptValue.Obj && (object5 = (obj = (ScriptValue.Obj)scriptValue9).instance()) != null && !(object5 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                        ...
                        v2 = ScriptValue.of((boolean)polyClassMachine4.tm$82_set_typed(string, string4, scriptValue10));
                    } else {
        ...
        if (scriptValue14.asNum() < scriptContext.getNum("CHUTE_STEP")) {
            ...
            if (scriptValue15 != ScriptValue.NULL) {
                ...
                if (scriptValue15 instanceof ScriptValue.Obj && (object7 = (obj = (ScriptValue.Obj)scriptValue15).instance()) != null && !(object7 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    ...
                    v4 = ScriptValue.of((boolean)polyClassMachine6.tm$82_set_typed(string, string6, scriptValue16));
                } else {
            ...
            if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue20, (ScriptContext)scriptContext).asBool()) {
                ...
                if (scriptValue19.asBool() ^ true && scriptValue21.asNum() > scriptContext.getNum("PLAIN_TRANSFER_CAP")) {
                    ...
                    if (scriptValue22 != ScriptValue.NULL) {
                        ...
                        String string = "_chute_item";
                        String string7 = "item";
                        Object object10 = scriptValue23 = scriptValue5 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "with_count", (ScriptValue)scriptValue5, (ScriptValue)ScriptValue.of((double)(scriptValue21.asNum() - scriptContext.getNum("PLAIN_TRANSFER_CAP"))), (ScriptContext)scriptContext) : ScriptValue.NULL;
                        if (scriptValue22 instanceof ScriptValue.Obj && (object9 = (obj = (ScriptValue.Obj)scriptValue22).instance()) != null && !(object9 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                            PolyClassMachine polyClassMachine7 = new PolyClassMachine(object9);
                            v7 = ScriptValue.of((boolean)polyClassMachine7.tm$82_set_typed(string, string7, scriptValue23));
                        } else {
                            v7 = PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue22, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string7), (ScriptValue)scriptValue23, (ScriptContext)scriptContext);
                        }
                    } else {
                        v7 = ScriptValue.NULL;
                    }
                } else {
                    Object object11 = scriptValue18 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue18, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", ChuteUtils.class, "_chute_item")), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", ChuteUtils.class, "item")), (ScriptValue)scriptValue5, (ScriptContext)scriptContext) : ScriptValue.NULL;
                    ...
                    if (scriptValue24 != ScriptValue.NULL) {
                        ...
                        if (scriptValue24 instanceof ScriptValue.Obj && (object12 = (obj = (ScriptValue.Obj)scriptValue24).instance()) != null && !(object12 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                            PolyClassMachine polyClassMachine8 = new PolyClassMachine(object12);
                            v9 = ScriptValue.of((boolean)polyClassMachine8.tm$82_set_typed(string, string8, scriptValue25));
                        } else {
                            v9 = PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue24, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string8), (ScriptValue)scriptValue25, (ScriptContext)scriptContext);
                        }
                    } else {
                        v9 = ScriptValue.NULL;
                    }
                }
                Object object13 = scriptValue18 != ScriptValue.NULL ? PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue18, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", ChuteUtils.class, "_chute_progress")), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constStr("s", MethodHandles.lookup(), "constStr", ChuteUtils.class, "int")), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", ChuteUtils.class, 0.0)), (ScriptContext)scriptContext) : ScriptValue.NULL;
                ...
                if (scriptValue26 != ScriptValue.NULL) {
                    ...
                    if (scriptValue26 instanceof ScriptValue.Obj && (object14 = (obj = (ScriptValue.Obj)scriptValue26).instance()) != null && !(object14 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                        PolyClassMachine polyClassMachine9 = new PolyClassMachine(object14);
                        v11 = ScriptValue.of((boolean)polyClassMachine9.tm$82_set_typed(string, string9, scriptValue27));
                    } else {
                        v11 = PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue26, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string9), (ScriptValue)scriptValue27, (ScriptContext)scriptContext);
                    }
                } else {
        ...
        if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue28, (ScriptContext)scriptContext).asBool() ^ true) {
            ...
            if (scriptValue30 != ScriptValue.NULL) {
                ...
                if (scriptValue30 instanceof ScriptValue.Obj && (object15 = (obj = (ScriptValue.Obj)scriptValue30).instance()) != null && !(object15 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                    PolyClassMachine polyClassMachine10 = new PolyClassMachine(object15);
                    v12 = ScriptValue.of((boolean)polyClassMachine10.tm$50_drop_item_at(scriptValue31, scriptValue32.asNum(), scriptValue33.asNum(), scriptValue34.asNum()));
                } else {
                    v12 = PolyDispatch.bootstrapCall("memberCall", "drop_item_at", (ScriptValue)scriptValue30, (ScriptValue)scriptValue31, (ScriptValue)scriptValue32, (ScriptValue)scriptValue33, (ScriptValue)scriptValue34, (ScriptContext)scriptContext);
                }
            } else {
        ...
        if ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL) {
            ...
            if (scriptValue instanceof ScriptValue.Obj && (object16 = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object16 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                PolyClassMachine polyClassMachine11 = new PolyClassMachine(object16);
                v13 = ScriptValue.of((boolean)polyClassMachine11.tm$82_set_typed(string, string10, scriptValue35));
            } else {
                v13 = PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string10), (ScriptValue)scriptValue35, (ScriptContext)scriptContext);
            }
        } else {
        ...
        if (scriptValue36 != ScriptValue.NULL) {
            ...
            if (scriptValue36 instanceof ScriptValue.Obj && (object17 = (obj = (ScriptValue.Obj)scriptValue36).instance()) != null && !(object17 instanceof PolyClass) && obj.typeName().equals("Machine")) {
                PolyClassMachine polyClassMachine12 = new PolyClassMachine(object17);
                v14 = ScriptValue.of((boolean)polyClassMachine12.tm$82_set_typed(string, string11, scriptValue37));
            } else {
                v14 = PolyDispatch.bootstrapCall("memberCall", "set_typed", (ScriptValue)scriptValue36, (ScriptValue)ScriptValue.of((String)string), (ScriptValue)ScriptValue.of((String)string11), (ScriptValue)scriptValue37, (ScriptContext)scriptContext);
            }
        } else {
    ...
    public static ScriptValue _chuteCycleFacing(ScriptContext.Builder builder) {
        ...
        if (list != null) {
            for (ScriptValue scriptValue6 : list) {
                builder.val("f", scriptValue6);
                if (ScriptFormula.valuesEqual((ScriptValue)scriptValue6, (ScriptValue)scriptContext.getClassOrVar("cur"))) break;
                ScriptValue scriptValue7 = ScriptFormula.addPolymorphic((ScriptValue)scriptValue5, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", ChuteUtils.class, 1.0)));
                builder.val("idx", scriptValue7);
                scriptValue5 = scriptValue7;
            }
        }
        ScriptValue scriptValue8 = ScriptFormula.subscriptGet((ScriptValue)scriptContext.getClassOrVar("FACING_CYCLE"), (ScriptValue)ScriptValue.of((double)((d = ScriptFormula.callBuiltin1((String)"size", (ScriptValue)scriptContext.getClassOrVar("FACING_CYCLE"), (ScriptContext)scriptContext).asNum()) == 0.0 ? 0.0 : ScriptFormula.addPolymorphic((ScriptValue)scriptValue5, (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", ChuteUtils.class, 1.0))).asNum() % d)));
        ...
        if (scriptValue9 != ScriptValue.NULL) {
            ...
            if (scriptValue9 instanceof ScriptValue.Obj && (object2 = (obj2 = (ScriptValue.Obj)scriptValue9).instance()) != null && !(object2 instanceof PolyClass) && obj2.typeName().equals("Machine")) {
                ...
                v1 = ScriptValue.of((boolean)polyClassMachine2.tm$16_set_property(string2, scriptValue10.asStr()));
            } else {
                v1 = PolyDispatch.bootstrapCall("memberCall", "set_property", (ScriptValue)scriptValue9, (ScriptValue)ScriptValue.of((String)string2), (ScriptValue)scriptValue10, (ScriptContext)scriptContext);
            }
        } else {
            v1 = ScriptValue.NULL;
        }
    ...
    public static ScriptValue _chuteDropHeld(ScriptContext.Builder builder) {
        block6: {
            ...
            if (!(ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)scriptValue2, (ScriptContext)scriptContext).asBool() ^ true)) break block6;
