...
public final class FloorFunnelUtils {
    ...
    public static ScriptValue _floorFunnelVacuum(ScriptContext.Builder var0) {
        block11: {
            ...
            for (ScriptValue[] var4_10 : var2_8) {
                ...
                v2 /* !! */  = var14_13 != ScriptValue.NULL ? ((var15_14 = PolyClassMachine.ofGuarded((ScriptValue)var14_13)) != null ? var15_14.pg$167_y() : PolyDispatch.bootstrapGet("memberGet", "y", (ScriptValue)var14_13, (ScriptContext)var1_1)) : ScriptValue.NULL;
                if (v1 >= v2 /* !! */ .asNum()) {
                    v3 = true;
                } else lbl-1000:
                // 2 sources
    ...
    public static ScriptValue _floorFunnelTick(ScriptContext.Builder builder) {
        ...
        CallSite callSite = PolyDispatch.bootstrapCall("memberCall", "get_item", (ScriptValue)(scriptValue != ScriptValue.NULL ? ((polyClassMachine3 = PolyClassMachine.ofGuarded((ScriptValue)scriptValue)) != null ? polyClassMachine3.pg$119_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue, (ScriptContext)scriptContext)) : ScriptValue.NULL), arrayList, (ScriptContext)scriptContext);
        ...
        if (scriptContext.getBool("pull_above")) {
            ...
            PolyDispatch.bootstrapCall("memberCall", "set_item", (ScriptValue)(scriptValue10 != ScriptValue.NULL ? ((polyClassMachine6 = PolyClassMachine.ofGuarded((ScriptValue)scriptValue10)) != null ? polyClassMachine6.pg$119_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue10, (ScriptContext)scriptContext)) : ScriptValue.NULL), arrayList11, (ScriptContext)scriptContext);
            return ScriptValue.NULL;
        }
        ...
        if (ScriptFormula.valuesEqual((ScriptValue)scriptValue12, (ScriptValue)scriptContext.getClassOrVar("null")) ^ true) {
            ...
            if (ScriptFormula.callBuiltin((String)"is_empty", arrayList14, (ScriptContext)scriptContext).asBool()) {
                ...
                PolyDispatch.bootstrapCall("memberCall", "set_item", (ScriptValue)(scriptValue15 != ScriptValue.NULL ? ((polyClassMachine9 = PolyClassMachine.ofGuarded((ScriptValue)scriptValue15)) != null ? polyClassMachine9.pg$119_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue15, (ScriptContext)scriptContext)) : ScriptValue.NULL), arrayList15, (ScriptContext)scriptContext);
            } else {
                ...
                if (d < ScriptFormula.callBuiltin((String)"item_count", arrayList17, (ScriptContext)scriptContext).asNum()) {
                    ...
                    PolyDispatch.bootstrapCall("memberCall", "set_item", (ScriptValue)(scriptValue16 != ScriptValue.NULL ? ((polyClassMachine10 = PolyClassMachine.ofGuarded((ScriptValue)scriptValue16)) != null ? polyClassMachine10.pg$119_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue16, (ScriptContext)scriptContext)) : ScriptValue.NULL), arrayList18, (ScriptContext)scriptContext);
                }
            }
            return ScriptValue.NULL;
        }
        ...
        PolyDispatch.bootstrapCall("memberCall", "set_item", (ScriptValue)(scriptValue18 != ScriptValue.NULL ? ((polyClassMachine = PolyClassMachine.ofGuarded((ScriptValue)scriptValue18)) != null ? polyClassMachine.pg$119_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue18, (ScriptContext)scriptContext)) : ScriptValue.NULL), arrayList20, (ScriptContext)scriptContext);
        return ScriptValue.NULL;
    }
    ...
    public static ScriptValue _floorFunnelDropHeld(ScriptContext.Builder builder) {
        block2: {
            ...
            ScriptValue scriptValue3 = scriptContext.getClassOrVar("Machine");
            PolyDispatch.bootstrapCall("memberCall", "set_item", (ScriptValue)(scriptValue3 != ScriptValue.NULL ? ((polyClassMachine = PolyClassMachine.ofGuarded((ScriptValue)scriptValue3)) != null ? polyClassMachine.pg$119_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue3, (ScriptContext)scriptContext)) : ScriptValue.NULL), arrayList4, (ScriptContext)scriptContext);
        }
        return ScriptValue.NULL;
    }
    ...
    public static ScriptValue _floorFunnelOnRightClick(ScriptContext.Builder builder) {
        ...
        arrayList.add((ScriptValue)(scriptValue != ScriptValue.NULL ? ((polyClassPlayer = PolyClassPlayer.ofGuarded((ScriptValue)scriptValue)) != null ? polyClassPlayer.pg$47_main_hand() : PolyDispatch.bootstrapGet("memberGet", "main_hand", (ScriptValue)scriptValue, (ScriptContext)scriptContext)) : ScriptValue.NULL));
