        ...
        if (ScriptFormula.callBuiltin((String)"is_empty", arrayList, (ScriptContext)scriptContext).asBool() ^ true) {
            ...
            if (scriptValue7 != ScriptValue.NULL) {
                ...
                if (scriptValue7 instanceof ScriptValue.Obj && (object5 = (obj3 = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object5 instanceof PolyClass) && obj3.typeName().equals("Machine")) {
                    ...
                    object4 = polyClassMachine_v33.tm$86_blocks_in_range(scriptValue8.asNum());
                } else {
            ...
            if (list != null) {
                for (ScriptValue scriptValue10 : list) {
                    ...
                    ScriptValue scriptValue16 = scriptValue15 != ScriptValue.NULL ? ((polyClassMachine_v34 = PolyClassMachine_v3.ofGuarded((ScriptValue)scriptValue15)) != null ? polyClassMachine_v34.pg$120_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue15, (ScriptContext)scriptContext)) : ScriptValue.NULL;
                    double d2 = 0.0;
                    double d3 = 1.0;
