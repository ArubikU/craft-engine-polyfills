...
public final class Fertilizer {
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        ScriptValue scriptValue6 = polyClassMachine_v4 != null ? polyClassMachine_v4.pg$120_container() : ((scriptValue = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue, (ScriptContext)scriptContext) : ScriptValue.NULL);
        double d = 0.0;
        ...
        if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)callSite, (ScriptContext)scriptContext).asBool() ^ true) {
            ...
            if (scriptValue7 != ScriptValue.NULL) {
                ...
                if (scriptValue7 instanceof ScriptValue.Obj && (object5 = (obj3 = (ScriptValue.Obj)scriptValue7).instance()) != null && !(object5 instanceof PolyClass) && obj3.typeName().equals("Machine")) {
                    ...
                    object4 = polyClassMachine_v42.tm$86_blocks_in_range(scriptValue8.asNum());
                } else {
            ...
            if (list != null) {
                for (ScriptValue scriptValue11 : list) {
                    ...
                    ScriptValue scriptValue17 = polyClassMachine_v43 != null ? polyClassMachine_v43.pg$120_container() : ((scriptValue12 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue12, (ScriptContext)scriptContext) : ScriptValue.NULL);
                    double d2 = 0.0;
                    double d3 = 1.0;
