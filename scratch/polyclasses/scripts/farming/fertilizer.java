        ...
        if (ScriptFormula.callBuiltin1((String)"is_empty", (ScriptValue)callSite, (ScriptContext)scriptContext).asBool() ^ true) {
            ...
            if (list != null) {
                for (ScriptValue scriptValue11 : list) {
                    ...
                    ScriptValue scriptValue17 = polyClassMachine3 != null ? polyClassMachine3.pg$120_container() : ((scriptValue12 = scriptContext.getClassOrVar("Machine")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)scriptValue12, (ScriptContext)scriptContext) : ScriptValue.NULL);
                    double d2 = 0.0;
                    double d3 = 1.0;
