...
public final class PressurizerWell {
    ...
    public static void run(ScriptContext.Builder builder) {
        ...
        ScriptValue scriptValue2 = scriptValue != ScriptValue.NULL ? ((polyClassMultiBlock = PolyClassMultiBlock.ofGuarded((ScriptValue)scriptValue)) != null ? polyClassMultiBlock.pg$15_formed() : PolyDispatch.bootstrapGet("memberGet", "formed", (ScriptValue)scriptValue, (ScriptContext)scriptContext)) : ScriptValue.NULL;
