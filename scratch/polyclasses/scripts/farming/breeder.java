...
public final class Breeder {
    ...
    public static void run(ScriptContext.Builder var0) {
        block14: {
            ...
            var12_11 = ScriptProgram.resolveForRows((String)"animals", (ScriptContext)var1_1, (int)1);
            ...
            for (ScriptValue[] var14_13 : var12_11) {
                ...
                var25_24 = ScriptProgram.resolveForRows((String)"range(9)", (ScriptContext)var1_1, (int)1);
                ...
                for (ScriptValue[] var27_26 : var25_24) {
                    ...
                    var28_27.add(var1_1.getClassOrVar("i"));
                    var29_28 = var1_1.getClassOrVar("Machine");
                    var32_31 = PolyDispatch.bootstrapCall("memberCall", "get_item", (ScriptValue)(var29_28 != ScriptValue.NULL ? (var29_28 instanceof ScriptValue.Obj && (var31_30 = (var30_29 = (ScriptValue.Obj)var29_28).instance()) != null && !(var31_30 instanceof PolyClass) && var30_29.typeName().equals("Machine") ? new PolyClassMachine_v2(var31_30).pg$119_container() : PolyDispatch.bootstrapGet("memberGet", "container", (ScriptValue)var29_28, (ScriptContext)var1_1)) : ScriptValue.NULL), var28_27, (ScriptContext)var1_1);
                    ...
                    if (var35_34 != ScriptValue.NULL) {
                        ...
                        if (var35_34 instanceof ScriptValue.Obj && (var39_38 = (var38_37 = (ScriptValue.Obj)var35_34).instance()) != null && !(var39_38 instanceof PolyClass) && var38_37.typeName().equals("Machine")) {
                            var40_39 = new PolyClassMachine_v2(var39_38);
