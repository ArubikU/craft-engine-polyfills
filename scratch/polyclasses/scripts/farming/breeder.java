    ...
    public static void run(ScriptContext.Builder var0) {
        block16: {
            ...
            for (ScriptValue var14_13 : var12_11) {
                ...
                if (!(v2 != false && ScriptFormula.valuesEqual((ScriptValue)((var18_17 = var1_1.getClassOrVar("animal")) != ScriptValue.NULL ? PolyDispatch.bootstrapGet("memberGet", "in_love_time", (ScriptValue)var18_17, (ScriptContext)var1_1) : ScriptValue.NULL), (ScriptValue)( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", Breeder.class, 0.0))) != false)) continue;
                ...
                var28_27.add( /* dynamic constant */ (ScriptValue)ScriptValue.constNum("n", MethodHandles.lookup(), "constNum", Breeder.class, 9.0));
