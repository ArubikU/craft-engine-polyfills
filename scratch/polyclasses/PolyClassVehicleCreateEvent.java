...
extends PolyClassEvent {
    ...
    public static PolyClassVehicleCreateEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassVehicleCreateEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
