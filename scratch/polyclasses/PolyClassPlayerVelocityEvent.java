...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerVelocityEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerVelocityEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
