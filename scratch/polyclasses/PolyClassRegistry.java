...
public class PolyClassRegistry {
    ...
    public static PolyClassRegistry ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Registry")) {
            return new PolyClassRegistry(object);
        }
        return null;
    }
