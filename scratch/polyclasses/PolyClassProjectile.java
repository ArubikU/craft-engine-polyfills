...
extends PolyClassEntity {
    ...
    public static PolyClassProjectile ofVar(ScriptContext scriptContext, String string) {
        return PolyClassProjectile.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
