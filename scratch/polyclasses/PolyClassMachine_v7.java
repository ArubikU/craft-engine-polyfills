...
extends PolyClassBlock_v2 {
    ...
    public static PolyClassMachine_v7 ofVar(ScriptContext scriptContext, String string) {
        return PolyClassMachine_v7.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
