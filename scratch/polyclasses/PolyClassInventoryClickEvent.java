...
extends PolyClassEvent {
    ...
    public static PolyClassInventoryClickEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("InventoryClickEvent")) {
            return new PolyClassInventoryClickEvent(object);
        }
        return null;
    }

    public static PolyClassInventoryClickEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassInventoryClickEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
