...
extends PolyClassEvent {
    ...
    public static PolyClassBlockDispenseEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("BlockDispenseEvent")) {
            return new PolyClassBlockDispenseEvent(object);
        }
        return null;
    }

    public static PolyClassBlockDispenseEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlockDispenseEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
