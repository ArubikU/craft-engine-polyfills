...
extends PolyClassEvent {
    ...
    public static PolyClassChunkLoadEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassChunkLoadEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
