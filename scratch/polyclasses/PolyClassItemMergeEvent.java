...
extends PolyClassEvent {
    ...
    public static PolyClassItemMergeEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassItemMergeEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
