...
extends PolyClassLivingEntity {
    ...
    public PolyClassPlayer_v2(Object object) {
        super(object);
    }
    ...
    public static PolyClassPlayer_v2 ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayer_v2.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
