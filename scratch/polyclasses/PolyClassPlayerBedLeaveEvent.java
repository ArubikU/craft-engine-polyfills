...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerBedLeaveEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerBedLeaveEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
