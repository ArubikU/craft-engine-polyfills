...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerEggThrowEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerEggThrowEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
