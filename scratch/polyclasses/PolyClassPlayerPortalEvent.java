...
extends PolyClassEvent {
    ...
    public static void refresh() {
        ...
        tp$3 = (PolyType.TypedPropertyHandler)PolyClassRuntime.resolveTypedPropertyHandler((String)"PlayerPortalEvent", (String)"cause", (String)"S");
        p$4 = PolyClassRuntime.resolvePropertyHandler((String)"PlayerPortalEvent", (String)"from");
        p$5 = PolyClassRuntime.resolvePropertyHandler((String)"PlayerPortalEvent", (String)"to");
    }
    ...
    public String tg$3_cause() {
        ...
        return PolyClassRuntime.genericProperty((String)"PlayerPortalEvent", (String)"cause", (Object)this.instance).asStr();
    }
    ...
    public static PolyClassPlayerPortalEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerPortalEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
