...
extends PolyClassEvent {
    ...
    public static PolyClassEntityDeathEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityDeathEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
