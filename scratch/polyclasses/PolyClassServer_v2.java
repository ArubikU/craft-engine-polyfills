...
public class PolyClassServer_v2 {
    ...
    public PolyClassServer_v2(Object object) {
        this.instance = object;
    }

    public static PolyClassServer_v2 of(Object object) {
        return new PolyClassServer_v2(object);
    }

    public static PolyClassServer_v2 ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
    ...
    public static PolyClassServer_v2 ofVar(ScriptContext scriptContext, String string) {
        return PolyClassServer_v2.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
