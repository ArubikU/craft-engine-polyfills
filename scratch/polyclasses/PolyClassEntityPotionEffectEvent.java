...
extends PolyClassEvent {
    ...
    public static PolyClassEntityPotionEffectEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityPotionEffectEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
