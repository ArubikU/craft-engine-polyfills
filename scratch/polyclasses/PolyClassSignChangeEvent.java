...
extends PolyClassEvent {
    ...
    public static PolyClassSignChangeEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("SignChangeEvent")) {
            return new PolyClassSignChangeEvent(object);
        }
        return null;
    }

    public static PolyClassSignChangeEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassSignChangeEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
