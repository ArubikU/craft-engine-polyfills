...
extends PolyClassEvent {
    ...
    public static PolyClassPrepareItemCraftEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("PrepareItemCraftEvent")) {
            return new PolyClassPrepareItemCraftEvent(object);
        }
        return null;
    }

    public static PolyClassPrepareItemCraftEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPrepareItemCraftEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
