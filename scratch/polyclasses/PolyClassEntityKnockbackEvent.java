...
extends PolyClassEvent {
    ...
    public static PolyClassEntityKnockbackEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("EntityKnockbackEvent")) {
            return new PolyClassEntityKnockbackEvent(object);
        }
        return null;
    }

    public static PolyClassEntityKnockbackEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityKnockbackEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
