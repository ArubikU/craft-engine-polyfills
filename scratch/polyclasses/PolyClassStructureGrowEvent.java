...
extends PolyClassEvent {
    ...
    public static PolyClassStructureGrowEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("StructureGrowEvent")) {
            return new PolyClassStructureGrowEvent(object);
        }
        return null;
    }

    public static PolyClassStructureGrowEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassStructureGrowEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
