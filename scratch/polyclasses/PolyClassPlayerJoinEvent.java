...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerJoinEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("PlayerJoinEvent")) {
            return new PolyClassPlayerJoinEvent(object);
        }
        return null;
    }

    public static PolyClassPlayerJoinEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerJoinEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
