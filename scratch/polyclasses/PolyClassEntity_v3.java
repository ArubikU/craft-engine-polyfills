...
public class PolyClassEntity_v3 {
    ...
    public static PolyClassEntity_v3 ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
    ...
    public static PolyClassEntity_v3 ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntity_v3.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
