...
public class PolyClassBlock_v2 {
    ...
    public PolyClassBlock_v2(Object object) {
        this.instance = object;
    }

    public static PolyClassBlock_v2 of(Object object) {
        return new PolyClassBlock_v2(object);
    }

    public static PolyClassBlock_v2 ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
    ...
    public static PolyClassBlock_v2 ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlock_v2.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
