...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerStatisticIncrementEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerStatisticIncrementEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
