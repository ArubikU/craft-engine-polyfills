...
extends PolyClassEvent {
    ...
    public static PolyClassEntityDamageEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityDamageEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
