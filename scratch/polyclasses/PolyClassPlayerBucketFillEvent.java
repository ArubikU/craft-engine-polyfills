...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerBucketFillEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("PlayerBucketFillEvent")) {
            return new PolyClassPlayerBucketFillEvent(object);
        }
        return null;
    }

    public static PolyClassPlayerBucketFillEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerBucketFillEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
