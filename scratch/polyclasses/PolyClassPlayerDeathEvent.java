...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerDeathEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerDeathEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
