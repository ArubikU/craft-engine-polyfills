...
extends PolyClassEvent {
    ...
    public static PolyClassVehicleExitEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassVehicleExitEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
