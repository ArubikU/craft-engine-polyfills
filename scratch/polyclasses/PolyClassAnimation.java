...
public class PolyClassAnimation {
    ...
    public static PolyClassAnimation ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Animation")) {
            return new PolyClassAnimation(object);
        }
        return null;
    }

    public static PolyClassAnimation ofVar(ScriptContext scriptContext, String string) {
        return PolyClassAnimation.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
