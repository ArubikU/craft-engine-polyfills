...
public class PolyClassVehicleDamageEvent
extends PolyClassEvent {
    ...
    public boolean tm$0_set_damage(double d) {
        ...
        return PolyClassRuntime.genericCall((String)"VehicleDamageEvent", (String)"set_damage", (Object)this.instance, (ScriptValue[])new ScriptValue[]{ScriptValue.of((double)d)}).asBool();
    }
    ...
    public ScriptValue um$1_set_damage(List list) {
        ...
        return PolyClassRuntime.genericCallList((String)"VehicleDamageEvent", (String)"set_damage", (Object)this.instance, (List)list);
    }
    ...
    public PolyClassVehicleDamageEvent(Object object) {
        super(object);
    }

    public static PolyClassVehicleDamageEvent of(Object object) {
        return new PolyClassVehicleDamageEvent(object);
    }

    public static PolyClassVehicleDamageEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("VehicleDamageEvent")) {
            return new PolyClassVehicleDamageEvent(object);
        }
        return null;
    }

    public static PolyClassVehicleDamageEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassVehicleDamageEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
