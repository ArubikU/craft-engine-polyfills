...
extends PolyClassInventoryClickEvent {
    ...
    public static PolyClassCraftItemEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassCraftItemEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
