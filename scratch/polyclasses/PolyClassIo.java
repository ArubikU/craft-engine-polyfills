...
public class PolyClassIo {
    ...
    public static PolyClassIo ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Io")) {
            return new PolyClassIo(object);
        }
        return null;
    }

    public static PolyClassIo ofVar(ScriptContext scriptContext, String string) {
        return PolyClassIo.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
