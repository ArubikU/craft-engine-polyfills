...
public class PolyClassBlockMetadata {
    ...
    public static PolyClassBlockMetadata ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("BlockMetadata")) {
            return new PolyClassBlockMetadata(object);
        }
        return null;
    }

    public static PolyClassBlockMetadata ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlockMetadata.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
