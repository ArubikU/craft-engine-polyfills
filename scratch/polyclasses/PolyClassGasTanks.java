...
public class PolyClassGasTanks {
    ...
    public static PolyClassGasTanks ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("GasTanks")) {
            return new PolyClassGasTanks(object);
        }
        return null;
    }

    public static PolyClassGasTanks ofVar(ScriptContext scriptContext, String string) {
        return PolyClassGasTanks.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
