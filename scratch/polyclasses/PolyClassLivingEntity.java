...
extends PolyClassEntity {
    ...
    public static void refresh() {
        ...
        p$15 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"main_hand");
        p$16 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"max_health");
        p$17 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"armor");
        p$18 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"off_hand");
        p$19 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"health");
        p$20 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"equipment");
        p$21 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"is_dead");
        p$22 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"last_damage");
        p$23 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"fire_ticks");
        p$24 = PolyClassRuntime.resolvePropertyHandler((String)"LivingEntity", (String)"frozen_ticks");
    }
    ...
    public ScriptValue pg$15_main_hand() {
        if (p$15 != null) {
    ...
    public ScriptValue pg$16_max_health() {
        if (p$16 != null) {
    ...
    public ScriptValue pg$17_armor() {
        if (p$17 != null) {
    ...
    public ScriptValue pg$18_off_hand() {
        if (p$18 != null) {
    ...
    public ScriptValue pg$19_health() {
        if (p$19 != null) {
    ...
    public ScriptValue pg$20_equipment() {
        if (p$20 != null) {
    ...
    public ScriptValue pg$21_is_dead() {
        if (p$21 != null) {
    ...
    public ScriptValue pg$22_last_damage() {
        if (p$22 != null) {
    ...
    public ScriptValue pg$23_fire_ticks() {
        if (p$23 != null) {
    ...
    public ScriptValue pg$24_frozen_ticks() {
        if (p$24 != null) {
