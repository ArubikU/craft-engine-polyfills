...
public class PolyClassEntityExplodeEvent
extends PolyClassEvent {
    ...
    public boolean tm$0_set_yield(double d) {
        ...
        return PolyClassRuntime.genericCall((String)"EntityExplodeEvent", (String)"set_yield", (Object)this.instance, (ScriptValue[])new ScriptValue[]{ScriptValue.of((double)d)}).asBool();
    }
    ...
    public ScriptValue um$1_set_yield(List list) {
        ...
        return PolyClassRuntime.genericCallList((String)"EntityExplodeEvent", (String)"set_yield", (Object)this.instance, (List)list);
    }
    ...
    public PolyClassEntityExplodeEvent(Object object) {
        super(object);
    }

    public static PolyClassEntityExplodeEvent of(Object object) {
        return new PolyClassEntityExplodeEvent(object);
    }

    public static PolyClassEntityExplodeEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("EntityExplodeEvent")) {
            return new PolyClassEntityExplodeEvent(object);
        }
        return null;
    }

    public static PolyClassEntityExplodeEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityExplodeEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
