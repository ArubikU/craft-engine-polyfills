...
extends PolyClassEvent {
    ...
    public static PolyClassBlockDamageEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("BlockDamageEvent")) {
            return new PolyClassBlockDamageEvent(object);
        }
        return null;
    }

    public static PolyClassBlockDamageEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlockDamageEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
