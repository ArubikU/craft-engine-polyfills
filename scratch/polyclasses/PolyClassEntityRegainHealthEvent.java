...
extends PolyClassEvent {
    ...
    public static PolyClassEntityRegainHealthEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("EntityRegainHealthEvent")) {
            return new PolyClassEntityRegainHealthEvent(object);
        }
        return null;
    }

    public static PolyClassEntityRegainHealthEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityRegainHealthEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
