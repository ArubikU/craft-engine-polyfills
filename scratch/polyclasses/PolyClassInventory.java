...
public class PolyClassInventory {
    ...
    public static PolyClassInventory ofVar(ScriptContext scriptContext, String string) {
        return PolyClassInventory.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
