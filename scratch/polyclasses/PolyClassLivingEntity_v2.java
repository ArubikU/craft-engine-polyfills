...
extends PolyClassEntity {
    ...
    public static PolyClassLivingEntity_v2 ofVar(ScriptContext scriptContext, String string) {
        return PolyClassLivingEntity_v2.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
