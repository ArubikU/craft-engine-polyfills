...
public class PolyClassEntity_v2 {
    ...
    public static PolyClassEntity_v2 ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntity_v2.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
