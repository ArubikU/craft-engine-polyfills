...
extends PolyClassEvent {
    ...
    public static PolyClassEntityBreedEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("EntityBreedEvent")) {
            return new PolyClassEntityBreedEvent(object);
        }
        return null;
    }

    public static PolyClassEntityBreedEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityBreedEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
