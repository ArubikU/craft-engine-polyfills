...
public class PolyClassEntity {
    ...
    public PolyClassEntity(Object object) {
        this.instance = object;
    }

    public static PolyClassEntity of(Object object) {
        return new PolyClassEntity(object);
    }

    public static PolyClassEntity ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
    ...
    public static PolyClassEntity ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntity.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
