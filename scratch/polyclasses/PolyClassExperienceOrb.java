...
extends PolyClassEntity {
    ...
    public static PolyClassExperienceOrb ofVar(ScriptContext scriptContext, String string) {
        return PolyClassExperienceOrb.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
