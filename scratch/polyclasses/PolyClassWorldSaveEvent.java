...
extends PolyClassEvent {
    ...
    public static PolyClassWorldSaveEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassWorldSaveEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
