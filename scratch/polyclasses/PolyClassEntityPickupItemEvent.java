...
extends PolyClassEvent {
    ...
    public static PolyClassEntityPickupItemEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityPickupItemEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
