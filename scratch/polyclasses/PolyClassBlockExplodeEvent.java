...
extends PolyClassEvent {
    ...
    public static void refresh() {
        ...
        tp$3 = (PolyType.TypedPropertyHandler)PolyClassRuntime.resolveTypedPropertyHandler((String)"BlockExplodeEvent", (String)"yield", (String)"D");
        p$4 = PolyClassRuntime.resolvePropertyHandler((String)"BlockExplodeEvent", (String)"block");
        p$5 = PolyClassRuntime.resolvePropertyHandler((String)"BlockExplodeEvent", (String)"block_list");
    }
    ...
    public double tg$3_yield() {
        ...
        return PolyClassRuntime.genericProperty((String)"BlockExplodeEvent", (String)"yield", (Object)this.instance).asNum();
    }
    ...
    public static PolyClassBlockExplodeEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("BlockExplodeEvent")) {
            return new PolyClassBlockExplodeEvent(object);
        }
        return null;
    }

    public static PolyClassBlockExplodeEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlockExplodeEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
