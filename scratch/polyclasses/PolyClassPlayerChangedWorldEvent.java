...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerChangedWorldEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("PlayerChangedWorldEvent")) {
            return new PolyClassPlayerChangedWorldEvent(object);
        }
        return null;
    }

    public static PolyClassPlayerChangedWorldEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerChangedWorldEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
