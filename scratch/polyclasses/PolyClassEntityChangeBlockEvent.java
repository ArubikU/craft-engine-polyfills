...
extends PolyClassEvent {
    ...
    public static PolyClassEntityChangeBlockEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityChangeBlockEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
