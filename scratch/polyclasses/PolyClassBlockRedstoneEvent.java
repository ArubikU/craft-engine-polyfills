...
extends PolyClassEvent {
    ...
    public static PolyClassBlockRedstoneEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlockRedstoneEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
