...
extends PolyClassEvent {
    ...
    public static PolyClassLightningStrikeEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassLightningStrikeEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
