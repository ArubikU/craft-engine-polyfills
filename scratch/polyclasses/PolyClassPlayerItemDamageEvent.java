...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerItemDamageEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerItemDamageEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
