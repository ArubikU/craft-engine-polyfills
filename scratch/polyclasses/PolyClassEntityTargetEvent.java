...
extends PolyClassEvent {
    ...
    public static PolyClassEntityTargetEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassEntityTargetEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
