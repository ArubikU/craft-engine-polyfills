...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerMoveEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("PlayerMoveEvent")) {
            return new PolyClassPlayerMoveEvent(object);
        }
        return null;
    }

    public static PolyClassPlayerMoveEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerMoveEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
