...
public class PolyClassWorkbench {
    ...
    public static PolyClassWorkbench ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("Workbench")) {
            return new PolyClassWorkbench(object);
        }
        return null;
    }

    public static PolyClassWorkbench ofVar(ScriptContext scriptContext, String string) {
        return PolyClassWorkbench.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
