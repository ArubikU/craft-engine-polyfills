...
extends PolyClassEvent {
    ...
    public static PolyClassInventoryMoveItemEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("InventoryMoveItemEvent")) {
            return new PolyClassInventoryMoveItemEvent(object);
        }
        return null;
    }

    public static PolyClassInventoryMoveItemEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassInventoryMoveItemEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
