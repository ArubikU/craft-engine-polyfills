...
extends PolyClassEvent {
    ...
    public static PolyClassServerCommandEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassServerCommandEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
