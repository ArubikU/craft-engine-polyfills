...
extends PolyClassEvent {
    ...
    public static PolyClassInventoryDragEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassInventoryDragEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
