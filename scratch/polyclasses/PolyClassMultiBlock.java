...
public class PolyClassMultiBlock {
    ...
    public static PolyClassMultiBlock ofVar(ScriptContext scriptContext, String string) {
        return PolyClassMultiBlock.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
