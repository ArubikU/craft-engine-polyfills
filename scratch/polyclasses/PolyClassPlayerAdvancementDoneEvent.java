...
extends PolyClassEvent {
    ...
    public static PolyClassPlayerAdvancementDoneEvent ofGuarded(ScriptValue scriptValue) {
        ScriptValue.Obj obj;
        Object object;
        if (scriptValue instanceof ScriptValue.Obj && (object = (obj = (ScriptValue.Obj)scriptValue).instance()) != null && !(object instanceof PolyClass) && obj.typeName().equals("PlayerAdvancementDoneEvent")) {
            return new PolyClassPlayerAdvancementDoneEvent(object);
        }
        return null;
    }

    public static PolyClassPlayerAdvancementDoneEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerAdvancementDoneEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
