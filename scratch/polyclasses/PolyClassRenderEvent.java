...
extends PolyClassEvent {
    ...
    public static PolyClassRenderEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassRenderEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
