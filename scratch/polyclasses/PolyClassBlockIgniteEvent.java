...
extends PolyClassEvent {
    ...
    public static PolyClassBlockIgniteEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlockIgniteEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
