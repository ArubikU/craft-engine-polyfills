...
extends PolyClassEntity_v3 {
    ...
    public static PolyClassFallingBlock ofVar(ScriptContext scriptContext, String string) {
        return PolyClassFallingBlock.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
