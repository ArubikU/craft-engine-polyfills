...
extends PolyClassEvent {
    ...
    public static PolyClassItemActionEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassItemActionEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
