...
extends PolyClassEvent {
    ...
    public static PolyClassBlockPhysicsEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlockPhysicsEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
