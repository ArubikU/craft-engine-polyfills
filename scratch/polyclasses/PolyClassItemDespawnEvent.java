...
extends PolyClassEvent {
    ...
    public static PolyClassItemDespawnEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassItemDespawnEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
