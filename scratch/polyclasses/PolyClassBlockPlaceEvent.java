...
extends PolyClassEvent {
    ...
    public static PolyClassBlockPlaceEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassBlockPlaceEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
