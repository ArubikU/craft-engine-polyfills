...
extends PolyClassEvent {
    ...
    public static void refresh() {
        ...
        tp$1 = (PolyType.TypedPropertyHandler)PolyClassRuntime.resolveTypedPropertyHandler((String)"PlayerToggleSprintEvent", (String)"is_sprinting", (String)"Z");
    }
    ...
    public boolean tg$1_is_sprinting() {
        if (tp$1 != null) {
            return (Boolean)tp$1.get(this.instance);
        }
        return PolyClassRuntime.genericProperty((String)"PlayerToggleSprintEvent", (String)"is_sprinting", (Object)this.instance).asBool();
    }
    ...
    public static PolyClassPlayerToggleSprintEvent ofVar(ScriptContext scriptContext, String string) {
        return PolyClassPlayerToggleSprintEvent.ofGuarded(scriptContext.getClassOrVar(string));
    }
}
